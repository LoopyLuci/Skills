---
name: email-marketing-content-troubleshooting
description: Use when applying email content troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, content, copywriting]
---

# Email Marketing Content Troubleshooting

"Use when applying email content troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  content,  copywriting workflows or issues
- Building, fixing, or optimizing email marketing content troubleshooting
