---
name: docker-registry-troubleshooting
description: Use when applying docker registry troubleshooting.
version: 1.0.0
...
"Use when applying docker registry troubleshooting."

## Trigger

Activate this skill when the user mentions:
- docker,  registry,  docker-registry-operations workflows or issues
- Building, fixing, or optimizing docker registry troubleshooting
