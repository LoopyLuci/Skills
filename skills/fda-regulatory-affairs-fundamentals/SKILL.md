---
name: fda-regulatory-affairs-fundamentals
description: Use when applying fda regulatory fundamentals.
version: 1.0.0
...
# Fda Regulatory Affairs Fundamentals

"Use when applying fda regulatory fundamentals."

## Trigger

Activate this skill when the user mentions:
- biotech,  pharma,  regulatory-affairs workflows or issues
- Building, fixing, or optimizing fda regulatory affairs fundamentals
