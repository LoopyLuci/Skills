---
name: database-postgresql-implementation
description: Use when applying postgresql implementation.
version: 1.0.0
...
"Use when applying postgresql implementation."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  postgres,  sql workflows or issues
- Building, fixing, or optimizing database postgresql implementation
