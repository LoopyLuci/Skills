---
name: agent-routing-models-deep-troubleshooting
description: "Use when applying agent routing models troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Agent Routing Models Deep Troubleshooting

"Use when applying agent routing models troubleshooting."

## Trigger

Activate this skill when the user mentions:
- agents,  routing workflows or issues
- Building, fixing, or optimizing agent routing models deep troubleshooting
