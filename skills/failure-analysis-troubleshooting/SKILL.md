---
name: failure-analysis-troubleshooting
description: Use when applying failure analysis troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [materials, engineering, failure-mode-analysis]
---

# Failure Analysis Troubleshooting

"Use when applying failure analysis troubleshooting."

## Trigger

Activate this skill when the user mentions:
- materials,  engineering,  failure-mode-analysis workflows or issues
- Building, fixing, or optimizing failure analysis troubleshooting
...
`materials, engineering, failure-mode-analysis`
