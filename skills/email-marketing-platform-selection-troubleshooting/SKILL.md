---
name: email-marketing-platform-selection-troubleshooting
description: "Use when applying email platform selection troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [email, platform, selection]
    related_skills: [general]
---

# Email Marketing Platform Selection Troubleshooting

"Use when applying email platform selection troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  platform,  selection workflows or issues
- Building, fixing, or optimizing email marketing platform selection troubleshooting
