...
"Use when tracking and reporting SaaS business metrics."

## Trigger

Activate this skill when the user mentions:
- saas,  metrics,  mrr,  churn,  LTV,  CAC,  subscription,  reporting,  board-deck workflows or issues
- Building, fixing, or optimizing saas metrics reporting
- Questions about saas best practices
...
`saas, metrics, mrr, churn, LTV, CAC, subscription, reporting, board-deck`
