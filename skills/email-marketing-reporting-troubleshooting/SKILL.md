---
name: email-marketing-reporting-troubleshooting
description: Use when applying email reporting troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, reporting, kpis]
---

# Email Marketing Reporting Troubleshooting

"Use when applying email reporting troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  reporting,  kpis workflows or issues
- Building, fixing, or optimizing email marketing reporting troubleshooting
