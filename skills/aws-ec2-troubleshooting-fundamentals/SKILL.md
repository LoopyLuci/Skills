---
name: aws-ec2-troubleshooting-fundamentals
description: "Use when applying aws ec2 troubleshooting fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Ec2 Troubleshooting Fundamentals

"Use when applying aws ec2 troubleshooting fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  ec2 workflows or issues
- Building, fixing, or optimizing aws ec2 troubleshooting fundamentals
