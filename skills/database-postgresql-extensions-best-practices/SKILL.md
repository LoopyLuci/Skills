---
name: database-postgresql-extensions-best-practices
description: Use when applying postgresql extensions best practices.
version: 1.0.0
...
# Database Postgresql Extensions Best Practices

"Use when applying postgresql extensions best practices."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  extensions,  contrib workflows or issues
- Building, fixing, or optimizing database postgresql extensions best practices
