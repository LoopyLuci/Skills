---
name: database-indexing-fundamentals
description: "Use when for database indexing fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database indexing fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  indexing,  performance,  optimization workflows or issues
- Building, fixing, or optimizing database indexing fundamentals
