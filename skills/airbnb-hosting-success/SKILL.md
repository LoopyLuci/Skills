...
"Use when succeeding as Airbnb host."

## Trigger

Activate this skill when the user mentions:
- travel,  airbnb,  hosting,  short-term-rental workflows or issues
- Building, fixing, or optimizing airbnb hosting success
...
`travel, airbnb, hosting, short-term-rental`
