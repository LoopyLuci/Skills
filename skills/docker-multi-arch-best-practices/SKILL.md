---
name: docker-multi-arch-best-practices
description: "Use when applying docker multi-arch best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Docker Multi Arch Best Practices

"Use when applying docker multi-arch best practices."

## Trigger

Activate this skill when the user mentions:
- devops,  docker,  multi-arch,  docker-multi-arch-builds workflows or issues
- Building, fixing, or optimizing docker multi arch best practices
...
`devops, docker, multi-arch, docker-multi-arch-builds`
