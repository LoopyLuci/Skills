---
name: agricultural-data-analytics-troubleshooting
description: "Use when applying agri data analytics troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [agri, data, precision-agriculture-analysis]
    related_skills: [general]
---

# Agricultural Data Analytics Troubleshooting

"Use when applying agri data analytics troubleshooting."

## Trigger

Activate this skill when the user mentions:
- agri,  data,  precision-agriculture-analysis workflows or issues
- Building, fixing, or optimizing agricultural data analytics troubleshooting
...
`agri, data, precision-agriculture-analysis`
