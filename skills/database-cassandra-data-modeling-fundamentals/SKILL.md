---
name: database-cassandra-data-modeling-fundamentals
description: "Use when applying cassandra modeling fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Cassandra Data Modeling Fundamentals

"Use when applying cassandra modeling fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  cassandra,  data-modeling,  single-table workflows or issues
- Building, fixing, or optimizing database cassandra data modeling fundamentals
