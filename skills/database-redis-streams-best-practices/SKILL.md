---
name: database-redis-streams-best-practices
description: "Use when applying redis streams best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Redis Streams Best Practices

"Use when applying redis streams best practices."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  streams,  pub-sub workflows or issues
- Building, fixing, or optimizing database redis streams best practices
