---
name: aws-emr-best-practices
description: Use when applying aws emr best practices.
version: 1.0.0
...
"Use when applying aws emr best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  emr,  hadoop,  spark workflows or issues
- Building, fixing, or optimizing aws emr best practices
