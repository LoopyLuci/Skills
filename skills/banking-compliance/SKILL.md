...
description: Use when ensuring banking compliance.
version: 1.0.0
...
metadata:
  hermes:
    tags: [finance, banking, banking-compliance]
---

# Banking Compliance

"Use when ensuring banking compliance."

## Trigger

Activate this skill when the user mentions:
- finance,  banking,  banking-compliance workflows or issues
- Building, fixing, or optimizing banking compliance
...
`finance, banking, banking-compliance`
