...
description: Use when applying azure aks troubleshooting.
version: 1.0.0
...
# Azure Kubernetes Troubleshooting

"Use when applying azure aks troubleshooting."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  aks,  kubernetes workflows or issues
- Building, fixing, or optimizing azure kubernetes troubleshooting
