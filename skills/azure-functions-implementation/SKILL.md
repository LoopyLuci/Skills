---
name: azure-functions-implementation
description: "Use when applying azure functions implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure functions implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  functions,  lambda workflows or issues
- Building, fixing, or optimizing azure functions implementation
