...
description: Use when for database security best practices.
version: 1.0.0
...
"Use when for database security best practices."

## Trigger

Activate this skill when the user mentions:
- database,  security,  encryption,  access-control workflows or issues
- Building, fixing, or optimizing database security best practices
