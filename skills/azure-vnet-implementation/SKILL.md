---
name: azure-vnet-implementation
description: Use when applying azure vnet implementation.
version: 1.0.0
...
# Azure Vnet Implementation

"Use when applying azure vnet implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  vnet,  networking workflows or issues
- Building, fixing, or optimizing azure vnet implementation
