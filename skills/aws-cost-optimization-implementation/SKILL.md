...
description: "Use when applying aws cost optimization implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws cost optimization implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  cost-optimization,  cost,  finops workflows or issues
- Building, fixing, or optimizing aws cost optimization implementation
