...
description: Use when for business continuity implementation.
version: 1.0.0
...
"Use when for business continuity implementation."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing business continuity implementation
