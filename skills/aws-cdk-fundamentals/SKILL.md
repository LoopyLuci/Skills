---
name: aws-cdk-fundamentals
description: Use when applying aws cdk fundamentals.
version: 1.0.0
...
"Use when applying aws cdk fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  cdk,  iac,  typescript workflows or issues
- Building, fixing, or optimizing aws cdk fundamentals
