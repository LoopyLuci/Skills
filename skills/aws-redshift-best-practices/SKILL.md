---
name: aws-redshift-best-practices
description: Use when applying aws redshift best practices.
version: 1.0.0
...
"Use when applying aws redshift best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  redshift,  data-warehouse,  analytics workflows or issues
- Building, fixing, or optimizing aws redshift best practices
