---
name: data-governance-troubleshooting-fundamentals
description: Use when applying data governance troubleshooting fundam.
version: 1.0.0
...
# Data Governance Troubleshooting Fundamentals

"Use when applying data governance troubleshooting fundam."

## Trigger

Activate this skill when the user mentions:
- data,  data-governance workflows or issues
- Building, fixing, or optimizing data governance troubleshooting fundamentals
