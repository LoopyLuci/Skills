---
name: email-marketing-open-rate-troubleshooting
description: Use when applying email open rate troubleshooting.
version: 1.0.0
...
# Email Marketing Open Rate Troubleshooting

"Use when applying email open rate troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  open-rate workflows or issues
- Building, fixing, or optimizing email marketing open rate troubleshooting
