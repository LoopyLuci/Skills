---
name: azure-database-troubleshooting
description: Use when applying azure database troubleshooting.
version: 1.0.0
...
"Use when applying azure database troubleshooting."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  sql-database,  cosmos-db workflows or issues
- Building, fixing, or optimizing azure database troubleshooting
