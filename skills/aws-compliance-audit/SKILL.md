...
description: Use when auditing AWS compliance.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, compliance-audit]
---

# Aws Compliance Audit

"Use when auditing AWS compliance."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  compliance-audit workflows or issues
- Building, fixing, or optimizing aws compliance audit
