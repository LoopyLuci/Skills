...
"Use when building Argo workflows."

## Trigger

Activate this skill when the user mentions:
- "argo",  "workflows",  "kubernetes",  "DAG",  "CI-CD" workflows or issues
- Building, fixing, or optimizing argo workflows pipelines
- Questions about "argo" best practices
...
`"argo", "workflows", "kubernetes", "DAG", "CI-CD"`
