...
"Use when configuring AWS CloudFront."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-cloudfront workflows or issues
- Building, fixing, or optimizing aws cloudfront cdn
