---
name: failure-analysis-fundamentals
description: Use when applying failure analysis fundamentals.
version: 1.0.0
...
"Use when applying failure analysis fundamentals."

## Trigger

Activate this skill when the user mentions:
- materials,  engineering,  failure-mode-analysis workflows or issues
- Building, fixing, or optimizing failure analysis fundamentals
