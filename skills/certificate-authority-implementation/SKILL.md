---
name: certificate-authority-implementation
description: Use when applying certificate authority implementation.
version: 1.0.0
...
"Use when applying certificate authority implementation."

## Trigger

Activate this skill when the user mentions:
- security,  ca,  certificates,  tls workflows or issues
- Building, fixing, or optimizing certificate authority implementation
