...
description: "Use when applying financial modeling fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying financial modeling fundamentals."

## Trigger

Activate this skill when the user mentions:
- finance,  modeling,  financial-modeling workflows or issues
- Building, fixing, or optimizing financial modeling fundamentals
