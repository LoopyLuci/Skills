---
name: email-delivery-troubleshooting
description: "Use when applying email delivery troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email delivery troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  smtp,  delivery workflows or issues
- Building, fixing, or optimizing email delivery troubleshooting
