---
name: database-cassandra-best-practices
description: "Use when applying cassandra best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Cassandra Best Practices

"Use when applying cassandra best practices."

## Trigger

Activate this skill when the user mentions:
- database,  cassandra,  nosql,  distributed workflows or issues
- Building, fixing, or optimizing database cassandra best practices
