---
name: email-marketing-preheaders-troubleshooting
description: Use when applying email preheaders troubleshooting.
version: 1.0.0
...
# Email Marketing Preheaders Troubleshooting

"Use when applying email preheaders troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  copywriting,  preheaders workflows or issues
- Building, fixing, or optimizing email marketing preheaders troubleshooting
