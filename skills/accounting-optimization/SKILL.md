---
name: accounting-optimization
description: Use when for accounting optimization.
version: 1.0.0
...
"Use when for accounting optimization."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing accounting optimization
