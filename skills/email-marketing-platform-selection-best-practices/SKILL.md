---
name: email-marketing-platform-selection-best-practices
description: "Use when applying email platform selection best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Platform Selection Best Practices

"Use when applying email platform selection best practices."

## Trigger

Activate this skill when the user mentions:
- email,  platform,  selection workflows or issues
- Building, fixing, or optimizing email marketing platform selection best practices
