---
name: email-marketing-tracking-implementation
description: Use when applying email tracking implementation.
version: 1.0.0
...
# Email Marketing Tracking Implementation

"Use when applying email tracking implementation."

## Trigger

Activate this skill when the user mentions:
- email,  tracking,  analytics workflows or issues
- Building, fixing, or optimizing email marketing tracking implementation
