...
description: Use when applying email newsletter best practices.
version: 1.0.0
...
"Use when applying email newsletter best practices."

## Trigger

Activate this skill when the user mentions:
- email,  publishing,  newsletter workflows or issues
- Building, fixing, or optimizing email newsletter best practices
