---
name: aws-config-fundamentals
description: Use when applying aws config fundamentals.
version: 1.0.0
...
"Use when applying aws config fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  config,  compliance,  auditing workflows or issues
- Building, fixing, or optimizing aws config fundamentals
