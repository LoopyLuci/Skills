...
"Use when using SQLite databases."

## Trigger

Activate this skill when the user mentions:
- "sqlite",  "embedded",  "database",  "WAL",  "FTS5" workflows or issues
- Building, fixing, or optimizing sqlite embedded database
- Questions about "sqlite" best practices
...
`"sqlite", "embedded", "database", "WAL", "FTS5"`
