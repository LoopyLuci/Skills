---
name: explainable-ai-implementation
description: Use when for explainable ai implementation.
version: 1.0.0
...
"Use when for explainable ai implementation."

## Trigger

Activate this skill when the user mentions:
- ai,  xai,  explainable-ai,  interpretability workflows or issues
- Building, fixing, or optimizing explainable ai implementation
