---
name: email-marketing-bounce-implementation
description: Use when applying email bounce implementation.
version: 1.0.0
...
# Email Marketing Bounce Implementation

"Use when applying email bounce implementation."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  bounce,  delivery workflows or issues
- Building, fixing, or optimizing email marketing bounce implementation
