---
name: cloud-security-posture-deep-troubleshooting
description: "Use when applying cloud security posture troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    ...
    related_skills: ['cloud-security-posture']
---

# Cloud Security Posture Deep Troubleshooting

"Use when applying cloud security posture troubleshooting."

## Trigger

Activate this skill when the user mentions:
- devops,  security workflows or issues
- Building, fixing, or optimizing cloud security posture deep troubleshooting
