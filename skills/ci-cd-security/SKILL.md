---
name: ci-cd-security
description: "Use when securing CI/CD pipelines."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [devops, ci-cd-security, pipeline-security, secrets-management]
    related_skills: ['ci-cd-pipeline-setup']
---

# Ci Cd Security

"Use when securing CI/CD pipelines."

## Trigger

Activate this skill when the user mentions:
- devops,  ci-cd-security,  pipeline-security,  secrets-management workflows or issues
- Building, fixing, or optimizing ci cd security
...
`devops, ci-cd-security, pipeline-security, secrets-management`
