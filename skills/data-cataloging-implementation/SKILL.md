---
name: data-cataloging-implementation
description: "Use when for data cataloging implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for data cataloging implementation."

## Trigger

Activate this skill when the user mentions:
- data-governance,  catalog,  metadata workflows or issues
- Building, fixing, or optimizing data cataloging implementation
