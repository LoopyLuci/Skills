---
name: audit-logging-best-practices
description: Use when for audit logging best practices.
version: 1.0.0
...
"Use when for audit logging best practices."

## Trigger

Activate this skill when the user mentions:
- security,  audit-logging,  compliance,  logging workflows or issues
- Building, fixing, or optimizing audit logging best practices
