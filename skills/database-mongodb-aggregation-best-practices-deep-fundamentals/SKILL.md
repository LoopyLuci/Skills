---
name: database-mongodb-aggregation-best-practices-deep-fundamentals
...
# Database Mongodb Aggregation Best Practices Deep Fundamentals

"Use when applying mongodb aggregation fundamentals."

## Trigger

Activate this skill when the user mentions:
- data,  mongodb workflows or issues
- Building, fixing, or optimizing database mongodb aggregation best practices deep fundamentals
