---
name: email-newsletter-implementation
description: Use when applying email newsletter implementation.
version: 1.0.0
...
"Use when applying email newsletter implementation."

## Trigger

Activate this skill when the user mentions:
- email,  publishing,  newsletter workflows or issues
- Building, fixing, or optimizing email newsletter implementation
