---
name: django-authentication-fundamentals
description: Use when applying django auth fundamentals.
version: 1.0.0
...
"Use when applying django auth fundamentals."

## Trigger

Activate this skill when the user mentions:
- backend,  django,  auth,  python workflows or issues
- Building, fixing, or optimizing django authentication fundamentals
