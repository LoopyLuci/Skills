---
name: database-monitoring-best-practices
description: Use when for database monitoring best practices.
version: 1.0.0
...
"Use when for database monitoring best practices."

## Trigger

Activate this skill when the user mentions:
- database,  monitoring,  observability,  performance workflows or issues
- Building, fixing, or optimizing database monitoring best practices
