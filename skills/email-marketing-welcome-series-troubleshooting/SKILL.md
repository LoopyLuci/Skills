---
name: email-marketing-welcome-series-troubleshooting
description: Use when applying welcome email series troubleshooting.
version: 1.0.0
...
# Email Marketing Welcome Series Troubleshooting

"Use when applying welcome email series troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome-series workflows or issues
- Building, fixing, or optimizing email marketing welcome series troubleshooting
...
`email, onboarding, welcome-series`
