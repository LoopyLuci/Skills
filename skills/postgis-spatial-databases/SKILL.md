...
Spatial indexing, PostGIS functions, raster support, and query optimization

## Trigger

Activate this skill when the user mentions:
- "postgis",  "sql" workflows or issues
- Building, fixing, or optimizing postgis spatial databases
- Questions about "postgis" best practices
