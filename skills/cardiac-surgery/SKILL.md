...
"Use when performing cardiac surgery."

## Trigger

Activate this skill when the user mentions:
- healthcare,  surgery,  cardiology-fundamentals workflows or issues
- Building, fixing, or optimizing cardiac surgery
...
`healthcare, surgery, cardiology-fundamentals`
