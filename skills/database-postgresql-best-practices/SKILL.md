---
name: database-postgresql-best-practices
description: Use when applying postgresql best practices.
version: 1.0.0
...
"Use when applying postgresql best practices."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  postgres,  sql workflows or issues
- Building, fixing, or optimizing database postgresql best practices
