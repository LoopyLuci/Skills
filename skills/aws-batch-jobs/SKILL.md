---
name: aws-batch-jobs
description: Use when running AWS Batch.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, aws-batch]
---

# Aws Batch Jobs

"Use when running AWS Batch."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-batch workflows or issues
- Building, fixing, or optimizing aws batch jobs
