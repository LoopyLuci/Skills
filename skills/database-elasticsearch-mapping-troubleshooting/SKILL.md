---
name: database-elasticsearch-mapping-troubleshooting
description: Use when applying elasticsearch mapping troubleshooting.
version: 1.0.0
...
# Database Elasticsearch Mapping Troubleshooting

"Use when applying elasticsearch mapping troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  elasticsearch,  mapping,  schema workflows or issues
- Building, fixing, or optimizing database elasticsearch mapping troubleshooting
...
`database, elasticsearch, mapping, schema`
