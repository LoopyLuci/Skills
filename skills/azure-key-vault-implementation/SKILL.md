...
description: Use when applying azure key vault implementation.
version: 1.0.0
...
"Use when applying azure key vault implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  key-vault,  security workflows or issues
- Building, fixing, or optimizing azure key vault implementation
