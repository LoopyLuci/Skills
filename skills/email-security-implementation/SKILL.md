...
description: "Use when for email security implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for email security implementation."

## Trigger

Activate this skill when the user mentions:
- security,  email,  phishing,  spam workflows or issues
- Building, fixing, or optimizing email security implementation
