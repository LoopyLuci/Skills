---
name: aws-cloudfront-fundamentals-deep-fundamentals
description: "Use when applying cloudfront fundamentals fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Cloudfront Fundamentals Deep Fundamentals

"Use when applying cloudfront fundamentals fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  cdn workflows or issues
- Building, fixing, or optimizing aws cloudfront fundamentals deep fundamentals
