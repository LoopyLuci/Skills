...
SOC 2, ISO 27001, PCI DSS, HIPAA, NIST CSF, and audit preparation

## Trigger

Activate this skill when the user mentions:
- "compliance",  "audit" workflows or issues
- Building, fixing, or optimizing compliance frameworks audit
