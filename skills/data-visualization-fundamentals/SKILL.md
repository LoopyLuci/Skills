...
description: Use when applying data visualization fundamentals.
version: 1.0.0
...
"Use when applying data visualization fundamentals."

## Trigger

Activate this skill when the user mentions:
- data,  viz,  data-visualization-design workflows or issues
- Building, fixing, or optimizing data visualization fundamentals
