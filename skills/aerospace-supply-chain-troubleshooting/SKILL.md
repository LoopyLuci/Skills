---
name: aerospace-supply-chain-troubleshooting
description: Use when applying aerospace supply chain troubleshooting.
version: 1.0.0
...
# Aerospace Supply Chain Troubleshooting

"Use when applying aerospace supply chain troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aerospace,  supply,  supply-chain workflows or issues
- Building, fixing, or optimizing aerospace supply chain troubleshooting
