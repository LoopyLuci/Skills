---
name: email-segmentation-fundamentals
description: Use when applying email segmentation fundamentals.
version: 1.0.0
...
# Email Segmentation Fundamentals

"Use when applying email segmentation fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  segmentation workflows or issues
- Building, fixing, or optimizing email segmentation fundamentals
