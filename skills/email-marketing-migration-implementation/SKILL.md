---
name: email-marketing-migration-implementation
description: Use when applying email migration implementation.
version: 1.0.0
...
# Email Marketing Migration Implementation

"Use when applying email migration implementation."

## Trigger

Activate this skill when the user mentions:
- email,  migration,  platform workflows or issues
- Building, fixing, or optimizing email marketing migration implementation
