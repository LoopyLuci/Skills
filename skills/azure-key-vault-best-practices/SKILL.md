...
description: Use when applying azure key vault best practices.
version: 1.0.0
...
"Use when applying azure key vault best practices."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  key-vault,  security workflows or issues
- Building, fixing, or optimizing azure key vault best practices
