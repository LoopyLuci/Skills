---
name: email-marketing-personalization-tokens-fundamentals
description: Use when applying email personalization fundamentals.
version: 1.0.0
...
# Email Marketing Personalization Tokens Fundamentals

"Use when applying email personalization fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  personalization,  dynamic-content workflows or issues
- Building, fixing, or optimizing email marketing personalization tokens fundamentals
