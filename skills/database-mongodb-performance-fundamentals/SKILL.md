---
name: database-mongodb-performance-fundamentals
description: Use when applying mongodb performance fundamentals.
version: 1.0.0
...
# Database Mongodb Performance Fundamentals

"Use when applying mongodb performance fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  performance,  optimization workflows or issues
- Building, fixing, or optimizing database mongodb performance fundamentals
