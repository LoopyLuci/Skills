---
name: fashion-model-management-fundamentals
...
# Fashion Model Management Fundamentals

"Use when applying model management fundamentals."

## Trigger

Activate this skill when the user mentions:
- fashion,  modeling,  model-management workflows or issues
- Building, fixing, or optimizing fashion model management fundamentals
