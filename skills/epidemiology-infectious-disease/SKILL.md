...
"Use when studying infectious disease epi."

## Trigger

Activate this skill when the user mentions:
- medicine,  epidemiology,  infectious-disease workflows or issues
- Building, fixing, or optimizing epidemiology infectious disease
...
`medicine, epidemiology, infectious-disease`
