---
name: email-marketing-tracking-fundamentals
description: Use when applying email tracking fundamentals.
version: 1.0.0
...
# Email Marketing Tracking Fundamentals

"Use when applying email tracking fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  tracking,  analytics workflows or issues
- Building, fixing, or optimizing email marketing tracking fundamentals
