...
description: "Use when for customer success fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for customer success fundamentals."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing customer success fundamentals
