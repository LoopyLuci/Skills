...
"Use when designing event-driven APIs."

## Trigger

Activate this skill when the user mentions:
- api,  event-driven,  async-api,  messaging workflows or issues
- Building, fixing, or optimizing event driven api design
...
`api, event-driven, async-api, messaging`
