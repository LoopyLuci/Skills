...
"Use when using Azure Functions."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  azure-functions-serverless workflows or issues
- Building, fixing, or optimizing azure functions
...
`cloud, azure, azure-functions-serverless`
