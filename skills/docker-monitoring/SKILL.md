...
"Use when monitoring Docker containers."

## Trigger

Activate this skill when the user mentions:
- docker,  monitoring,  logs,  observability workflows or issues
- Building, fixing, or optimizing docker monitoring
...
`docker, monitoring, logs, observability`
