---
name: database-administration-best-practices
description: Use when for database administration best practices.
version: 1.0.0
...
"Use when for database administration best practices."

## Trigger

Activate this skill when the user mentions:
- database,  dba,  administration,  maintenance workflows or issues
- Building, fixing, or optimizing database administration best practices
