---
name: email-marketing-analysis
description: Use when for email marketing analysis.
version: 1.0.0
...
"Use when for email marketing analysis."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing email marketing analysis
