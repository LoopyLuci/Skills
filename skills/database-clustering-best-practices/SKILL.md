---
name: database-clustering-best-practices
description: "Use when for database clustering best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Clustering Best Practices

"Use when for database clustering best practices."

## Trigger

Activate this skill when the user mentions:
- database,  clustering,  high-availability,  nosql workflows or issues
- Building, fixing, or optimizing database clustering best practices
...
`database, clustering, high-availability, nosql`
