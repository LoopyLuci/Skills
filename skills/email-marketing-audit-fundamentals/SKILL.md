---
name: email-marketing-audit-fundamentals
description: Use when applying email marketing audit fundamentals.
version: 1.0.0
...
# Email Marketing Audit Fundamentals

"Use when applying email marketing audit fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-audit workflows or issues
- Building, fixing, or optimizing email marketing audit fundamentals
