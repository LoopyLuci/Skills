...
"Use when ensuring AWS compliance."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  compliance-security-best-practices workflows or issues
- Building, fixing, or optimizing aws security compliance
...
`cloud, aws, compliance-security-best-practices`
