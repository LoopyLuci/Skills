...
description: Use when applying azure service bus fundamentals.
version: 1.0.0
...
"Use when applying azure service bus fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  service-bus,  mq workflows or issues
- Building, fixing, or optimizing azure service bus fundamentals
