...
- network-security,  IDS,  IPS,  intrusion-detection,  suricata,  snort workflows or issues
- Building, fixing, or optimizing network ids ips patterns
- Questions about network-security best practices
...
`network-security, IDS, IPS, intrusion-detection, suricata, snort`
