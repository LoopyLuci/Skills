---
name: distributed-sql-fundamentals
description: Use when applying distributed sql databases fundamentals.
version: 1.0.0
...
"Use when applying distributed sql databases fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  distributed-sql,  cockroachdb,  yugabyte workflows or issues
- Building, fixing, or optimizing distributed sql fundamentals
