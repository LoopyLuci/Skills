...
description: "Use when resolving construction disputes."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [construction, dispute-resolution, arbitration, mediation]
    related_skills: [legal-and-compliance-basics]
---

## Overview
Construction Dispute Resolution implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Construction Dispute Resolution implementation and optimization"
- "Best practices for Construction Dispute Resolution workflows"
- "Construction Dispute Resolution compliance and standards"
- "Construction Dispute Resolution troubleshooting and problem-solving"
- "Construction Dispute Resolution ROI and performance measurement"
