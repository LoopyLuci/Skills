...
"Use when deploying with Docker Compose."

## Trigger

Activate this skill when the user mentions:
- "docker-compose",  "production",  "healthchecks",  "volumes" workflows or issues
- Building, fixing, or optimizing docker compose prod
- Questions about "docker-compose" best practices
...
`"docker-compose", "production", "healthchecks", "volumes"`
