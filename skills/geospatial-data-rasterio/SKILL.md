...
Rasterio, xarray, GeoTIFF, COG, and multi-band analysis

## Trigger

Activate this skill when the user mentions:
- "raster",  "python" workflows or issues
- Building, fixing, or optimizing geospatial data rasterio
- Questions about "raster" best practices
