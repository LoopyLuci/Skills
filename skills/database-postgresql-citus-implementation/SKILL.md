---
name: database-postgresql-citus-implementation
description: Use when applying postgresql citus implementation.
version: 1.0.0
...
# Database Postgresql Citus Implementation

"Use when applying postgresql citus implementation."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  citus,  sharding workflows or issues
- Building, fixing, or optimizing database postgresql citus implementation
