---
name: aws-quicksight-best-practices
description: Use when applying aws quicksight best practices.
version: 1.0.0
...
"Use when applying aws quicksight best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  quicksight,  bi,  dashboards workflows or issues
- Building, fixing, or optimizing aws quicksight best practices
