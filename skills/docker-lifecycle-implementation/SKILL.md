---
name: docker-lifecycle-implementation
description: Use when applying docker lifecycle implementation.
version: 1.0.0
...
"Use when applying docker lifecycle implementation."

## Trigger

Activate this skill when the user mentions:
- docker,  lifecycle,  docker-lifecycle-management workflows or issues
- Building, fixing, or optimizing docker lifecycle implementation
