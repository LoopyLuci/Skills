...
"Use when implementing JWT auth in Node."

## Trigger

Activate this skill when the user mentions:
- "nodejs",  "JWT",  "auth",  "passport",  "sessions" workflows or issues
- Building, fixing, or optimizing nodejs authentication jwt
...
`"nodejs", "JWT", "auth", "passport", "sessions"`
