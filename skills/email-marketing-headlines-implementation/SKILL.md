---
name: email-marketing-headlines-implementation
description: Use when applying email headlines implementation.
version: 1.0.0
...
# Email Marketing Headlines Implementation

"Use when applying email headlines implementation."

## Trigger

Activate this skill when the user mentions:
- email,  copywriting,  headlines workflows or issues
- Building, fixing, or optimizing email marketing headlines implementation
