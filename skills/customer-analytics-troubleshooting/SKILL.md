---
name: customer-analytics-troubleshooting
description: Use when applying customer analytics troubleshooting.
version: 1.0.0
...
"Use when applying customer analytics troubleshooting."

## Trigger

Activate this skill when the user mentions:
- business,  customer,  analytics,  digital-marketing-analytics workflows or issues
- Building, fixing, or optimizing customer analytics troubleshooting
