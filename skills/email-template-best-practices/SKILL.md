---
name: email-template-best-practices
description: "Use when applying email templates best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email templates best practices."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  templates workflows or issues
- Building, fixing, or optimizing email template best practices
