---
name: aws-fargate-implementation
description: Use when applying aws fargate implementation.
version: 1.0.0
...
"Use when applying aws fargate implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  fargate,  serverless-containers workflows or issues
- Building, fixing, or optimizing aws fargate implementation
