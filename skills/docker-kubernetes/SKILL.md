...
description: Use when using Docker with Kubernetes.
version: 1.0.0
...
"Use when using Docker with Kubernetes."

## Trigger

Activate this skill when the user mentions:
- docker,  kubernetes,  container-orchestration workflows or issues
- Building, fixing, or optimizing docker kubernetes
