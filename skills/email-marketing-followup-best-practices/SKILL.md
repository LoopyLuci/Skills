---
name: email-marketing-followup-best-practices
description: Use when applying email follow-up best practices.
version: 1.0.0
...
# Email Marketing Followup Best Practices

"Use when applying email follow-up best practices."

## Trigger

Activate this skill when the user mentions:
- email,  follow-up,  sales workflows or issues
- Building, fixing, or optimizing email marketing followup best practices
