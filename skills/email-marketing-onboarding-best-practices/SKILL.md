---
name: email-marketing-onboarding-best-practices
description: Use when applying email onboarding best practices.
version: 1.0.0
...
# Email Marketing Onboarding Best Practices

"Use when applying email onboarding best practices."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome workflows or issues
- Building, fixing, or optimizing email marketing onboarding best practices
