---
name: embedded-security-implementation
description: Use when for embedded security implementation.
version: 1.0.0
...
"Use when for embedded security implementation."

## Trigger

Activate this skill when the user mentions:
- security,  embedded,  firmware,  iot workflows or issues
- Building, fixing, or optimizing embedded security implementation
