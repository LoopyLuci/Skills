...
"Use when configuring dev containers."

## Trigger

Activate this skill when the user mentions:
- devops,  containers,  docker-dev-containers workflows or issues
- Building, fixing, or optimizing container dev containers
...
`devops, containers, docker-dev-containers`
