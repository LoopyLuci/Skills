---
name: email-automation-implementation
description: Use when applying email automation implementation.
version: 1.0.0
...
"Use when applying email automation implementation."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-automation workflows or issues
- Building, fixing, or optimizing email automation implementation
