---
name: email-delivery-fundamentals
description: "Use when applying email delivery fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email delivery fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  smtp,  delivery workflows or issues
- Building, fixing, or optimizing email delivery fundamentals
