...
description: Use when applying data architecture implementation.
version: 1.0.0
...
"Use when applying data architecture implementation."

## Trigger

Activate this skill when the user mentions:
- data,  architecture,  data-lake-architecture workflows or issues
- Building, fixing, or optimizing data architecture implementation
