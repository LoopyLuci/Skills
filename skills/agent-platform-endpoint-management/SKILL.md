...
description: Skill for agent platform endpoint management
version: 1.0.0
...
**Trigger**: Use when managing Endpoint Management on Google Cloud's Agent Platform — Google Cloud AI and agent infrastructure.
