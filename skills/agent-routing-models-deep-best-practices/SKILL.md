---
name: agent-routing-models-deep-best-practices
description: Use when applying agent routing models best practices.
version: 1.0.0
...
# Agent Routing Models Deep Best Practices

"Use when applying agent routing models best practices."

## Trigger

Activate this skill when the user mentions:
- agents,  routing workflows or issues
- Building, fixing, or optimizing agent routing models deep best practices
