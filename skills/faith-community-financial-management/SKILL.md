---
name: faith-community-financial-management
description: "Use when managing faith community finances."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [religious, church-finances, stewardship, budgeting]
    related_skills: [nonprofit-accounting]
---

## Overview (Non-Profit & Social Impact)
Domain-specific implementation.
Faith Community Financial Management implementation. Covers best practices, common methodologies, 
technical considerations, and verification approaches for this field.

## When to Use
- "Faith Community Financial Management implementation and optimization"
- "Best practices for Faith Community Financial Management workflows"
- "Faith Community Financial Management compliance and standards"
- "Faith Community Financial Management troubleshooting and problem-solving"
- "Faith Community Financial Management ROI and performance measurement"
