---
name: docker-dev-environments-deep-troubleshooting
description: "Use when applying docker dev environments troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [devops, docker]
    related_skills: ['docker-dev-environments']
---

# Docker Dev Environments Deep Troubleshooting

"Use when applying docker dev environments troubleshooting."

## Trigger

Activate this skill when the user mentions:
- devops,  docker workflows or issues
- Building, fixing, or optimizing docker dev environments deep troubleshooting
