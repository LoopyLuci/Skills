---
name: email-template-implementation
description: "Use when applying email templates implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email templates implementation."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  templates workflows or issues
- Building, fixing, or optimizing email template implementation
