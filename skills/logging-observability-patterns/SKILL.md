...
"Use when implementing structured logging and observability."

## Trigger

Activate this skill when the user mentions:
- logging,  observability,  structured-logging,  telemetry,  monitoring workflows or issues
- Building, fixing, or optimizing logging observability patterns
...
`logging, observability, structured-logging, telemetry, monitoring`
