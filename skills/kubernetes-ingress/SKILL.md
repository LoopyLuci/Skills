...
description: "Use when implementing kubernetes ingress."
version: 1.0.0
...
"Use when implementing kubernetes ingress."

## Trigger

Activate this skill when the user mentions:
- "kubernetes",  "ingress" workflows or issues
- Building, fixing, or optimizing kubernetes ingress
