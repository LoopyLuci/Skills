---
name: email-marketing-frequency-troubleshooting
description: Use when applying email frequency troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, optimization, frequency]
---

# Email Marketing Frequency Troubleshooting

"Use when applying email frequency troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  frequency workflows or issues
- Building, fixing, or optimizing email marketing frequency troubleshooting
