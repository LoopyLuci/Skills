...
SANS PICERL, NIST 800-61, containment, eradication, recovery, and lessons-learned

## Trigger

Activate this skill when the user mentions:
- "ir",  "dfir" workflows or issues
- Building, fixing, or optimizing incident response ir
