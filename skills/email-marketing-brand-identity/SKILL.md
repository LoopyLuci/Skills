...
"Use when aligning email with brand."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  branding,  identity workflows or issues
- Building, fixing, or optimizing email marketing brand identity
...
`email, marketing, branding, identity`
