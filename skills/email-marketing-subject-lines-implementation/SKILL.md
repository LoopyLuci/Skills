---
name: email-marketing-subject-lines-implementation
description: Use when applying email subject lines implementation.
version: 1.0.0
...
# Email Marketing Subject Lines Implementation

"Use when applying email subject lines implementation."

## Trigger

Activate this skill when the user mentions:
- email,  copywriting,  subject-lines workflows or issues
- Building, fixing, or optimizing email marketing subject lines implementation
