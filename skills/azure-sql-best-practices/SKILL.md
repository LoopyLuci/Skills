...
description: "Use when applying azure sql best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure sql best practices."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  sql,  database workflows or issues
- Building, fixing, or optimizing azure sql best practices
