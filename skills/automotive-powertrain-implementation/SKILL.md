---
name: automotive-powertrain-implementation
description: Use when applying automotive powertrain implementation.
version: 1.0.0
...
# Automotive Powertrain Implementation

"Use when applying automotive powertrain implementation."

## Trigger

Activate this skill when the user mentions:
- auto,  engineering,  vehicle-powertrain-optimization workflows or issues
- Building, fixing, or optimizing automotive powertrain implementation
