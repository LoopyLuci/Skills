---
name: email-marketing-optimization-best-practices
description: Use when applying email optimization best practices.
version: 1.0.0
...
# Email Marketing Optimization Best Practices

"Use when applying email optimization best practices."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  ab-testing workflows or issues
- Building, fixing, or optimizing email marketing optimization best practices
