---
name: docker-security-troubleshooting
description: "Use when applying docker security troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying docker security troubleshooting."

## Trigger

Activate this skill when the user mentions:
- docker,  security,  docker-security-hardening workflows or issues
- Building, fixing, or optimizing docker security troubleshooting
...
`docker, security, docker-security-hardening`
