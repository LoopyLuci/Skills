---
name: data-mart-implementation
description: Use when applying data mart implementation.
version: 1.0.0
...
"Use when applying data mart implementation."

## Trigger

Activate this skill when the user mentions:
- ds,  data,  data-mart workflows or issues
- Building, fixing, or optimizing data mart implementation
