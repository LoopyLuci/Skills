...
description: Use when applying mongodb sharding fundamentals.
version: 1.0.0
...
# Database Mongodb Sharding Fundamentals

"Use when applying mongodb sharding fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  sharding,  scale workflows or issues
- Building, fixing, or optimizing database mongodb sharding fundamentals
