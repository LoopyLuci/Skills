---
name: astrodynamics-calculations
description: "Use when calculating astrodynamics."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [space, astrodynamics, orbital-mechanics, calculations]
    related_skills: [general]
---

## Overview
Calculate orbital mechanics for spacecraft trajectories and maneuvers.

## When to Use
- "Astrodynamics Calculations design and implementation"
- "Best practices for Astrodynamics Calculations"
- "Astrodynamics Calculations optimization and enhancement"
- "Astrodynamics Calculations troubleshooting and validation"
- "Astrodynamics Calculations performance and metrics"
