---
name: email-marketing-frequency-best-practices
description: "Use when applying email frequency best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email frequency best practices."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  frequency workflows or issues
- Building, fixing, or optimizing email marketing frequency best practices
