...
description: Use when applying data engineering best practices.
version: 1.0.0
...
metadata:
  hermes:
    tags: [data, data-engineering, pipelines, etl]
---

# Data Engineering Best Practices

"Use when applying data engineering best practices."

## Trigger

Activate this skill when the user mentions:
- data,  data-engineering,  pipelines,  etl workflows or issues
- Building, fixing, or optimizing data engineering best practices
