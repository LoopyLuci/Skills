---
name: aws-cloudwatch-troubleshooting
description: "Use when applying aws cloudwatch troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [aws, cloudwatch, monitoring, logs]
    related_skills: [general]
---

# Aws Cloudwatch Troubleshooting

"Use when applying aws cloudwatch troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  cloudwatch,  monitoring,  logs workflows or issues
- Building, fixing, or optimizing aws cloudwatch troubleshooting
