---
name: email-marketing-implementation-best-practices
description: Use when applying email marketing impl best practices.
version: 1.0.0
...
# Email Marketing Implementation Best Practices

"Use when applying email marketing impl best practices."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-implementation workflows or issues
- Building, fixing, or optimizing email marketing implementation best practices
