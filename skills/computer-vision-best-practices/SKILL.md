---
name: computer-vision-best-practices
description: Use when applying computer vision best practices.
version: 1.0.0
...
metadata:
  hermes:
    tags: [ai, vision, computer-vision-techniques]
---

# Computer Vision Best Practices

"Use when applying computer vision best practices."

## Trigger

Activate this skill when the user mentions:
- ai,  vision,  computer-vision-techniques workflows or issues
- Building, fixing, or optimizing computer vision best practices
...
`ai, vision, computer-vision-techniques`
