---
name: database-mongodb-sharding-implementation
description: "Use when applying mongodb sharding implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mongodb Sharding Implementation

"Use when applying mongodb sharding implementation."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  sharding,  scale workflows or issues
- Building, fixing, or optimizing database mongodb sharding implementation
