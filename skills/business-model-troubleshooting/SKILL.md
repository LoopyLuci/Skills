---
name: business-model-troubleshooting
description: "Use when applying business model troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [business, startup, startup-strategy]
    related_skills: [general]
---

# Business Model Troubleshooting

"Use when applying business model troubleshooting."

## Trigger

Activate this skill when the user mentions:
- business,  startup,  startup-strategy workflows or issues
- Building, fixing, or optimizing business model troubleshooting
...
`business, startup, startup-strategy`
