...
"Use when implementing cryptography securely in apps."

## Trigger

Activate this skill when the user mentions:
- cryptography,  encryption,  hashing,  signing,  security,  python,  rust workflows or issues
- Building, fixing, or optimizing cryptography implementation patterns
- Questions about cryptography best practices
...
`cryptography, encryption, hashing, signing, security, python, rust`
