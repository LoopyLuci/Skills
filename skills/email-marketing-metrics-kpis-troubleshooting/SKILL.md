---
name: email-marketing-metrics-kpis-troubleshooting
description: Use when applying email kpis troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, analytics, kpis]
---

# Email Marketing Metrics Kpis Troubleshooting

"Use when applying email kpis troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  kpis workflows or issues
- Building, fixing, or optimizing email marketing metrics kpis troubleshooting
