...
description: Use when applying aws disaster recovery implementation.
version: 1.0.0
...
"Use when applying aws disaster recovery implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  disaster-recovery,  dr,  backup workflows or issues
- Building, fixing, or optimizing aws disaster recovery implementation
