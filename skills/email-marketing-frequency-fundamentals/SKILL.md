---
name: email-marketing-frequency-fundamentals
description: "Use when applying email frequency fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Frequency Fundamentals

"Use when applying email frequency fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  frequency workflows or issues
- Building, fixing, or optimizing email marketing frequency fundamentals
