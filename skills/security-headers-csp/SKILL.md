...
"Use when implementing security headers."

## Trigger

Activate this skill when the user mentions:
- "CSP",  "HSTS",  "X-Frame-Options",  "security-headers" workflows or issues
- Building, fixing, or optimizing security headers csp
- Questions about "CSP" best practices
