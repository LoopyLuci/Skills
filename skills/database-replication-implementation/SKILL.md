...
description: "Use when for database replication implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database replication implementation."

## Trigger

Activate this skill when the user mentions:
- database,  replication,  high-availability,  cluster workflows or issues
- Building, fixing, or optimizing database replication implementation
