---
name: data-lineage-troubleshooting-best-practices
description: Use when applying data lineage troubleshooting best prac.
version: 1.0.0
...
# Data Lineage Troubleshooting Best Practices

"Use when applying data lineage troubleshooting best prac."

## Trigger

Activate this skill when the user mentions:
- data,  lineage workflows or issues
- Building, fixing, or optimizing data lineage troubleshooting best practices
