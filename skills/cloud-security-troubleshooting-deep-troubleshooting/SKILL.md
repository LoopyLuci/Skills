---
name: cloud-security-troubleshooting-deep-troubleshooting
description: "Use when applying cloud security troubleshoot troublesho."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    ...
    related_skills: ['cloud-security-troubleshooting']
---

# Cloud Security Troubleshooting Deep Troubleshooting

"Use when applying cloud security troubleshoot troublesho."

## Trigger

Activate this skill when the user mentions:
- devops,  security workflows or issues
- Building, fixing, or optimizing cloud security troubleshooting deep troubleshooting
