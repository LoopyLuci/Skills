---
name: azure-event-hubs-troubleshooting
description: Use when applying azure event hubs troubleshooting.
version: 1.0.0
...
"Use when applying azure event hubs troubleshooting."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  event-hubs,  streaming workflows or issues
- Building, fixing, or optimizing azure event hubs troubleshooting
...
`cloud, azure, event-hubs, streaming`
