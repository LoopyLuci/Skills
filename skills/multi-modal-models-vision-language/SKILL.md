...
"Use when building multi-modal vision-language AI models."

## Trigger

Activate this skill when the user mentions:
- multi-modal,  vision-language,  VLM,  CLIP,  image-captioning,  visual-qa workflows or issues
- Building, fixing, or optimizing multi modal models vision language
- Questions about multi-modal best practices
...
`multi-modal, vision-language, VLM, CLIP, image-captioning, visual-qa`
