---
name: email-marketing-content-fundamentals
description: Use when applying email content fundamentals.
version: 1.0.0
...
# Email Marketing Content Fundamentals

"Use when applying email content fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  content,  copywriting workflows or issues
- Building, fixing, or optimizing email marketing content fundamentals
