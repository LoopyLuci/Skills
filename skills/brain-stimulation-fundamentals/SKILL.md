---
name: brain-stimulation-fundamentals
description: Use when applying brain stimulation fundamentals.
version: 1.0.0
...
# Brain Stimulation Fundamentals

"Use when applying brain stimulation fundamentals."

## Trigger

Activate this skill when the user mentions:
- neurotech,  bci,  brain-stimulation-safety workflows or issues
- Building, fixing, or optimizing brain stimulation fundamentals
