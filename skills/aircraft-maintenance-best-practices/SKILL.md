---
name: aircraft-maintenance-best-practices
description: Use when applying aircraft maintenance best practices.
version: 1.0.0
...
"Use when applying aircraft maintenance best practices."

## Trigger

Activate this skill when the user mentions:
- aviation,  maintenance,  aircraft-maintenance workflows or issues
- Building, fixing, or optimizing aircraft maintenance best practices
