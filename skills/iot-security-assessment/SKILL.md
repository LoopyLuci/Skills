...
Firmware analysis, UART/SPI sniffing, Zigbee/BLE attacks, and IoT hardening

## Trigger

Activate this skill when the user mentions:
- "iot",  "embedded" workflows or issues
- Building, fixing, or optimizing iot security assessment
- Questions about "iot" best practices
