---
name: email-marketing-abandoned-cart-recovery-best-practices
description: "Use when applying abandoned cart recovery best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Abandoned Cart Recovery Best Practices

"Use when applying abandoned cart recovery best practices."

## Trigger

Activate this skill when the user mentions:
- email,  ecommerce,  cart-abandonment workflows or issues
- Building, fixing, or optimizing email marketing abandoned cart recovery best practices
