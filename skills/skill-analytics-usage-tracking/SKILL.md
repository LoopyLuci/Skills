...
"Use when tracking skill usage and performance analytics."

## Trigger

Activate this skill when the user mentions:
- meta,  skill-analytics,  usage-tracking,  performance,  metrics,  dashboards workflows or issues
- Building, fixing, or optimizing skill analytics usage tracking
...
`meta, skill-analytics, usage-tracking, performance, metrics, dashboards`
