---
name: aws-audit-manager-implementation
description: "Use when applying aws audit manager implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Audit Manager Implementation

"Use when applying aws audit manager implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  audit-manager,  compliance,  audit workflows or issues
- Building, fixing, or optimizing aws audit manager implementation
