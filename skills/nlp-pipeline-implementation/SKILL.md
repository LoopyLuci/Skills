...
"Use when building end-to-end NLP processing pipelines."

## Trigger

Activate this skill when the user mentions:
- nlp,  pipeline,  text-processing,  tokenization,  NER,  parsing,  classification workflows or issues
- Building, fixing, or optimizing nlp pipeline implementation
- Questions about nlp best practices
...
`nlp, pipeline, text-processing, tokenization, NER, parsing, classification`
