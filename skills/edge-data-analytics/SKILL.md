...
"Use when analyzing edge data."

## Trigger

Activate this skill when the user mentions:
- edge-computing,  data-analytics,  edge-analytics,  real-time workflows or issues
- Building, fixing, or optimizing edge data analytics
...
`edge-computing, data-analytics, edge-analytics, real-time`
