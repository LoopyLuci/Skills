---
name: crypto-crypto-wallet-dev-fundamentals
description: Use when applying wallet development fundamentals.
version: 1.0.0
...
# Crypto Crypto Wallet Dev Fundamentals

"Use when applying wallet development fundamentals."

## Trigger

Activate this skill when the user mentions:
- crypto,  wallet,  blockchain-development-solidity workflows or issues
- Building, fixing, or optimizing crypto crypto wallet dev fundamentals
