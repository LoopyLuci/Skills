---
name: embedded-databases-best-practices
description: "Use when applying embedded databases best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Embedded Databases Best Practices

"Use when applying embedded databases best practices."

## Trigger

Activate this skill when the user mentions:
- database,  embedded,  sqlite,  leveldb workflows or issues
- Building, fixing, or optimizing embedded databases best practices
...
`database, embedded, sqlite, leveldb`
