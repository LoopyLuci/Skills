---
name: email-marketing-unsubscribe-fundamentals
description: Use when applying email unsubscribe fundamentals.
version: 1.0.0
...
# Email Marketing Unsubscribe Fundamentals

"Use when applying email unsubscribe fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  unsubscribe workflows or issues
- Building, fixing, or optimizing email marketing unsubscribe fundamentals
