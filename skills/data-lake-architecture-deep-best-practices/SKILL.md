---
name: data-lake-architecture-deep-best-practices
description: "Use when applying data lake architecture best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Data Lake Architecture Deep Best Practices

"Use when applying data lake architecture best practices."

## Trigger

Activate this skill when the user mentions:
- data,  data-lake workflows or issues
- Building, fixing, or optimizing data lake architecture deep best practices
