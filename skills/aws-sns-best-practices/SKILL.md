---
name: aws-sns-best-practices
description: Use when applying aws sns best practices.
version: 1.0.0
...
"Use when applying aws sns best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  sns,  notifications,  pub-sub workflows or issues
- Building, fixing, or optimizing aws sns best practices
