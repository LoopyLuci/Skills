---
name: agricultural-data-troubleshooting
description: Use when applying agricultural data troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [agriculture, data, analytics]
---

# Agricultural Data Troubleshooting

"Use when applying agricultural data troubleshooting."

## Trigger

Activate this skill when the user mentions:
- agriculture,  data,  analytics workflows or issues
- Building, fixing, or optimizing agricultural data troubleshooting
