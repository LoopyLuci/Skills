---
name: failure-analysis-best-practices
description: Use when applying failure analysis best practices.
version: 1.0.0
...
"Use when applying failure analysis best practices."

## Trigger

Activate this skill when the user mentions:
- materials,  engineering,  failure-mode-analysis workflows or issues
- Building, fixing, or optimizing failure analysis best practices
