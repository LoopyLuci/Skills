---
name: email-marketing-automation-workflows-fundamentals
description: Use when applying email workflows fundamentals.
version: 1.0.0
...
# Email Marketing Automation Workflows Fundamentals

"Use when applying email workflows fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  workflows workflows or issues
- Building, fixing, or optimizing email marketing automation workflows fundamentals
