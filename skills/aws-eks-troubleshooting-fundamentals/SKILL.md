---
name: aws-eks-troubleshooting-fundamentals
description: Use when applying aws eks troubleshooting fundamentals.
version: 1.0.0
...
# Aws Eks Troubleshooting Fundamentals

"Use when applying aws eks troubleshooting fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  eks workflows or issues
- Building, fixing, or optimizing aws eks troubleshooting fundamentals
