---
name: docker-compose-migration-deep-troubleshooting
description: "Use when applying docker compose migration troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Docker Compose Migration Deep Troubleshooting

"Use when applying docker compose migration troubleshooting."

## Trigger

Activate this skill when the user mentions:
- devops,  docker workflows or issues
- Building, fixing, or optimizing docker compose migration deep troubleshooting
