---
name: email-protocol-fundamentals
description: "Use when applying email protocol fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email protocol fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  smtp,  imap,  pop3 workflows or issues
- Building, fixing, or optimizing email protocol fundamentals
