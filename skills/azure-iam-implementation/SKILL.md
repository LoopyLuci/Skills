---
name: azure-iam-implementation
description: Use when applying azure iam implementation.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, azure, iam, rbac]
---

# Azure Iam Implementation

"Use when applying azure iam implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  iam,  rbac workflows or issues
- Building, fixing, or optimizing azure iam implementation
