...
"Use when designing electric power steering."

## Trigger

Activate this skill when the user mentions:
- automotive,  eps,  steering,  electric workflows or issues
- Building, fixing, or optimizing electric power steering design
...
`automotive, eps, steering, electric`
