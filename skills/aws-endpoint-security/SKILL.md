...
"Use when applying AWS endpoint security."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  endpoint-security-best-practices workflows or issues
- Building, fixing, or optimizing aws endpoint security
...
`cloud, aws, endpoint-security-best-practices`
