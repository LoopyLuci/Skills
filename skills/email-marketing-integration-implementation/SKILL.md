---
name: email-marketing-integration-implementation
description: "Use when applying email integration implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Integration Implementation

"Use when applying email integration implementation."

## Trigger

Activate this skill when the user mentions:
- email,  integration,  api workflows or issues
- Building, fixing, or optimizing email marketing integration implementation
