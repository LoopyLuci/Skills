...
Smart contract auditing, formal verification, and bug bounties

## Trigger

Activate this skill when the user mentions:
- "security",  "auditing" workflows or issues
- Building, fixing, or optimizing blockchain security auditing
