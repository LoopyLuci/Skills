...
"Use when designing Airflow DAGs."

## Trigger

Activate this skill when the user mentions:
- "airflow",  "DAGs",  "tasks",  "scheduling",  "operators" workflows or issues
- Building, fixing, or optimizing airflow dag design
- Questions about "airflow" best practices
...
`"airflow", "DAGs", "tasks", "scheduling", "operators"`
