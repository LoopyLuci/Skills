---
name: database-replication-best-practices
description: Use when for database replication best practices.
version: 1.0.0
...
"Use when for database replication best practices."

## Trigger

Activate this skill when the user mentions:
- database,  replication,  high-availability,  cluster workflows or issues
- Building, fixing, or optimizing database replication best practices
