---
name: financial-modeling-troubleshooting
description: Use when applying financial modeling troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [finance, modeling, financial-modeling]
---

# Financial Modeling Troubleshooting

"Use when applying financial modeling troubleshooting."

## Trigger

Activate this skill when the user mentions:
- finance,  modeling,  financial-modeling workflows or issues
- Building, fixing, or optimizing financial modeling troubleshooting
...
`finance, modeling, financial-modeling`
