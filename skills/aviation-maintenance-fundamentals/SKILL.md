---
name: aviation-maintenance-fundamentals
description: Use when applying aviation maintenance fundamentals.
version: 1.0.0
...
"Use when applying aviation maintenance fundamentals."

## Trigger

Activate this skill when the user mentions:
- aviation,  maintenance,  aircraft-certification workflows or issues
- Building, fixing, or optimizing aviation maintenance fundamentals
