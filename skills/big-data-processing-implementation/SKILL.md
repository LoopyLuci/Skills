---
name: big-data-processing-implementation
description: Use when for big data processing implementation.
version: 1.0.0
...
- Building, fixing, or optimizing big data processing implementation
