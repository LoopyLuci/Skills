...
"Use when implementing SMS marketing and messaging campaigns."

## Trigger

Activate this skill when the user mentions:
- sms,  messaging,  text-marketing,  SMS-campaigns,  compliance,  TCPA workflows or issues
- Building, fixing, or optimizing sms marketing messaging
- Questions about sms best practices
...
`sms, messaging, text-marketing, SMS-campaigns, compliance, TCPA`
