---
name: email-markering-fundamentals
description: Use when applying email marketing fundamentals.
version: 1.0.0
...
# Email Markering Fundamentals

"Use when applying email marketing fundamentals."

## Trigger

Activate this skill when the user mentions:
- marketing,  email,  email-marketing-campaigns workflows or issues
- Building, fixing, or optimizing email markering fundamentals
