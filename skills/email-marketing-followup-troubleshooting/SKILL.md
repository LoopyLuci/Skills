---
name: email-marketing-followup-troubleshooting
description: Use when applying email follow-up troubleshooting.
version: 1.0.0
...
# Email Marketing Followup Troubleshooting

"Use when applying email follow-up troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  follow-up,  sales workflows or issues
- Building, fixing, or optimizing email marketing followup troubleshooting
