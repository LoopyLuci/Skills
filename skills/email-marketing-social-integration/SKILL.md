---
name: email-marketing-social-integration
description: Use when connecting email to social.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, marketing, social, integration]
---

# Email Marketing Social Integration

"Use when connecting email to social."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  social,  integration workflows or issues
- Building, fixing, or optimizing email marketing social integration
