---
name: data-governance-best-practices
description: "Use when for data governance best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [data-governance, compliance, metadata]
    related_skills: [general]
---

# Data Governance Best Practices

"Use when for data governance best practices."

## Trigger

Activate this skill when the user mentions:
- data-governance,  compliance,  metadata workflows or issues
- Building, fixing, or optimizing data governance best practices
