---
name: email-marketing-spam-fundamentals
description: "Use when applying email spam fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Spam Fundamentals

"Use when applying email spam fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  spam,  deliverability workflows or issues
- Building, fixing, or optimizing email marketing spam fundamentals
