...
"Use when managing EV battery systems."

## Trigger

Activate this skill when the user mentions:
- automotive,  bms,  battery-management,  ev-battery workflows or issues
- Building, fixing, or optimizing battery management systems
...
`automotive, bms, battery-management, ev-battery`
