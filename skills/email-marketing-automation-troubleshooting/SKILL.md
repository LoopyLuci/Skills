---
name: email-marketing-automation-troubleshooting
description: Use when applying email marketing automation troubleshoo.
version: 1.0.0
...
"Use when applying email marketing automation troubleshoo."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-automation workflows or issues
- Building, fixing, or optimizing email marketing automation troubleshooting
