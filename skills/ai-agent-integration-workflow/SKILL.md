...
"AI agents: use cases, deployment, analytics."

## Trigger

Activate this skill when the user mentions:
- ai,  agents,  chatbot,  integration,  automation workflows or issues
- Building, fixing, or optimizing ai agent integration workflow
...
`ai, agents, chatbot, integration, automation`
