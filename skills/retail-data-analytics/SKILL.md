...
Customer analytics, basket analysis, churn prediction, and RFM modeling

## Trigger

Activate this skill when the user mentions:
- "analytics",  "retail" workflows or issues
- Building, fixing, or optimizing retail data analytics
