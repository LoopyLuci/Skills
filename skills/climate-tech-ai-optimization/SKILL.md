...
"Use when optimizing climate tech with AI."

## Trigger

Activate this skill when the user mentions:
- cross-domain,  climate-ai,  renewable-optimization,  ml workflows or issues
- Building, fixing, or optimizing climate tech ai optimization
...
`cross-domain, climate-ai, renewable-optimization, ml`
