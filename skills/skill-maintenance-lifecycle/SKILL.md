...
"Use when maintaining and updating existing skills."

## Trigger

Activate this skill when the user mentions:
- meta,  skill-maintenance,  lifecycle,  updates,  versioning,  deprecation workflows or issues
- Building, fixing, or optimizing skill maintenance lifecycle
...
`meta, skill-maintenance, lifecycle, updates, versioning, deprecation`
