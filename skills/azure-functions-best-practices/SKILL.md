...
description: Use when applying azure functions best practices.
version: 1.0.0
...
"Use when applying azure functions best practices."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  functions,  lambda workflows or issues
- Building, fixing, or optimizing azure functions best practices
