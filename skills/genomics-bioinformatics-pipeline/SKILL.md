...
NGS pipelines, variant calling, annotation, and clinical genomics

## Trigger

Activate this skill when the user mentions:
- "genomics",  "ngs" workflows or issues
- Building, fixing, or optimizing genomics bioinformatics pipeline
- Questions about "genomics" best practices
