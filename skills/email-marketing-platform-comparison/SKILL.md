---
name: email-marketing-platform-comparison
description: "Use when comparing email platforms."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [email, marketing, platform, comparison]
    related_skills: [general]
---

# Email Marketing Platform Comparison

"Use when comparing email platforms."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  platform,  comparison workflows or issues
- Building, fixing, or optimizing email marketing platform comparison
