...
description: "Use when applying docker compose best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying docker compose best practices."

## Trigger

Activate this skill when the user mentions:
- docker,  compose,  docker-compose-patterns workflows or issues
- Building, fixing, or optimizing docker compose best practices
