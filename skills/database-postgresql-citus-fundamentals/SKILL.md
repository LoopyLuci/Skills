---
name: database-postgresql-citus-fundamentals
description: Use when applying postgresql citus fundamentals.
version: 1.0.0
...
# Database Postgresql Citus Fundamentals

"Use when applying postgresql citus fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  citus,  sharding workflows or issues
- Building, fixing, or optimizing database postgresql citus fundamentals
