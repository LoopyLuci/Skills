---
name: email-marketing-abandoned-cart-best-practices
description: Use when applying email abandoned cart best practices.
version: 1.0.0
...
# Email Marketing Abandoned Cart Best Practices

"Use when applying email abandoned cart best practices."

## Trigger

Activate this skill when the user mentions:
- email,  ecommerce,  cart-abandonment workflows or issues
- Building, fixing, or optimizing email marketing abandoned cart best practices
