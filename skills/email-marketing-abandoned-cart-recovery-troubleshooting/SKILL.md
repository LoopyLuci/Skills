---
name: email-marketing-abandoned-cart-recovery-troubleshooting
description: "Use when applying abandoned cart recovery troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Abandoned Cart Recovery Troubleshooting

"Use when applying abandoned cart recovery troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  ecommerce,  cart-abandonment workflows or issues
- Building, fixing, or optimizing email marketing abandoned cart recovery troubleshooting
