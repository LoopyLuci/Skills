...
"Use when applying biotechnology best practices."

## Trigger

Activate this skill when the user mentions:
- biotech,  biotech-eng-fundamentals workflows or issues
- Building, fixing, or optimizing biotechnology best practices
...
`biotech, biotech-eng-fundamentals`
