...
"Use when securing elections. Voting systems, audit."

## Trigger

Activate this skill when the user mentions:
- govtech,  election-security,  voting,  cybersecurity workflows or issues
- Building, fixing, or optimizing election security
...
`govtech, election-security, voting, cybersecurity`
