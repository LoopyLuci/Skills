...
"Use when orchestrating edge workloads."

## Trigger

Activate this skill when the user mentions:
- edge-computing,  orchestration,  kubernetes,  k3s workflows or issues
- Building, fixing, or optimizing edge orchestration
...
`edge-computing, orchestration, kubernetes, k3s`
