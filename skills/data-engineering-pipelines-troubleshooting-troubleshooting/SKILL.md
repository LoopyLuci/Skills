---
name: data-engineering-pipelines-troubleshooting-troubleshooting
description: Use when applying data engineering troubleshooting troub.
version: 1.0.0
...
metadata:
  hermes:
    tags: [data, data-eng-troubleshooting]
---

# Data Engineering Pipelines Troubleshooting Troubleshooting

"Use when applying data engineering troubleshooting troub."

## Trigger

Activate this skill when the user mentions:
- data,  data-eng-troubleshooting workflows or issues
- Building, fixing, or optimizing data engineering pipelines troubleshooting troubleshooting
