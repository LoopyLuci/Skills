...
Multi-touch attribution, marketing mix modeling, incrementality, and data layers

## Trigger

Activate this skill when the user mentions:
- "analytics",  "attribution" workflows or issues
- Building, fixing, or optimizing marketing analytics attribution
