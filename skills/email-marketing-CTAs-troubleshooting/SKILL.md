---
name: email-marketing-CTAs-troubleshooting
description: "Use when applying email ctas troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Ctas Troubleshooting

"Use when applying email ctas troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  copywriting,  call-to-action workflows or issues
- Building, fixing, or optimizing email marketing ctas troubleshooting
...
`email, copywriting, call-to-action`
