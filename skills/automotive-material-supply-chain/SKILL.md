...
"Use when managing auto material supply."

## Trigger

Activate this skill when the user mentions:
- automotive,  materials-supply,  commodity-risk,  sourcing workflows or issues
- Building, fixing, or optimizing automotive material supply chain
...
`automotive, materials-supply, commodity-risk, sourcing`
