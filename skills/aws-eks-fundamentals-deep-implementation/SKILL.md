---
name: aws-eks-fundamentals-deep-implementation
description: "Use when applying aws eks fundamentals implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Eks Fundamentals Deep Implementation

"Use when applying aws eks fundamentals implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  eks workflows or issues
- Building, fixing, or optimizing aws eks fundamentals deep implementation
