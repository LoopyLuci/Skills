---
name: database-cassandra-tuning-fundamentals
description: Use when applying cassandra tuning fundamentals.
version: 1.0.0
...
# Database Cassandra Tuning Fundamentals

"Use when applying cassandra tuning fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  cassandra,  tuning,  performance workflows or issues
- Building, fixing, or optimizing database cassandra tuning fundamentals
