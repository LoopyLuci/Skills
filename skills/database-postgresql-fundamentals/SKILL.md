---
name: database-postgresql-fundamentals
description: Use when applying postgresql fundamentals.
version: 1.0.0
...
"Use when applying postgresql fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  postgres,  sql workflows or issues
- Building, fixing, or optimizing database postgresql fundamentals
