---
name: botany-troubleshooting
description: "Use when troubleshooting botany issues."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [botany, plants, botany, flora]
    related_skills: [general]
---

## Overview
Apply troubleshooting botany issues for effective results. 

## When to Use
- "Botany Troubleshooting design and implementation"
- "Best practices for Botany Troubleshooting"
- "Botany Troubleshooting optimization and scaling"
- "Botany Troubleshooting troubleshooting and validation"
