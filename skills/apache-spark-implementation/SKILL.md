---
name: apache-spark-implementation
description: Use when for apache spark implementation.
version: 1.0.0
...
"Use when for apache spark implementation."

## Trigger

Activate this skill when the user mentions:
- big-data,  spark,  scala,  python workflows or issues
- Building, fixing, or optimizing apache spark implementation
