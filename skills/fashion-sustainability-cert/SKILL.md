---
name: fashion-sustainability-cert
...
metadata:
  hermes:
    tags: [fashion, sustainability, certification, eco]
    related_skills: ['fashion-sustainability-certification']
---

# Fashion Sustainability Cert

"Use when certifying fashion sustainability."

## Trigger

Activate this skill when the user mentions:
- fashion,  sustainability,  certification,  eco workflows or issues
- Building, fixing, or optimizing fashion sustainability cert
...
`fashion, sustainability, certification, eco`
