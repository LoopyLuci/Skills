---
name: database-mongodb-performance-best-practices
description: Use when applying mongodb performance best practices.
version: 1.0.0
...
# Database Mongodb Performance Best Practices

"Use when applying mongodb performance best practices."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  performance,  optimization workflows or issues
- Building, fixing, or optimizing database mongodb performance best practices
