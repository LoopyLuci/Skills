---
name: database-backup-fundamentals
description: Use when for database backups fundamentals.
version: 1.0.0
...
"Use when for database backups fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  backup,  recovery,  postgresql,  mysql workflows or issues
- Building, fixing, or optimizing database backup fundamentals
