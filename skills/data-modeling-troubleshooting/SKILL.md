...
# Data Modeling Troubleshooting

"Use when troubleshooting data modeling."

## Trigger

Activate this skill when the user mentions:
- database,  data-modeling,  schema-design workflows or issues
- Building, fixing, or optimizing data modeling troubleshooting
