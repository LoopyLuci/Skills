---
name: email-marketing-survival-guide-fundamentals
description: "Use when applying email survival guide fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Survival Guide Fundamentals

"Use when applying email survival guide fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  spam-filter workflows or issues
- Building, fixing, or optimizing email marketing survival guide fundamentals
