...
"Use when transforming data with dbt."

## Trigger

Activate this skill when the user mentions:
- "dbt",  "data-transformation",  "SQL",  "models",  "testing" workflows or issues
- Building, fixing, or optimizing dbt data transformation
- Questions about "dbt" best practices
...
`"dbt", "data-transformation", "SQL", "models", "testing"`
