---
name: email-marketing-win-back-fundamentals
description: "Use when applying win-back email fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Win Back Fundamentals

"Use when applying win-back email fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  retention,  win-back workflows or issues
- Building, fixing, or optimizing email marketing win back fundamentals
