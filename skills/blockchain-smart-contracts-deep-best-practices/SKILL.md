---
name: blockchain-smart-contracts-deep-best-practices
description: Use when applying smart contract dev best practices.
version: 1.0.0
...
# Blockchain Smart Contracts Deep Best Practices

"Use when applying smart contract dev best practices."

## Trigger

Activate this skill when the user mentions:
- blockchain,  contracts workflows or issues
- Building, fixing, or optimizing blockchain smart contracts deep best practices
