---
name: datadog-fundamentals-deep-troubleshooting
description: "Use when applying datadog fundamentals troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [sys, monitoring]
    related_skills: ['datadog-fundamentals']
---

# Datadog Fundamentals Deep Troubleshooting

"Use when applying datadog fundamentals troubleshooting."

## Trigger

Activate this skill when the user mentions:
- sys,  monitoring workflows or issues
- Building, fixing, or optimizing datadog fundamentals deep troubleshooting
