---
name: email-marketing-transactional-troubleshooting
description: "Use when applying transactional email troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Transactional Troubleshooting

"Use when applying transactional email troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  transactional,  triggered workflows or issues
- Building, fixing, or optimizing email marketing transactional troubleshooting
