---
name: data-lake-architecture-deep-implementation
description: "Use when applying data lake architecture implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Data Lake Architecture Deep Implementation

"Use when applying data lake architecture implementation."

## Trigger

Activate this skill when the user mentions:
- data,  data-lake workflows or issues
- Building, fixing, or optimizing data lake architecture deep implementation
