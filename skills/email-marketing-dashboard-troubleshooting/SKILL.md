---
name: email-marketing-dashboard-troubleshooting
description: "Use when applying email dashboard troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Dashboard Troubleshooting

"Use when applying email dashboard troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  dashboard,  analytics workflows or issues
- Building, fixing, or optimizing email marketing dashboard troubleshooting
