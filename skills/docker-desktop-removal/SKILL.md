...
"Use when removing Docker Desktop."

## Trigger

Activate this skill when the user mentions:
- devops,  docker,  docker-desktop-windows-removal workflows or issues
- Building, fixing, or optimizing docker desktop removal
...
`devops, docker, docker-desktop-windows-removal`
