---
name: email-marketing-tools-implementation
description: "Use when applying email marketing tools implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Tools Implementation

"Use when applying email marketing tools implementation."

## Trigger

Activate this skill when the user mentions:
- email,  tools,  marketing workflows or issues
- Building, fixing, or optimizing email marketing tools implementation
