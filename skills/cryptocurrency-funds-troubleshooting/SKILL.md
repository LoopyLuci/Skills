---
name: cryptocurrency-funds-troubleshooting
description: Use when applying crypto funds troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [finance, crypto, crypto-funds]
---

# Cryptocurrency Funds Troubleshooting

"Use when applying crypto funds troubleshooting."

## Trigger

Activate this skill when the user mentions:
- finance,  crypto,  crypto-funds workflows or issues
- Building, fixing, or optimizing cryptocurrency funds troubleshooting
