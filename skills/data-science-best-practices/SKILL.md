...
description: "Use when applying data science best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [ds, data, data-science-fundamentals]
    related_skills: [general]
---

# Data Science Best Practices

"Use when applying data science best practices."

## Trigger

Activate this skill when the user mentions:
- ds,  data,  data-science-fundamentals workflows or issues
- Building, fixing, or optimizing data science best practices
- Questions about ds best practices
...
`ds, data, data-science-fundamentals`
