---
name: aws-security-training
description: Use when training AWS security.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, security-awareness-best-practices]
---

# Aws Security Training

"Use when training AWS security."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  security-awareness-best-practices workflows or issues
- Building, fixing, or optimizing aws security training
...
`cloud, aws, security-awareness-best-practices`
