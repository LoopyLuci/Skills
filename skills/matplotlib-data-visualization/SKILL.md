...
"Use when visualizing data with Matplotlib."

## Trigger

Activate this skill when the user mentions:
- "matplotlib",  "plots",  "charts",  "customization",  "styling" workflows or issues
- Building, fixing, or optimizing matplotlib data visualization
- Questions about "matplotlib" best practices
...
`"matplotlib", "plots", "charts", "customization", "styling"`
