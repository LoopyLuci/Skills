...
"Use when optimizing MySQL queries."

## Trigger

Activate this skill when the user mentions:
- "mysql",  "optimization",  "indexes",  "slow-query",  "explain" workflows or issues
- Building, fixing, or optimizing mysql query optimization
- Questions about "mysql" best practices
...
`"mysql", "optimization", "indexes", "slow-query", "explain"`
