---
name: biotech-data-management-fundamentals
description: Use when applying biotech data management fundamentals.
version: 1.0.0
...
# Biotech Data Management Fundamentals

"Use when applying biotech data management fundamentals."

## Trigger

Activate this skill when the user mentions:
- biotech,  data,  data-mgmt workflows or issues
- Building, fixing, or optimizing biotech data management fundamentals
