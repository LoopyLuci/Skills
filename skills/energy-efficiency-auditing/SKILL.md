...
"Use when auditing energy efficiency. Walkthrough, analysis."

## Trigger

Activate this skill when the user mentions:
- climatetech,  energy-audit,  efficiency,  buildings workflows or issues
- Building, fixing, or optimizing energy efficiency auditing
...
`climatetech, energy-audit, efficiency, buildings`
