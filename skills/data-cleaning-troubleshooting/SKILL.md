---
name: data-cleaning-troubleshooting
description: "Use when applying data cleaning troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [data, cleaning, data-cleaning-techniques]
    related_skills: [general]
---

# Data Cleaning Troubleshooting

"Use when applying data cleaning troubleshooting."

## Trigger

Activate this skill when the user mentions:
- data,  cleaning,  data-cleaning-techniques workflows or issues
- Building, fixing, or optimizing data cleaning troubleshooting
...
`data, cleaning, data-cleaning-techniques`
