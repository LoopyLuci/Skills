...
"Use when implementing biotech manufacturing 4.0."

## Trigger

Activate this skill when the user mentions:
- cross-domain,  biotech-manufacturing,  industry-4.0,  automation workflows or issues
- Building, fixing, or optimizing biotech manufacturing 4.0
...
`cross-domain, biotech-manufacturing, industry-4.0, automation`
