---
name: customer-analytics-implementation
description: Use when applying customer analytics implementation.
version: 1.0.0
...
"Use when applying customer analytics implementation."

## Trigger

Activate this skill when the user mentions:
- business,  customer,  analytics,  digital-marketing-analytics workflows or issues
- Building, fixing, or optimizing customer analytics implementation
