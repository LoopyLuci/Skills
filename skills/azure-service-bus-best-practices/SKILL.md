...
description: "Use when applying azure service bus best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure service bus best practices."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  service-bus,  mq workflows or issues
- Building, fixing, or optimizing azure service bus best practices
