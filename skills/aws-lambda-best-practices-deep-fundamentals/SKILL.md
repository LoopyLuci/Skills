---
name: aws-lambda-best-practices-deep-fundamentals
description: "Use when applying aws lambda fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Lambda Best Practices Deep Fundamentals

"Use when applying aws lambda fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  lambda workflows or issues
- Building, fixing, or optimizing aws lambda best practices deep fundamentals
