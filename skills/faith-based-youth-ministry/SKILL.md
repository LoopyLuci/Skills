...
"Use when leading youth ministry programs."

## Trigger

Activate this skill when the user mentions:
- religious,  youth-ministry,  teenagers,  faith-education workflows or issues
- Building, fixing, or optimizing faith based youth ministry
...
`religious, youth-ministry, teenagers, faith-education`
