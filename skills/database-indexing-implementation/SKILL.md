---
name: database-indexing-implementation
description: Use when for database indexing implementation.
version: 1.0.0
...
"Use when for database indexing implementation."

## Trigger

Activate this skill when the user mentions:
- database,  indexing,  performance,  optimization workflows or issues
- Building, fixing, or optimizing database indexing implementation
