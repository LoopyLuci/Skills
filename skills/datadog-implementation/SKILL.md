---
name: datadog-implementation
description: Use when applying datadog implementation.
version: 1.0.0
...
"Use when applying datadog implementation."

## Trigger

Activate this skill when the user mentions:
- monitoring,  datadog,  apm,  infrastructure workflows or issues
- Building, fixing, or optimizing datadog implementation
