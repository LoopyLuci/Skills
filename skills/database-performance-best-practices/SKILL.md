---
name: database-performance-best-practices
description: "Use when for database performance best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database performance best practices."

## Trigger

Activate this skill when the user mentions:
- database,  performance,  optimization,  tuning workflows or issues
- Building, fixing, or optimizing database performance best practices
