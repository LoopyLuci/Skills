---
name: aws-redshift-fundamentals
description: Use when applying aws redshift fundamentals.
version: 1.0.0
...
"Use when applying aws redshift fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  redshift,  data-warehouse,  analytics workflows or issues
- Building, fixing, or optimizing aws redshift fundamentals
