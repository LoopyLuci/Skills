---
name: email-marketing-metrics-kpis-fundamentals
description: Use when applying email kpis fundamentals.
version: 1.0.0
...
# Email Marketing Metrics Kpis Fundamentals

"Use when applying email kpis fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  kpis workflows or issues
- Building, fixing, or optimizing email marketing metrics kpis fundamentals
