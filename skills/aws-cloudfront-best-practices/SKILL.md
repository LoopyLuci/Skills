---
name: aws-cloudfront-best-practices
description: Use when applying aws cloudfront best practices.
version: 1.0.0
...
"Use when applying aws cloudfront best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  cloudfront,  cdn,  caching workflows or issues
- Building, fixing, or optimizing aws cloudfront best practices
