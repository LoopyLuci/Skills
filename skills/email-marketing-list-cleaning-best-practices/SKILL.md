---
name: email-marketing-list-cleaning-best-practices
description: Use when applying email list cleaning best practices.
version: 1.0.0
...
# Email Marketing List Cleaning Best Practices

"Use when applying email list cleaning best practices."

## Trigger

Activate this skill when the user mentions:
- email,  hygiene,  list-cleaning workflows or issues
- Building, fixing, or optimizing email marketing list cleaning best practices
