---
name: decentralized-finance-optimization
description: Use when for defi optimization.
version: 1.0.0
...
"Use when for defi optimization."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing decentralized finance optimization
