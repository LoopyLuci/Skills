...
"Use for debugging. Systematic: reproduce, isolate, fix."

## Trigger

Activate this skill when the user mentions:
- programming,  debugging,  troubleshooting,  bugs,  root-cause-analysis workflows or issues
- Building, fixing, or optimizing debugging workflow
...
`programming, debugging, troubleshooting, bugs, root-cause-analysis`
