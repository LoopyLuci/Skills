---
name: email-marketing-management-fundamentals
description: "Use when applying email marketing mgmt fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Management Fundamentals

"Use when applying email marketing mgmt fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-management workflows or issues
- Building, fixing, or optimizing email marketing management fundamentals
