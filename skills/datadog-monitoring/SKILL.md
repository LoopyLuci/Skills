...
"Use when monitoring with Datadog."

## Trigger

Activate this skill when the user mentions:
- monitoring,  datadog,  apms,  alerts workflows or issues
- Building, fixing, or optimizing datadog monitoring
...
`monitoring, datadog, apms, alerts`
