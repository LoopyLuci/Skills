---
name: database-migrations-best-practices
description: Use when for database migrations best practices.
version: 1.0.0
...
"Use when for database migrations best practices."

## Trigger

Activate this skill when the user mentions:
- database,  migrations,  schema-evolution workflows or issues
- Building, fixing, or optimizing database migrations best practices
