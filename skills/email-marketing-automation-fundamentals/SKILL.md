---
name: email-marketing-automation-fundamentals
description: Use when applying email marketing automation fundamentals.
version: 1.0.0
...
"Use when applying email marketing automation fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-automation workflows or issues
- Building, fixing, or optimizing email marketing automation fundamentals
