...
"Use when building systems designed to last 100+ years."

## Trigger

Activate this skill when the user mentions:
- architecture,  longevity,  schema-versioning,  self-healing,  plugin-systems,  atomic-writes,  forward-compat workflows or issues
- Building, fixing, or optimizing century architecture patterns
...
`architecture, longevity, schema-versioning, self-healing, plugin-systems, atomic-writes, forward-compat`
