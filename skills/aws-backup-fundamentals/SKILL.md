---
name: aws-backup-fundamentals
description: Use when applying aws backup fundamentals.
version: 1.0.0
...
"Use when applying aws backup fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  backup,  disaster-recovery workflows or issues
- Building, fixing, or optimizing aws backup fundamentals
