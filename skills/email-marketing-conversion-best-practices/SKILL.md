---
name: email-marketing-conversion-best-practices
description: Use when applying email conversion best practices.
version: 1.0.0
...
# Email Marketing Conversion Best Practices

"Use when applying email conversion best practices."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  conversion workflows or issues
- Building, fixing, or optimizing email marketing conversion best practices
