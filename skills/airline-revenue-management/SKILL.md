...
"Use when managing airline revenue."

## Trigger

Activate this skill when the user mentions:
- travel,  airline-revenue,  pricing,  yield-management workflows or issues
- Building, fixing, or optimizing airline revenue management
...
`travel, airline-revenue, pricing, yield-management`
