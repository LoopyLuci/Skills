---
name: database-postgresql-partitioning-fundamentals
...
# Database Postgresql Partitioning Fundamentals

"Use when applying postgresql partitioning fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  partitioning,  scale workflows or issues
- Building, fixing, or optimizing database postgresql partitioning fundamentals
