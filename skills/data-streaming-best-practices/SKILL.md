---
name: data-streaming-best-practices
description: "Use when for data streaming best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [data-streaming, kafka, events]
    related_skills: [general]
---

# Data Streaming Best Practices

"Use when for data streaming best practices."

## Trigger

Activate this skill when the user mentions:
- data-streaming,  kafka,  events workflows or issues
- Building, fixing, or optimizing data streaming best practices
- Questions about data-streaming best practices
