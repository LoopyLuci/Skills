---
name: email-marketing-automation-implementation
description: Use when applying email marketing automation implementat.
version: 1.0.0
...
"Use when applying email marketing automation implementat."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-automation workflows or issues
- Building, fixing, or optimizing email marketing automation implementation
