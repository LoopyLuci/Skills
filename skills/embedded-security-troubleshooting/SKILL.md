---
name: embedded-security-troubleshooting
description: "Use when for embedded security troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Embedded Security Troubleshooting

"Use when for embedded security troubleshooting."

## Trigger

Activate this skill when the user mentions:
- security,  embedded,  firmware,  iot workflows or issues
- Building, fixing, or optimizing embedded security troubleshooting
...
`security, embedded, firmware, iot`
