---
name: database-postgresql-extensions-troubleshooting
description: "Use when applying postgresql extensions troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [database, postgresql, extensions, contrib]
    related_skills: [general]
---

# Database Postgresql Extensions Troubleshooting

"Use when applying postgresql extensions troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  extensions,  contrib workflows or issues
- Building, fixing, or optimizing database postgresql extensions troubleshooting
...
`database, postgresql, extensions, contrib`
