---
name: data-governance-fundamentals-deep-best-practices
description: Use when applying data governance fundamentals best prac.
version: 1.0.0
...
# Data Governance Fundamentals Deep Best Practices

"Use when applying data governance fundamentals best prac."

## Trigger

Activate this skill when the user mentions:
- data,  data-governance workflows or issues
- Building, fixing, or optimizing data governance fundamentals deep best practices
