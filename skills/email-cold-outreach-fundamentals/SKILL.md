---
name: email-cold-outreach-fundamentals
description: Use when applying email cold outreach fundamentals.
version: 1.0.0
...
# Email Cold Outreach Fundamentals

"Use when applying email cold outreach fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  sales,  outreach workflows or issues
- Building, fixing, or optimizing email cold outreach fundamentals
