---
name: email-marketing-compliance-implementation
description: Use when applying email compliance implementation.
version: 1.0.0
...
# Email Marketing Compliance Implementation

"Use when applying email compliance implementation."

## Trigger

Activate this skill when the user mentions:
- email,  legal,  gdpr,  can-spam workflows or issues
- Building, fixing, or optimizing email marketing compliance implementation
