---
name: data-warehousing-best-practices
description: Use when for data warehousing best practices.
version: 1.0.0
...
"Use when for data warehousing best practices."

## Trigger

Activate this skill when the user mentions:
- database,  data-warehouse,  etl workflows or issues
- Building, fixing, or optimizing data warehousing best practices
