...
description: "Use when applying aws cost optimization troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Cost Optimization Troubleshooting

"Use when applying aws cost optimization troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  cost-optimization,  cost,  finops workflows or issues
- Building, fixing, or optimizing aws cost optimization troubleshooting
...
`aws, cost-optimization, cost, finops`
