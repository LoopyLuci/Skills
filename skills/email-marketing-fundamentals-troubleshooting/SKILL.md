---
name: email-marketing-fundamentals-troubleshooting
description: Use when applying email marketing fundamentals troublesh.
version: 1.0.0
...
# Email Marketing Fundamentals Troubleshooting

"Use when applying email marketing fundamentals troublesh."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-fundamentals workflows or issues
- Building, fixing, or optimizing email marketing fundamentals troubleshooting
