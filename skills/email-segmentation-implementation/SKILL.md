---
name: email-segmentation-implementation
description: "Use when applying email segmentation implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email segmentation implementation."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  segmentation workflows or issues
- Building, fixing, or optimizing email segmentation implementation
