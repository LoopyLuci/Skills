---
name: database-elasticsearch-mapping-implementation
description: Use when applying elasticsearch mapping implementation.
version: 1.0.0
...
# Database Elasticsearch Mapping Implementation

"Use when applying elasticsearch mapping implementation."

## Trigger

Activate this skill when the user mentions:
- database,  elasticsearch,  mapping,  schema workflows or issues
- Building, fixing, or optimizing database elasticsearch mapping implementation
