---
name: email-segmentation-best-practices
description: Use when applying email segmentation best practices.
version: 1.0.0
...
"Use when applying email segmentation best practices."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  segmentation workflows or issues
- Building, fixing, or optimizing email segmentation best practices
