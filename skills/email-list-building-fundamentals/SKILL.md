---
name: email-list-building-fundamentals
description: "Use when applying email list building fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email list building fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  list-building-email-growth workflows or issues
- Building, fixing, or optimizing email list building fundamentals
