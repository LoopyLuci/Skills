...
description: "Use when applying aws well-architected troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Well Architected Troubleshooting

"Use when applying aws well-architected troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  well-architected,  best-practices workflows or issues
- Building, fixing, or optimizing aws well architected troubleshooting
