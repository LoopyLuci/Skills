---
name: email-marketing-metrics-troubleshooting
description: Use when applying email metrics troubleshooting.
version: 1.0.0
...
# Email Marketing Metrics Troubleshooting

"Use when applying email metrics troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  metrics workflows or issues
- Building, fixing, or optimizing email marketing metrics troubleshooting
