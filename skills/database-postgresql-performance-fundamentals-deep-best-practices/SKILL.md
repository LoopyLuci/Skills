---
name: database-postgresql-performance-fundamentals-deep-best-practices
description: Use when applying postgresql performance fundamentals be.
version: 1.0.0
...
# Database Postgresql Performance Fundamentals Deep Best Practices

"Use when applying postgresql performance fundamentals be."

## Trigger

Activate this skill when the user mentions:
- data,  postgres workflows or issues
- Building, fixing, or optimizing database postgresql performance fundamentals deep best practices
