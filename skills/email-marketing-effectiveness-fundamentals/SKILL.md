---
name: email-marketing-effectiveness-fundamentals
description: "Use when applying email effectiveness fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Effectiveness Fundamentals

"Use when applying email effectiveness fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  effectiveness workflows or issues
- Building, fixing, or optimizing email marketing effectiveness fundamentals
