...
Bridge protocols, cross-chain messaging, and interoperability

## Trigger

Activate this skill when the user mentions:
- "bridge",  "interop" workflows or issues
- Building, fixing, or optimizing cross chain bridges interop
- Questions about "bridge" best practices
