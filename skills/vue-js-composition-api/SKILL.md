...
"Use when building Vue apps with Composition API."

## Trigger

Activate this skill when the user mentions:
- "vue",  "composition-api",  "ref",  "reactive",  "composables" workflows or issues
- Building, fixing, or optimizing vue js composition api
