---
name: aws-eks-fundamentals-deep-best-practices
description: "Use when applying aws eks fundamentals best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Eks Fundamentals Deep Best Practices

"Use when applying aws eks fundamentals best practices."

## Trigger

Activate this skill when the user mentions:
- cloud,  eks workflows or issues
- Building, fixing, or optimizing aws eks fundamentals deep best practices
