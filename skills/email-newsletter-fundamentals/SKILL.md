---
name: email-newsletter-fundamentals
description: "Use when applying email newsletter fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Newsletter Fundamentals

"Use when applying email newsletter fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  publishing,  newsletter workflows or issues
- Building, fixing, or optimizing email newsletter fundamentals
