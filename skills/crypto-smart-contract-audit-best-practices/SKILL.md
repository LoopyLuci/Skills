---
name: crypto-smart-contract-audit-best-practices
description: Use when applying smart contract auditing best practices.
version: 1.0.0
...
# Crypto Smart Contract Audit Best Practices

"Use when applying smart contract auditing best practices."

## Trigger

Activate this skill when the user mentions:
- crypto,  audit,  blockchain-smart-contracts workflows or issues
- Building, fixing, or optimizing crypto smart contract audit best practices
