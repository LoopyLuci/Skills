---
name: automotive-powertrain-troubleshooting
description: Use when applying automotive powertrain troubleshooting.
version: 1.0.0
...
# Automotive Powertrain Troubleshooting

"Use when applying automotive powertrain troubleshooting."

## Trigger

Activate this skill when the user mentions:
- auto,  engineering,  vehicle-powertrain-optimization workflows or issues
- Building, fixing, or optimizing automotive powertrain troubleshooting
