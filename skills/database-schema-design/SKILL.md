...
"Use for DB schema design. Entities, normalization, indexes."

## Trigger

Activate this skill when the user mentions:
- programming,  database,  schema,  sql,  design,  normalization workflows or issues
- Building, fixing, or optimizing database schema design
...
`programming, database, schema, sql, design, normalization`
