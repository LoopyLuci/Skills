---
name: email-marketing-effectiveness-troubleshooting
description: "Use when applying email effectiveness troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [email, analytics, effectiveness]
    related_skills: [general]
---

# Email Marketing Effectiveness Troubleshooting

"Use when applying email effectiveness troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  effectiveness workflows or issues
- Building, fixing, or optimizing email marketing effectiveness troubleshooting
