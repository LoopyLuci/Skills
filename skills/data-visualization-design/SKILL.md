...
"Use when designing data visualizations."

## Trigger

Activate this skill when the user mentions:
- data-science,  viz,  charts,  dashboard workflows or issues
- Building, fixing, or optimizing data visualization design
...
`data-science, viz, charts, dashboard`
