---
name: container-shipping-troubleshooting
description: Use when applying container shipping troubleshooting.
version: 1.0.0
...
# Container Shipping Troubleshooting

"Use when applying container shipping troubleshooting."

## Trigger

Activate this skill when the user mentions:
- marine,  logistics,  container-shipping workflows or issues
- Building, fixing, or optimizing container shipping troubleshooting
...
`marine, logistics, container-shipping`
