---
name: aws-quicksight-fundamentals
description: Use when applying aws quicksight fundamentals.
version: 1.0.0
...
# Aws Quicksight Fundamentals

"Use when applying aws quicksight fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  quicksight,  bi,  dashboards workflows or issues
- Building, fixing, or optimizing aws quicksight fundamentals
