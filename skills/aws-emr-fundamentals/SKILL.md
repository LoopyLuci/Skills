---
name: aws-emr-fundamentals
description: Use when applying aws emr fundamentals.
version: 1.0.0
...
"Use when applying aws emr fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  emr,  hadoop,  spark workflows or issues
- Building, fixing, or optimizing aws emr fundamentals
