...
"Use when using HuggingFace Transformers."

## Trigger

Activate this skill when the user mentions:
- "huggingface",  "transformers",  "models",  "tokenizers" workflows or issues
- Building, fixing, or optimizing huggingface transformers
- Questions about "huggingface" best practices
