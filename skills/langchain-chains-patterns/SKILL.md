...
"Use when building LangChain chains."

## Trigger

Activate this skill when the user mentions:
- "langchain",  "chains",  "LLMChain",  "RouterChain" workflows or issues
- Building, fixing, or optimizing langchain chains patterns
...
`"langchain", "chains", "LLMChain", "RouterChain"`
