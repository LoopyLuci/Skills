---
name: email-responsiveness-fundamentals
description: Use when applying email responsiveness fundamentals.
version: 1.0.0
...
# Email Responsiveness Fundamentals

"Use when applying email responsiveness fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  design,  responsive workflows or issues
- Building, fixing, or optimizing email responsiveness fundamentals
