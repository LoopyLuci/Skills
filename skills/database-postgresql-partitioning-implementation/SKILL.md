---
name: database-postgresql-partitioning-implementation
description: Use when applying postgresql partitioning implementation.
version: 1.0.0
...
metadata:
  hermes:
    tags: [database, postgresql, partitioning, scale]
---

# Database Postgresql Partitioning Implementation

"Use when applying postgresql partitioning implementation."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  partitioning,  scale workflows or issues
- Building, fixing, or optimizing database postgresql partitioning implementation
...
`database, postgresql, partitioning, scale`
