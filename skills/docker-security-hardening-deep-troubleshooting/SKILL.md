---
name: docker-security-hardening-deep-troubleshooting
description: "Use when applying docker hardening troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Docker Security Hardening Deep Troubleshooting

"Use when applying docker hardening troubleshooting."

## Trigger

Activate this skill when the user mentions:
- devops,  docker workflows or issues
- Building, fixing, or optimizing docker security hardening deep troubleshooting
