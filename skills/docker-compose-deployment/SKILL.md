...
description: Use when deploying with Compose.
version: 1.0.0
...
"Use when deploying with Compose."

## Trigger

Activate this skill when the user mentions:
- devops,  docker,  docker-compose workflows or issues
- Building, fixing, or optimizing docker compose deployment
