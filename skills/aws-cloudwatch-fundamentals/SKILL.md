---
name: aws-cloudwatch-fundamentals
description: Use when applying aws cloudwatch fundamentals.
version: 1.0.0
...
"Use when applying aws cloudwatch fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  cloudwatch,  monitoring,  logs workflows or issues
- Building, fixing, or optimizing aws cloudwatch fundamentals
