---
name: aws-redshift-implementation
description: "Use when applying aws redshift implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws redshift implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  redshift,  data-warehouse,  analytics workflows or issues
- Building, fixing, or optimizing aws redshift implementation
