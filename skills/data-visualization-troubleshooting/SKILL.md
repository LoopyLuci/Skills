---
name: data-visualization-troubleshooting
description: "Use when applying data visualization troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [data, viz, data-visualization-design]
    related_skills: [general]
---

# Data Visualization Troubleshooting

"Use when applying data visualization troubleshooting."

## Trigger

Activate this skill when the user mentions:
- data,  viz,  data-visualization-design workflows or issues
- Building, fixing, or optimizing data visualization troubleshooting
...
`data, viz, data-visualization-design`
