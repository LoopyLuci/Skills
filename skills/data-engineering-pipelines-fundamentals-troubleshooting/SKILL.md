---
name: data-engineering-pipelines-fundamentals-troubleshooting
description: Use when applying data engineering fundamentals troubles.
version: 1.0.0
...
metadata:
  hermes:
    tags: [data, data-eng-fundamentals]
---

# Data Engineering Pipelines Fundamentals Troubleshooting

"Use when applying data engineering fundamentals troubles."

## Trigger

Activate this skill when the user mentions:
- data,  data-eng-fundamentals workflows or issues
- Building, fixing, or optimizing data engineering pipelines fundamentals troubleshooting
