...
description: Use when for blockchain security best practices.
version: 1.0.0
...
metadata:
  hermes:
    tags: [security, blockchain, crypto-audit]
---

# Blockchain Security Best Practices

"Use when for blockchain security best practices."

## Trigger

Activate this skill when the user mentions:
- security,  blockchain,  crypto-audit workflows or issues
- Building, fixing, or optimizing blockchain security best practices
...
`security, blockchain, crypto-audit`
