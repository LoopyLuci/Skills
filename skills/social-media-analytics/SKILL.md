...
"Use when analyzing social media performance data."

## Trigger

Activate this skill when the user mentions:
- social-media,  analytics,  metrics,  reporting,  kpi workflows or issues
- Building, fixing, or optimizing social media analytics
...
`social-media, analytics, metrics, reporting, kpi`
