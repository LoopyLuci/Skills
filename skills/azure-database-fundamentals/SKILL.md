---
name: azure-database-fundamentals
description: "Use when applying azure database fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure database fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  sql-database,  cosmos-db workflows or issues
- Building, fixing, or optimizing azure database fundamentals
