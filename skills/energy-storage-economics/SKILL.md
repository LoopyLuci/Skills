...
"Use when analyzing energy storage. Battery, ROI, economics."

## Trigger

Activate this skill when the user mentions:
- climatetech,  energy-storage,  battery,  roi,  economics,  lcoe workflows or issues
- Building, fixing, or optimizing energy storage economics
...
`climatetech, energy-storage, battery, roi, economics, lcoe`
