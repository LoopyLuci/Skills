...
"Use when detecting and mitigating bias in AI systems."

## Trigger

Activate this skill when the user mentions:
- fairness,  bias,  ethical-ai,  auditing,  responsible-ai workflows or issues
- Building, fixing, or optimizing ai fairness mitigation
- Questions about fairness best practices
...
`fairness, bias, ethical-ai, auditing, responsible-ai`
