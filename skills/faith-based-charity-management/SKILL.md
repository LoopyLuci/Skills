...
# Faith Based Charity Management

"Use when managing faith-based charities."

## Trigger

Activate this skill when the user mentions:
- religious,  charity,  nonprofit,  social-services workflows or issues
- Building, fixing, or optimizing faith based charity management
...
`religious, charity, nonprofit, social-services`
