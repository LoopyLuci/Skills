...
description: "Use when applying data protection implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying data protection implementation."

## Trigger

Activate this skill when the user mentions:
- security,  data-protection,  encryption workflows or issues
- Building, fixing, or optimizing data protection implementation
