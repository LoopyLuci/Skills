---
name: data-viz-implementation-deep-fundamentals
description: "Use when applying data viz implementation fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Data Viz Implementation Deep Fundamentals

"Use when applying data viz implementation fundamentals."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing data viz implementation deep fundamentals
