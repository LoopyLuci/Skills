---
name: event-planning-audit
description: Use when for event planning audit.
version: 1.0.0
...
"Use when for event planning audit."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing event planning audit
