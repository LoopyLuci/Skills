---
name: email-retention-troubleshooting
description: Use when applying email retention troubleshooting.
version: 1.0.0
...
# Email Retention Troubleshooting

"Use when applying email retention troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  retention workflows or issues
- Building, fixing, or optimizing email retention troubleshooting
