...
"Use when modeling building energy performance."

## Trigger

Activate this skill when the user mentions:
- construction,  energy-modeling,  simulation,  efficiency workflows or issues
- Building, fixing, or optimizing building energy modeling
...
`construction, energy-modeling, simulation, efficiency`
