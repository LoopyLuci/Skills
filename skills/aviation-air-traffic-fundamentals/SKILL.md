---
name: aviation-air-traffic-fundamentals
description: Use when applying air traffic control fundamentals.
version: 1.0.0
...
# Aviation Air Traffic Fundamentals

"Use when applying air traffic control fundamentals."

## Trigger

Activate this skill when the user mentions:
- aviation,  atc,  air-traffic-control workflows or issues
- Building, fixing, or optimizing aviation air traffic fundamentals
