---
name: content-marketing-audit-troubleshooting
description: Use when applying content marketing audit troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [marketing, content-marketing-audit]
---

# Content Marketing Audit Troubleshooting

"Use when applying content marketing audit troubleshooting."

## Trigger

Activate this skill when the user mentions:
- marketing,  content-marketing-audit workflows or issues
- Building, fixing, or optimizing content marketing audit troubleshooting
...
`marketing, content-marketing-audit`
