---
name: email-marketing-onboarding-fundamentals
description: "Use when applying email onboarding fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Onboarding Fundamentals

"Use when applying email onboarding fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome workflows or issues
- Building, fixing, or optimizing email marketing onboarding fundamentals
