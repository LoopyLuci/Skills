...
"Use when designing container networking."

## Trigger

Activate this skill when the user mentions:
- devops,  containers,  container-networking-patterns workflows or issues
- Building, fixing, or optimizing container networking
...
`devops, containers, container-networking-patterns`
