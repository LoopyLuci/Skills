---
name: data-viz-implementation-deep-troubleshooting
description: "Use when applying data viz implementation troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    ...
    related_skills: ['data-viz-implementation']
---

# Data Viz Implementation Deep Troubleshooting

"Use when applying data viz implementation troubleshooting."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing data viz implementation deep troubleshooting
