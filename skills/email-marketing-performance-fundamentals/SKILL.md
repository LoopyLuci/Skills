---
name: email-marketing-performance-fundamentals
description: Use when applying email performance fundamentals.
version: 1.0.0
...
# Email Marketing Performance Fundamentals

"Use when applying email performance fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  performance workflows or issues
- Building, fixing, or optimizing email marketing performance fundamentals
