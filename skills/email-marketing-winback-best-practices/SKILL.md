---
name: email-marketing-winback-best-practices
description: "Use when applying email win-back best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Winback Best Practices

"Use when applying email win-back best practices."

## Trigger

Activate this skill when the user mentions:
- email,  retention,  win-back workflows or issues
- Building, fixing, or optimizing email marketing winback best practices
