...
description: "Use when securing AWS IAM."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cloud, aws, aws-iam-security]
    related_skills: [general]
---

# Aws Iam Security

"Use when securing AWS IAM."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-iam-security workflows or issues
- Building, fixing, or optimizing aws iam security
