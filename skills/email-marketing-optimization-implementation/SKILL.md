---
name: email-marketing-optimization-implementation
description: Use when applying email optimization implementation.
version: 1.0.0
...
# Email Marketing Optimization Implementation

"Use when applying email optimization implementation."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  ab-testing workflows or issues
- Building, fixing, or optimizing email marketing optimization implementation
