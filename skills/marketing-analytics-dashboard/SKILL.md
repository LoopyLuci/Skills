...
"Use when building marketing dashboards. KPIs, funnels."

## Trigger

Activate this skill when the user mentions:
- marketing,  analytics,  dashboard,  kpi,  metrics,  reporting workflows or issues
- Building, fixing, or optimizing marketing analytics dashboard
...
`marketing, analytics, dashboard, kpi, metrics, reporting`
