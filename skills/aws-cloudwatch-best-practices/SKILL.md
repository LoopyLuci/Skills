...
description: "Use when applying aws cloudwatch best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws cloudwatch best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  cloudwatch,  monitoring,  logs workflows or issues
- Building, fixing, or optimizing aws cloudwatch best practices
