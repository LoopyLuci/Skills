...
"Use when managing data catalogs."

## Trigger

Activate this skill when the user mentions:
- data-science,  data-catalog,  metadata,  discovery workflows or issues
- Building, fixing, or optimizing data catalog management
...
`data-science, data-catalog, metadata, discovery`
