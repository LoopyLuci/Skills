---
name: email-marketing-migration-fundamentals
description: Use when applying email migration fundamentals.
version: 1.0.0
...
# Email Marketing Migration Fundamentals

"Use when applying email migration fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  migration,  platform workflows or issues
- Building, fixing, or optimizing email marketing migration fundamentals
