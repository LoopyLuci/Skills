...
"Use when exporting models to ONNX format."

## Trigger

Activate this skill when the user mentions:
- "onnx",  "export",  "inference",  "optimization",  "opset" workflows or issues
- Building, fixing, or optimizing onnx model export
- Questions about "onnx" best practices
...
`"onnx", "export", "inference", "optimization", "opset"`
