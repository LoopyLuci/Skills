...
"Use when for database schema design best practices."

## Trigger

Activate this skill when the user mentions:
- database,  schema-design,  modeling workflows or issues
- Building, fixing, or optimizing database design best practices
