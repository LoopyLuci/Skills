...
"Use when segmenting images."

## Trigger

Activate this skill when the user mentions:
- computer-vision,  segmentation,  unet workflows or issues
- Building, fixing, or optimizing computer vision segmentation
- Questions about computer-vision best practices
...
`computer-vision, segmentation, unet`
