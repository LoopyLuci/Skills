...
"Use when managing cold chain logistics. Temperature control."

## Trigger

Activate this skill when the user mentions:
- cold-chain,  logistics,  temperature-control,  food-safety,  pharma workflows or issues
- Building, fixing, or optimizing cold chain logistics
- Questions about cold-chain best practices
...
`cold-chain, logistics, temperature-control, food-safety, pharma`
