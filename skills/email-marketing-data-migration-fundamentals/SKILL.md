---
name: email-marketing-data-migration-fundamentals
description: "Use when applying email data migration fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Data Migration Fundamentals

"Use when applying email data migration fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  data,  migration workflows or issues
- Building, fixing, or optimizing email marketing data migration fundamentals
