---
name: endpoint-security-best-practices
description: Use when for endpoint security best practices.
version: 1.0.0
...
"Use when for endpoint security best practices."

## Trigger

Activate this skill when the user mentions:
- security,  endpoint,  edr,  antivirus workflows or issues
- Building, fixing, or optimizing endpoint security best practices
