...
"Use when manufacturing cosmetics under GMP."

## Trigger

Activate this skill when the user mentions:
- fashion,  cosmetics,  gmp,  manufacturing workflows or issues
- Building, fixing, or optimizing cosmetic manufacturing gmp
...
`fashion, cosmetics, gmp, manufacturing`
