---
name: database-postgresql-troubleshooting
description: "Use when applying postgresql troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Postgresql Troubleshooting

"Use when applying postgresql troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  postgres,  sql workflows or issues
- Building, fixing, or optimizing database postgresql troubleshooting
...
`database, postgresql, postgres, sql`
