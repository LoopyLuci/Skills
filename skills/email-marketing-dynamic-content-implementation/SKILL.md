---
name: email-marketing-dynamic-content-implementation
description: "Use when applying dynamic email content implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Dynamic Content Implementation

"Use when applying dynamic email content implementation."

## Trigger

Activate this skill when the user mentions:
- email,  personalization,  dynamic-content workflows or issues
- Building, fixing, or optimizing email marketing dynamic content implementation
