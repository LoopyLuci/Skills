---
name: cd-pipeline-setup-best-practices
description: Use when applying cd pipeline setup best practices.
version: 1.0.0
...
# Cd Pipeline Setup Best Practices

"Use when applying cd pipeline setup best practices."

## Trigger

Activate this skill when the user mentions:
- devops,  ci-cd,  pipeline,  cd-pipeline-setup workflows or issues
- Building, fixing, or optimizing cd pipeline setup best practices
...
`devops, ci-cd, pipeline, cd-pipeline-setup`
