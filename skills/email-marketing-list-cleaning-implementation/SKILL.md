---
name: email-marketing-list-cleaning-implementation
description: "Use when applying email list cleaning implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing List Cleaning Implementation

"Use when applying email list cleaning implementation."

## Trigger

Activate this skill when the user mentions:
- email,  hygiene,  list-cleaning workflows or issues
- Building, fixing, or optimizing email marketing list cleaning implementation
