---
name: blockchain-smart-contracts-deep-fundamentals
description: "Use when applying smart contract dev fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Blockchain Smart Contracts Deep Fundamentals

"Use when applying smart contract dev fundamentals."

## Trigger

Activate this skill when the user mentions:
- blockchain,  contracts workflows or issues
- Building, fixing, or optimizing blockchain smart contracts deep fundamentals
