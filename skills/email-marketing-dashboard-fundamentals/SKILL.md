---
name: email-marketing-dashboard-fundamentals
description: "Use when applying email dashboard fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Dashboard Fundamentals

"Use when applying email dashboard fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  dashboard,  analytics workflows or issues
- Building, fixing, or optimizing email marketing dashboard fundamentals
