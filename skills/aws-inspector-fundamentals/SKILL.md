---
name: aws-inspector-fundamentals
description: Use when applying aws inspector fundamentals.
version: 1.0.0
...
# Aws Inspector Fundamentals

"Use when applying aws inspector fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  inspector,  security,  vulnerability workflows or issues
- Building, fixing, or optimizing aws inspector fundamentals
