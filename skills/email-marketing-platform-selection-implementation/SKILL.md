---
name: email-marketing-platform-selection-implementation
description: "Use when applying email platform selection implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Platform Selection Implementation

"Use when applying email platform selection implementation."

## Trigger

Activate this skill when the user mentions:
- email,  platform,  selection workflows or issues
- Building, fixing, or optimizing email marketing platform selection implementation
