...
description: "Use when for database backups implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database backups implementation."

## Trigger

Activate this skill when the user mentions:
- database,  backup,  recovery,  postgresql,  mysql workflows or issues
- Building, fixing, or optimizing database backup implementation
