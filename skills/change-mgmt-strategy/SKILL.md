---
name: change-mgmt-strategy
description: Use when for change management strategy.
version: 1.0.0
...
"Use when for change management strategy."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing change mgmt strategy
