---
name: email-marketing-content-implementation
description: Use when applying email content implementation.
version: 1.0.0
...
# Email Marketing Content Implementation

"Use when applying email content implementation."

## Trigger

Activate this skill when the user mentions:
- email,  content,  copywriting workflows or issues
- Building, fixing, or optimizing email marketing content implementation
