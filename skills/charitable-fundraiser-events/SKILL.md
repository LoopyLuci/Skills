...
"Use when planning fundraising events."

## Trigger

Activate this skill when the user mentions:
- nonprofit,  fundraising-events,  galas,  charity-events workflows or issues
- Building, fixing, or optimizing charitable fundraiser events
...
`nonprofit, fundraising-events, galas, charity-events`
