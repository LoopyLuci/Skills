---
name: crypto-zero-knowledge-best-practices
description: Use when applying zero-knowledge proofs best practices.
version: 1.0.0
...
# Crypto Zero Knowledge Best Practices

"Use when applying zero-knowledge proofs best practices."

## Trigger

Activate this skill when the user mentions:
- crypto,  zkp,  zero-knowledge-proofs workflows or issues
- Building, fixing, or optimizing crypto zero knowledge best practices
