...
"Use when implementing GraphQL subs."

## Trigger

Activate this skill when the user mentions:
- "graphql",  "subscriptions",  "websocket",  "realtime" workflows or issues
- Building, fixing, or optimizing graphql subscriptions realtime
...
`"graphql", "subscriptions", "websocket", "realtime"`
