---
name: cybersecurity-risk-fundamentals
description: Use when for cybersecurity risk fundamentals.
version: 1.0.0
...
"Use when for cybersecurity risk fundamentals."

## Trigger

Activate this skill when the user mentions:
- security,  risk,  cyber-risk,  assessment workflows or issues
- Building, fixing, or optimizing cybersecurity risk fundamentals
