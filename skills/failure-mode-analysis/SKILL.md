...
"Use when performing FMEA analysis."

## Trigger

Activate this skill when the user mentions:
- manufacturing,  fmea,  reliability,  risk-assessment workflows or issues
- Building, fixing, or optimizing failure mode analysis
...
`manufacturing, fmea, reliability, risk-assessment`
