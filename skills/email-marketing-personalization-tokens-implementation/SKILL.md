---
name: email-marketing-personalization-tokens-implementation
description: Use when applying email personalization implementation.
version: 1.0.0
...
# Email Marketing Personalization Tokens Implementation

"Use when applying email personalization implementation."

## Trigger

Activate this skill when the user mentions:
- email,  personalization,  dynamic-content workflows or issues
- Building, fixing, or optimizing email marketing personalization tokens implementation
