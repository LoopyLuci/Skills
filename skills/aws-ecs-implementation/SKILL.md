---
name: aws-ecs-implementation
description: Use when applying aws ecs implementation.
version: 1.0.0
...
"Use when applying aws ecs implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  ecs,  containers,  ecs-service workflows or issues
- Building, fixing, or optimizing aws ecs implementation
