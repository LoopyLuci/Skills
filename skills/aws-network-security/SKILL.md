...
"Use when securing AWS networks."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  network-security-best-practices workflows or issues
- Building, fixing, or optimizing aws network security
...
`cloud, aws, network-security-best-practices`
