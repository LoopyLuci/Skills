...
Training plans, gait analysis, pace strategy, and race preparation

## Trigger

Activate this skill when the user mentions:
- "running",  "coaching" workflows or issues
- Building, fixing, or optimizing running coaching training
- Questions about "running" best practices
