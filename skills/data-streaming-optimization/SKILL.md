...
"Use when optimizing data streaming systems."

## Trigger

Activate this skill when the user mentions:
- data-streaming,  kafka,  events,  real-time workflows or issues
- Building, fixing, or optimizing data streaming optimization
...
`data-streaming, kafka, events, real-time`
