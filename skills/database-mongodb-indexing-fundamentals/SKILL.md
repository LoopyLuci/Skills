---
name: database-mongodb-indexing-fundamentals
description: "Use when applying mongodb indexing fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mongodb Indexing Fundamentals

"Use when applying mongodb indexing fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  indexing,  performance workflows or issues
- Building, fixing, or optimizing database mongodb indexing fundamentals
