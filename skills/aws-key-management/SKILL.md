...
description: "Use when managing AWS keys."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cloud, aws, key-management-best-practices]
    related_skills: [general]
---

# Aws Key Management

"Use when managing AWS keys."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  key-management-best-practices workflows or issues
- Building, fixing, or optimizing aws key management
...
`cloud, aws, key-management-best-practices`
