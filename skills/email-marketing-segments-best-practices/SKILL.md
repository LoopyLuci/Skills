---
name: email-marketing-segments-best-practices
description: "Use when applying email segments best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Segments Best Practices

"Use when applying email segments best practices."

## Trigger

Activate this skill when the user mentions:
- email,  segmentation,  targeting workflows or issues
- Building, fixing, or optimizing email marketing segments best practices
