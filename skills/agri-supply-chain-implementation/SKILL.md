---
name: agri-supply-chain-implementation
description: Use when applying agri supply chain implementation.
version: 1.0.0
...
# Agri Supply Chain Implementation

"Use when applying agri supply chain implementation."

## Trigger

Activate this skill when the user mentions:
- agri,  supply,  agricultural-tech-supply-chain workflows or issues
- Building, fixing, or optimizing agri supply chain implementation
