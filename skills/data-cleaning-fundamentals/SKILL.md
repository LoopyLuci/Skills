---
name: data-cleaning-fundamentals
description: Use when applying data cleaning fundamentals.
version: 1.0.0
...
"Use when applying data cleaning fundamentals."

## Trigger

Activate this skill when the user mentions:
- data,  cleaning,  data-cleaning-techniques workflows or issues
- Building, fixing, or optimizing data cleaning fundamentals
