---
name: datadog-monitoring-setup-deep-best-practices
description: "Use when applying datadog monitoring setup best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Datadog Monitoring Setup Deep Best Practices

"Use when applying datadog monitoring setup best practices."

## Trigger

Activate this skill when the user mentions:
- sys,  monitoring workflows or issues
- Building, fixing, or optimizing datadog monitoring setup deep best practices
