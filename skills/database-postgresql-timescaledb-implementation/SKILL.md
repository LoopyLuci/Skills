---
name: database-postgresql-timescaledb-implementation
description: "Use when applying postgresql timescaledb implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying postgresql timescaledb implementation."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  timescaledb,  time-series workflows or issues
- Building, fixing, or optimizing database postgresql timescaledb implementation
