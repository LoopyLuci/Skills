...
"Use when implementing adversarial attacks and ML defenses."

## Trigger

Activate this skill when the user mentions:
- adversarial,  robustness,  attacks,  defenses,  security workflows or issues
- Building, fixing, or optimizing adversarial ml robustness
- Questions about adversarial best practices
...
`adversarial, robustness, attacks, defenses, security`
