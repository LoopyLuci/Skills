---
name: email-marketing-subject-lines-fundamentals
description: "Use when applying email subject lines fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Subject Lines Fundamentals

"Use when applying email subject lines fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  copywriting,  subject-lines workflows or issues
- Building, fixing, or optimizing email marketing subject lines fundamentals
