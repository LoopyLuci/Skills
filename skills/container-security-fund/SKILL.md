...
"Use when learning container security."

## Trigger

Activate this skill when the user mentions:
- devops,  containers,  container-security-fundamentals workflows or issues
- Building, fixing, or optimizing container security fund
...
`devops, containers, container-security-fundamentals`
