---
name: crypto-tokenomics-implementation
description: "Use when applying token economics design implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Crypto Tokenomics Implementation

"Use when applying token economics design implementation."

## Trigger

Activate this skill when the user mentions:
- crypto,  tokenomics,  tokenomics-design workflows or issues
- Building, fixing, or optimizing crypto tokenomics implementation
