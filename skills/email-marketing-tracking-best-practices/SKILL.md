---
name: email-marketing-tracking-best-practices
description: Use when applying email tracking best practices.
version: 1.0.0
...
# Email Marketing Tracking Best Practices

"Use when applying email tracking best practices."

## Trigger

Activate this skill when the user mentions:
- email,  tracking,  analytics workflows or issues
- Building, fixing, or optimizing email marketing tracking best practices
