...
"Use when automating AWS compliance."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  compliance-automation workflows or issues
- Building, fixing, or optimizing aws compliance automation
...
`cloud, aws, compliance-automation`
