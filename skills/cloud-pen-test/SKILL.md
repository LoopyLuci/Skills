...
"Use when testing cloud security."

## Trigger

Activate this skill when the user mentions:
- security,  pentest,  cloud-penetration workflows or issues
- Building, fixing, or optimizing cloud pen test
...
`security, pentest, cloud-penetration`
