...
"Use when building financial models and budgets."

## Trigger

Activate this skill when the user mentions:
- financial-modeling,  budgeting,  forecasting,  P&L,  cash-flow,  scenario-planning workflows or issues
- Building, fixing, or optimizing financial modeling budgeting
- Questions about financial-modeling best practices
...
`financial-modeling, budgeting, forecasting, P&L, cash-flow, scenario-planning`
