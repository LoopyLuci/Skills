...
GeoPandas, spatial joins, projections, geometry operations, and mapping

## Trigger

Activate this skill when the user mentions:
- "geopandas",  "python" workflows or issues
- Building, fixing, or optimizing geospatial data geopandas
- Questions about "geopandas" best practices
