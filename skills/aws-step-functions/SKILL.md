...
description: "Use when orchestrating with AWS."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cloud, aws, aws-step-functions]
    related_skills: [general]
---

# Aws Step Functions

"Use when orchestrating with AWS."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-step-functions workflows or issues
- Building, fixing, or optimizing aws step functions
