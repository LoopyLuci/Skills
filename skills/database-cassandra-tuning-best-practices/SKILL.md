---
name: database-cassandra-tuning-best-practices
description: Use when applying cassandra tuning best practices.
version: 1.0.0
...
# Database Cassandra Tuning Best Practices

"Use when applying cassandra tuning best practices."

## Trigger

Activate this skill when the user mentions:
- database,  cassandra,  tuning,  performance workflows or issues
- Building, fixing, or optimizing database cassandra tuning best practices
