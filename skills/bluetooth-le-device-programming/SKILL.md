...
"Use when programming BLE devices."

## Trigger

Activate this skill when the user mentions:
- consumer-tech,  bluetooth-le,  ble,  embedded-systems workflows or issues
- Building, fixing, or optimizing bluetooth le device programming
...
`consumer-tech, bluetooth-le, ble, embedded-systems`
