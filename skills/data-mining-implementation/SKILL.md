---
name: data-mining-implementation
description: Use when applying data mining implementation.
version: 1.0.0
...
"Use when applying data mining implementation."

## Trigger

Activate this skill when the user mentions:
- data,  mining,  data-mining workflows or issues
- Building, fixing, or optimizing data mining implementation
