---
name: aws-eks-troubleshooting
description: Use when applying aws eks troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [aws, eks, kubernetes, managed-k8s]
---

# Aws Eks Troubleshooting

"Use when applying aws eks troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  eks,  kubernetes,  managed-k8s workflows or issues
- Building, fixing, or optimizing aws eks troubleshooting
...
`aws, eks, kubernetes, managed-k8s`
