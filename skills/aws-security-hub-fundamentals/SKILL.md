---
name: aws-security-hub-fundamentals
description: Use when applying aws security hub fundamentals.
version: 1.0.0
...
"Use when applying aws security hub fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  security-hub,  security-center workflows or issues
- Building, fixing, or optimizing aws security hub fundamentals
