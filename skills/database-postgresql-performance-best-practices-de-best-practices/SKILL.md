---
name: database-postgresql-performance-best-practices-de-best-practices
description: "Use when applying postgresql performance best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Postgresql Performance Best Practices De Best Practices

"Use when applying postgresql performance best practices."

## Trigger

Activate this skill when the user mentions:
- data,  postgres workflows or issues
- Building, fixing, or optimizing database postgresql performance best practices de best practices
