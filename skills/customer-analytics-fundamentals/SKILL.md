---
name: customer-analytics-fundamentals
description: Use when applying customer analytics fundamentals.
version: 1.0.0
...
"Use when applying customer analytics fundamentals."

## Trigger

Activate this skill when the user mentions:
- business,  customer,  analytics,  digital-marketing-analytics workflows or issues
- Building, fixing, or optimizing customer analytics fundamentals
