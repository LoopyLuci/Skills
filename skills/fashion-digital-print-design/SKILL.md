...
"Use when designing digital fashion prints."

## Trigger

Activate this skill when the user mentions:
- fashion,  digital-print,  pattern-design workflows or issues
- Building, fixing, or optimizing fashion digital print design
...
`fashion, digital-print, pattern-design`
