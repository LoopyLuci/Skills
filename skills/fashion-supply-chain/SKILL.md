...
"Use when managing fashion supply chains."

## Trigger

Activate this skill when the user mentions:
- fashion,  supply-chain,  sourcing,  manufacturing workflows or issues
- Building, fixing, or optimizing fashion supply chain
...
`fashion, supply-chain, sourcing, manufacturing`
