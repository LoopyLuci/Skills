...
"Use when building deep packet inspection engine patterns."

## Trigger

Activate this skill when the user mentions:
- dpi,  packet-inspection,  network,  protocol-analysis,  security workflows or issues
- Building, fixing, or optimizing deep packet inspection engine
- Questions about dpi best practices
...
`dpi, packet-inspection, network, protocol-analysis, security`
