---
name: docker-logging
description: "Use when logging Docker."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [devops, docker, logging-best-practices]
    related_skills: [general]
---

# Docker Logging

"Use when logging Docker."

## Trigger

Activate this skill when the user mentions:
- devops,  docker,  logging-best-practices workflows or issues
- Building, fixing, or optimizing docker logging
...
`devops, docker, logging-best-practices`
