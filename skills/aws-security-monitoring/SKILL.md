...
description: Use when monitoring AWS security.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, security-monitoring-best-practices]
---

# Aws Security Monitoring

"Use when monitoring AWS security."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  security-monitoring-best-practices workflows or issues
- Building, fixing, or optimizing aws security monitoring
...
`cloud, aws, security-monitoring-best-practices`
