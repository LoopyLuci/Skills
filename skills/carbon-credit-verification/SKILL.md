...
"Use when verifying carbon credits. Standards, MRV."

## Trigger

Activate this skill when the user mentions:
- climatetech,  carbon-credits,  verification,  mrv workflows or issues
- Building, fixing, or optimizing carbon credit verification
...
`climatetech, carbon-credits, verification, mrv`
