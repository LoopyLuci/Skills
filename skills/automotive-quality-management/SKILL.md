...
description: "Use when managing automotive quality."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [automotive, quality, iso-9001, iatf-16949]
    related_skills: [quality-control-systems]
---

## Overview
Automotive Quality Management implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Automotive Quality Management implementation and optimization"
- "Best practices for Automotive Quality Management workflows"
- "Automotive Quality Management compliance and standards"
- "Automotive Quality Management troubleshooting and problem-solving"
- "Automotive Quality Management ROI and performance measurement"
