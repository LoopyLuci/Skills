...
description: Use when for customer support optimization.
version: 1.0.0
...
"Use when for customer support optimization."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing customer support optimization
