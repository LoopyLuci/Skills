---
name: agri-tech-yield-modeling-fundamentals
...
# Agri Tech Yield Modeling Fundamentals

"Use when applying crop yield modeling fundamentals."

## Trigger

Activate this skill when the user mentions:
- agri,  data,  crop-yield-modeling workflows or issues
- Building, fixing, or optimizing agri tech yield modeling fundamentals
