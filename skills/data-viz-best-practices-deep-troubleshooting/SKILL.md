---
name: data-viz-best-practices-deep-troubleshooting
description: Use when applying data visualization best practices trou.
version: 1.0.0
...
# Data Viz Best Practices Deep Troubleshooting

"Use when applying data visualization best practices trou."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing data viz best practices deep troubleshooting
