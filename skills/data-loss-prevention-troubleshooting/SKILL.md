---
name: data-loss-prevention-troubleshooting
description: Use when for data loss prevention troubleshooting.
version: 1.0.0
...
"Use when for data loss prevention troubleshooting."

## Trigger

Activate this skill when the user mentions:
- security,  dlp,  data-protection,  monitoring workflows or issues
- Building, fixing, or optimizing data loss prevention troubleshooting
...
`security, dlp, data-protection, monitoring`
