---
name: email-marketing-campaigns-troubleshooting
description: Use when applying email marketing campaigns troubleshoot.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, marketing, email-marketing-campaigns]
---

# Email Marketing Campaigns Troubleshooting

"Use when applying email marketing campaigns troubleshoot."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-campaigns workflows or issues
- Building, fixing, or optimizing email marketing campaigns troubleshooting
