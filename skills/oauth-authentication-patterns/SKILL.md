...
"Use when implementing OAuth 2.0 and OpenID Connect auth."

## Trigger

Activate this skill when the user mentions:
- oauth,  openid-connect,  authentication,  authorization,  JWT,  SSO workflows or issues
- Building, fixing, or optimizing oauth authentication patterns
- Questions about oauth best practices
...
`oauth, openid-connect, authentication, authorization, JWT, SSO`
