...
description: "Use when for email marketing fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for email marketing fundamentals."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing email marketing fundamentals
