...
"Use when planning decarbonization. Roadmap, targets."

## Trigger

Activate this skill when the user mentions:
- climatetech,  decarbonization,  strategy,  net-zero workflows or issues
- Building, fixing, or optimizing decarbonization roadmapping
...
`climatetech, decarbonization, strategy, net-zero`
