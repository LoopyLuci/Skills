---
name: database-postgresql-partitioning-best-practices
description: Use when applying postgresql partitioning best practices.
version: 1.0.0
...
# Database Postgresql Partitioning Best Practices

"Use when applying postgresql partitioning best practices."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  partitioning,  scale workflows or issues
- Building, fixing, or optimizing database postgresql partitioning best practices
