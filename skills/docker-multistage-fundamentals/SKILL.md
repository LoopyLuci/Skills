---
name: docker-multistage-fundamentals
description: Use when applying docker multistage fundamentals.
version: 1.0.0
...
# Docker Multistage Fundamentals

"Use when applying docker multistage fundamentals."

## Trigger

Activate this skill when the user mentions:
- docker,  multistage,  buildx workflows or issues
- Building, fixing, or optimizing docker multistage fundamentals
