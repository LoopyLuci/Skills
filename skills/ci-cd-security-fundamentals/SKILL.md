---
name: ci-cd-security-fundamentals
description: "Use when applying ci/cd security fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying ci/cd security fundamentals."

## Trigger

Activate this skill when the user mentions:
- devops,  security,  ci-cd-security,  pipeline workflows or issues
- Building, fixing, or optimizing ci cd security fundamentals
