---
name: embedding-models-patterns-deep-best-practices
description: Use when applying embedding models best practices.
version: 1.0.0
...
# Embedding Models Patterns Deep Best Practices

"Use when applying embedding models best practices."

## Trigger

Activate this skill when the user mentions:
- ml,  embeddings workflows or issues
- Building, fixing, or optimizing embedding models patterns deep best practices
