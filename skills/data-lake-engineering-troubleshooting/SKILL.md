---
name: data-lake-engineering-troubleshooting
description: Use when for data lake engineering troubleshooting.
version: 1.0.0
...
# Data Lake Engineering Troubleshooting

"Use when for data lake engineering troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  data-lake,  storage workflows or issues
- Building, fixing, or optimizing data lake engineering troubleshooting
