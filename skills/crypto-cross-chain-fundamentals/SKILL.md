---
name: crypto-cross-chain-fundamentals
description: "Use when applying cross-chain protocols fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Crypto Cross Chain Fundamentals

"Use when applying cross-chain protocols fundamentals."

## Trigger

Activate this skill when the user mentions:
- crypto,  cross-chain,  blockchain-development-solidity workflows or issues
- Building, fixing, or optimizing crypto cross chain fundamentals
