...
Quantum kernels, QSVM, variational circuits, and quantum neural networks

## Trigger

Activate this skill when the user mentions:
- "qml",  "hybrid" workflows or issues
- Building, fixing, or optimizing quantum machine learning
- Questions about "qml" best practices
