...
"Use when measuring email KPIs."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  kpis,  analytics workflows or issues
- Building, fixing, or optimizing email marketing kpi framework
...
`email, marketing, kpis, analytics`
