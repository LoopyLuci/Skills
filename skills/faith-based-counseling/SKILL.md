...
"Use when providing faith-based counseling."

## Trigger

Activate this skill when the user mentions:
- religious,  counseling,  pastoral-care,  therapy workflows or issues
- Building, fixing, or optimizing faith based counseling
...
`religious, counseling, pastoral-care, therapy`
