---
name: email-marketing-tools-troubleshooting
description: "Use when applying email marketing tools troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Tools Troubleshooting

"Use when applying email marketing tools troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  tools,  marketing workflows or issues
- Building, fixing, or optimizing email marketing tools troubleshooting
