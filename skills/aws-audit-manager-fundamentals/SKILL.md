---
name: aws-audit-manager-fundamentals
description: "Use when applying aws audit manager fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Audit Manager Fundamentals

"Use when applying aws audit manager fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  audit-manager,  compliance,  audit workflows or issues
- Building, fixing, or optimizing aws audit manager fundamentals
