---
name: ema-regulatory-affairs-fundamentals
description: Use when applying ema regulatory fundamentals.
version: 1.0.0
...
# Ema Regulatory Affairs Fundamentals

"Use when applying ema regulatory fundamentals."

## Trigger

Activate this skill when the user mentions:
- biotech,  pharma,  ema workflows or issues
- Building, fixing, or optimizing ema regulatory affairs fundamentals
