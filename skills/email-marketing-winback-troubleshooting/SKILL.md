---
name: email-marketing-winback-troubleshooting
description: "Use when applying email win-back troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Winback Troubleshooting

"Use when applying email win-back troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  retention,  win-back workflows or issues
- Building, fixing, or optimizing email marketing winback troubleshooting
