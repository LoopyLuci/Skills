---
name: email-marketing-deliverability-fundamentals
description: "Use when applying email deliverability fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email deliverability fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  spam workflows or issues
- Building, fixing, or optimizing email marketing deliverability fundamentals
