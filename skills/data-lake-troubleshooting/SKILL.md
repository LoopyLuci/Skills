...
"Use when troubleshooting data lake."

## Trigger

Activate this skill when the user mentions:
- database,  data-lake,  storage,  analytics workflows or issues
- Building, fixing, or optimizing data lake troubleshooting
...
`database, data-lake, storage, analytics`
