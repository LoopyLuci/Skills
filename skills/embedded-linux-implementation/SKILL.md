---
name: embedded-linux-implementation
description: Use when applying embedded linux implementation.
version: 1.0.0
...
"Use when applying embedded linux implementation."

## Trigger

Activate this skill when the user mentions:
- electronics,  embedded,  embedded-linux-development workflows or issues
- Building, fixing, or optimizing embedded linux implementation
