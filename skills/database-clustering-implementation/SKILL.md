---
name: database-clustering-implementation
description: Use when for database clustering implementation.
version: 1.0.0
...
"Use when for database clustering implementation."

## Trigger

Activate this skill when the user mentions:
- database,  clustering,  high-availability,  nosql workflows or issues
- Building, fixing, or optimizing database clustering implementation
