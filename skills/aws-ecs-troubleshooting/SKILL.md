---
name: aws-ecs-troubleshooting
description: Use when applying aws ecs troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [aws, ecs, containers, ecs-service]
---

# Aws Ecs Troubleshooting

"Use when applying aws ecs troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  ecs,  containers,  ecs-service workflows or issues
- Building, fixing, or optimizing aws ecs troubleshooting
...
`aws, ecs, containers, ecs-service`
