---
name: email-marketing-deliverability-best-practices
description: Use when applying email deliverability best practices.
version: 1.0.0
...
"Use when applying email deliverability best practices."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  spam workflows or issues
- Building, fixing, or optimizing email marketing deliverability best practices
