---
name: email-marketing-followup-fundamentals
description: Use when applying email follow-up fundamentals.
version: 1.0.0
...
# Email Marketing Followup Fundamentals

"Use when applying email follow-up fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  follow-up,  sales workflows or issues
- Building, fixing, or optimizing email marketing followup fundamentals
