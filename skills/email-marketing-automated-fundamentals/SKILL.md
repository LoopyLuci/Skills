---
name: email-marketing-automated-fundamentals
description: Use when applying automated email fundamentals.
version: 1.0.0
...
# Email Marketing Automated Fundamentals

"Use when applying automated email fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  workflows workflows or issues
- Building, fixing, or optimizing email marketing automated fundamentals
