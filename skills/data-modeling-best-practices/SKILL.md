...
description: Use when applying data modeling best practices.
version: 1.0.0
...
metadata:
  hermes:
    tags: [data, modeling, database-schema-design]
---

# Data Modeling Best Practices

"Use when applying data modeling best practices."

## Trigger

Activate this skill when the user mentions:
- data,  modeling,  database-schema-design workflows or issues
- Building, fixing, or optimizing data modeling best practices
