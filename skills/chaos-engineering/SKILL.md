...
"Use when implementing chaos engineering experiments."

## Trigger

Activate this skill when the user mentions:
- chaos-engineering,  resilience-testing,  fault-injection,  Gameday,  reliability workflows or issues
- Building, fixing, or optimizing chaos engineering
...
`chaos-engineering, resilience-testing, fault-injection, Gameday, reliability`
