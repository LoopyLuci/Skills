---
name: email-marketing-trigger-based-best-practices
description: "Use when applying trigger-based emails best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Trigger Based Best Practices

"Use when applying trigger-based emails best practices."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  triggers workflows or issues
- Building, fixing, or optimizing email marketing trigger based best practices
