...
"Use when optimizing routing between specialized AI agents."

## Trigger

Activate this skill when the user mentions:
- agents,  routing,  optimization,  orchestration,  load-balancing workflows or issues
- Building, fixing, or optimizing multi agent routing optimization
...
`agents, routing, optimization, orchestration, load-balancing`
