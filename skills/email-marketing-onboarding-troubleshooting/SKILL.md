---
name: email-marketing-onboarding-troubleshooting
description: Use when applying email onboarding troubleshooting.
version: 1.0.0
...
# Email Marketing Onboarding Troubleshooting

"Use when applying email onboarding troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome workflows or issues
- Building, fixing, or optimizing email marketing onboarding troubleshooting
