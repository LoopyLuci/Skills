---
name: email-protocol-troubleshooting
description: "Use when applying email protocol troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Protocol Troubleshooting

"Use when applying email protocol troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  smtp,  imap,  pop3 workflows or issues
- Building, fixing, or optimizing email protocol troubleshooting
