---
name: database-mongodb-aggregation-best-practices-deep-best-practices
description: "Use when applying mongodb aggregation best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mongodb Aggregation Best Practices Deep Best Practices

"Use when applying mongodb aggregation best practices."

## Trigger

Activate this skill when the user mentions:
- data,  mongodb workflows or issues
- Building, fixing, or optimizing database mongodb aggregation best practices deep best practices
