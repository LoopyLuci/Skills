---
name: biomedical-troubleshooting
description: "Use when troubleshooting biomedical issues."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [biomedical, bioengineering, medical-devices, bme]
    related_skills: [general]
---

## Overview
Apply troubleshooting biomedical issues for effective results. 

## When to Use
- "Biomedical Troubleshooting design and implementation"
- "Best practices for Biomedical Troubleshooting"
- "Biomedical Troubleshooting optimization and scaling"
- "Biomedical Troubleshooting troubleshooting and validation"
