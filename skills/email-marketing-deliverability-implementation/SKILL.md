---
name: email-marketing-deliverability-implementation
description: Use when applying email deliverability implementation.
version: 1.0.0
...
# Email Marketing Deliverability Implementation

"Use when applying email deliverability implementation."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  spam workflows or issues
- Building, fixing, or optimizing email marketing deliverability implementation
