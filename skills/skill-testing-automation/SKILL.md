...
"Use when validating skills for correctness and freshness."

## Trigger

Activate this skill when the user mentions:
- skills,  testing,  validation,  automation,  quality workflows or issues
- Building, fixing, or optimizing skill testing automation
...
`skills, testing, validation, automation, quality`
