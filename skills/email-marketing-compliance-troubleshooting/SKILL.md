---
name: email-marketing-compliance-troubleshooting
description: Use when applying email compliance troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, legal, gdpr, can-spam]
---

# Email Marketing Compliance Troubleshooting

"Use when applying email compliance troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  legal,  gdpr,  can-spam workflows or issues
- Building, fixing, or optimizing email marketing compliance troubleshooting
