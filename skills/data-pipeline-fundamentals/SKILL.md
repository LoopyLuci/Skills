...
description: Use when applying data pipeline fundamentals.
version: 1.0.0
...
"Use when applying data pipeline fundamentals."

## Trigger

Activate this skill when the user mentions:
- data,  pipelines,  data-pipeline-streaming workflows or issues
- Building, fixing, or optimizing data pipeline fundamentals
