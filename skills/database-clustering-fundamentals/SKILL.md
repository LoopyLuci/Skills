---
name: database-clustering-fundamentals
description: Use when for database clustering fundamentals.
version: 1.0.0
...
"Use when for database clustering fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  clustering,  high-availability,  nosql workflows or issues
- Building, fixing, or optimizing database clustering fundamentals
