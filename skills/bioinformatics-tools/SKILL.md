...
"Use when using bioinformatics tools."

## Trigger

Activate this skill when the user mentions:
- bioinformatics,  genomics,  alignment workflows or issues
- Building, fixing, or optimizing bioinformatics tools
...
`bioinformatics, genomics, alignment`
