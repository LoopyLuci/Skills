---
name: docker-security-implementation
description: "Use when applying docker security implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying docker security implementation."

## Trigger

Activate this skill when the user mentions:
- docker,  security,  docker-security-hardening workflows or issues
- Building, fixing, or optimizing docker security implementation
