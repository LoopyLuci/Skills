---
name: database-postgresql-timescaledb-troubleshooting
description: "Use when applying postgresql timescaledb troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Postgresql Timescaledb Troubleshooting

"Use when applying postgresql timescaledb troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  timescaledb,  time-series workflows or issues
- Building, fixing, or optimizing database postgresql timescaledb troubleshooting
