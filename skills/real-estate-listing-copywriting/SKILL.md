...
"MLS listing copy. AIDA, feature-to-benefit, A/B variants."

## Trigger

Activate this skill when the user mentions:
- real-estate,  copywriting,  mls,  listings,  marketing workflows or issues
- Building, fixing, or optimizing real estate listing copywriting
...
`real-estate, copywriting, mls, listings, marketing`
