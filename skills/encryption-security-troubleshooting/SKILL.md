---
name: encryption-security-troubleshooting
description: Use when for encryption troubleshooting.
version: 1.0.0
...
"Use when for encryption troubleshooting."

## Trigger

Activate this skill when the user mentions:
- security,  encryption,  crypto,  tls workflows or issues
- Building, fixing, or optimizing encryption security troubleshooting
...
`security, encryption, crypto, tls`
