---
name: data-viz-fundamentals-deep-implementation
description: "Use when applying data viz fundamentals implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Data Viz Fundamentals Deep Implementation

"Use when applying data viz fundamentals implementation."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing data viz fundamentals deep implementation
