---
name: email-marketing-effectiveness-best-practices
description: Use when applying email effectiveness best practices.
version: 1.0.0
...
# Email Marketing Effectiveness Best Practices

"Use when applying email effectiveness best practices."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  effectiveness workflows or issues
- Building, fixing, or optimizing email marketing effectiveness best practices
