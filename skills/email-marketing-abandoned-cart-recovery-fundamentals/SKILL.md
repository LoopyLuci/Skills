---
name: email-marketing-abandoned-cart-recovery-fundamentals
description: "Use when applying abandoned cart recovery fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Abandoned Cart Recovery Fundamentals

"Use when applying abandoned cart recovery fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  ecommerce,  cart-abandonment workflows or issues
- Building, fixing, or optimizing email marketing abandoned cart recovery fundamentals
