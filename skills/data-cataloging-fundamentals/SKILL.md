---
name: data-cataloging-fundamentals
description: Use when for data cataloging fundamentals.
version: 1.0.0
...
"Use when for data cataloging fundamentals."

## Trigger

Activate this skill when the user mentions:
- data-governance,  catalog,  metadata workflows or issues
- Building, fixing, or optimizing data cataloging fundamentals
