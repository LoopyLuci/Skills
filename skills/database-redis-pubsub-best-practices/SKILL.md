---
name: database-redis-pubsub-best-practices
description: "Use when applying redis pub/sub best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Redis Pubsub Best Practices

"Use when applying redis pub/sub best practices."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  pub-sub,  messaging workflows or issues
- Building, fixing, or optimizing database redis pubsub best practices
