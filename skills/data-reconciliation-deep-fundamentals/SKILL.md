---
name: data-reconciliation-deep-fundamentals
description: "Use when applying data reconciliation fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Data Reconciliation Deep Fundamentals

"Use when applying data reconciliation fundamentals."

## Trigger

Activate this skill when the user mentions:
- data,  dq workflows or issues
- Building, fixing, or optimizing data reconciliation deep fundamentals
