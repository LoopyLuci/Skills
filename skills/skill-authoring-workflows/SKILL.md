...
"Use when designing efficient skill authoring workflows."

## Trigger

Activate this skill when the user mentions:
- meta,  skill-authoring,  workflow,  efficiency,  templates,  batch workflows or issues
- Building, fixing, or optimizing skill authoring workflows
...
`meta, skill-authoring, workflow, efficiency, templates, batch`
