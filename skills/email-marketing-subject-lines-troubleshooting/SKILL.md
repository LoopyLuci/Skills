---
name: email-marketing-subject-lines-troubleshooting
description: Use when applying email subject lines troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, copywriting, subject-lines]
---

# Email Marketing Subject Lines Troubleshooting

"Use when applying email subject lines troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  copywriting,  subject-lines workflows or issues
- Building, fixing, or optimizing email marketing subject lines troubleshooting
