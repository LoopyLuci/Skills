...
"Use when designing and managing customer loyalty programs."

## Trigger

Activate this skill when the user mentions:
- loyalty,  rewards,  points,  VIP,  customer-retention,  referral-programs workflows or issues
- Building, fixing, or optimizing loyalty programs crm
- Questions about loyalty best practices
...
`loyalty, rewards, points, VIP, customer-retention, referral-programs`
