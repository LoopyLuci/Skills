---
name: database-mongodb-indexing-implementation
description: "Use when applying mongodb indexing implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mongodb Indexing Implementation

"Use when applying mongodb indexing implementation."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  indexing,  performance workflows or issues
- Building, fixing, or optimizing database mongodb indexing implementation
