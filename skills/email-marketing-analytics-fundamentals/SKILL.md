---
name: email-marketing-analytics-fundamentals
description: "Use when applying email analytics fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email analytics fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  data workflows or issues
- Building, fixing, or optimizing email marketing analytics fundamentals
