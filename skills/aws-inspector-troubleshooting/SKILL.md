---
name: aws-inspector-troubleshooting
description: Use when applying aws inspector troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [aws, inspector, security, vulnerability]
---

# Aws Inspector Troubleshooting

"Use when applying aws inspector troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  inspector,  security,  vulnerability workflows or issues
- Building, fixing, or optimizing aws inspector troubleshooting
...
`aws, inspector, security, vulnerability`
