...
"Use when writing optimized Dockerfiles."

## Trigger

Activate this skill when the user mentions:
- "docker",  "dockerfile",  "multi-stage",  "layers",  "caching" workflows or issues
- Building, fixing, or optimizing dockerfile best practices
...
`"docker", "dockerfile", "multi-stage", "layers", "caching"`
