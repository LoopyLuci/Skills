---
name: cloud-penetration-troubleshooting
description: Use when applying cloud penetration troubleshooting.
version: 1.0.0
...
# Cloud Penetration Troubleshooting

"Use when applying cloud penetration troubleshooting."

## Trigger

Activate this skill when the user mentions:
- security,  pentesting,  cloud workflows or issues
- Building, fixing, or optimizing cloud penetration troubleshooting
