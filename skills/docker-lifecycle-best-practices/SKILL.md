---
name: docker-lifecycle-best-practices
...
# Docker Lifecycle Best Practices

"Use when applying docker lifecycle best practices."

## Trigger

Activate this skill when the user mentions:
- docker,  lifecycle,  docker-lifecycle-management workflows or issues
- Building, fixing, or optimizing docker lifecycle best practices
