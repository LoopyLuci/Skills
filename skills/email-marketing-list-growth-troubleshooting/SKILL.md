---
name: email-marketing-list-growth-troubleshooting
description: Use when applying email list growth troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, growth, list-building-email-growth]
---

# Email Marketing List Growth Troubleshooting

"Use when applying email list growth troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  growth,  list-building-email-growth workflows or issues
- Building, fixing, or optimizing email marketing list growth troubleshooting
...
`email, growth, list-building-email-growth`
