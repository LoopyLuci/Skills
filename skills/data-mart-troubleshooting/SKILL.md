---
name: data-mart-troubleshooting
description: Use when applying data mart troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [ds, data, data-mart]
---

# Data Mart Troubleshooting

"Use when applying data mart troubleshooting."

## Trigger

Activate this skill when the user mentions:
- ds,  data,  data-mart workflows or issues
- Building, fixing, or optimizing data mart troubleshooting
