...
description: "Use when testing file upload."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [security, pentest, file-upload-test]
    related_skills: [general]
---

# File Upload Security

"Use when testing file upload."

## Trigger

Activate this skill when the user mentions:
- security,  pentest,  file-upload-test workflows or issues
- Building, fixing, or optimizing file upload security
...
`security, pentest, file-upload-test`
