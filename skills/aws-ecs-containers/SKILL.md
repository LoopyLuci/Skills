...
description: "Use when using AWS ECS."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cloud, aws, aws-ecs]
    related_skills: [general]
---

# Aws Ecs Containers

"Use when using AWS ECS."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-ecs workflows or issues
- Building, fixing, or optimizing aws ecs containers
