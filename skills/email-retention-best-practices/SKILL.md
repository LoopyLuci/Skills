---
name: email-retention-best-practices
description: Use when applying email retention best practices.
version: 1.0.0
...
"Use when applying email retention best practices."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  retention workflows or issues
- Building, fixing, or optimizing email retention best practices
