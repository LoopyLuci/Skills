---
name: encryption-security-fundamentals
description: Use when for encryption fundamentals.
version: 1.0.0
...
"Use when for encryption fundamentals."

## Trigger

Activate this skill when the user mentions:
- security,  encryption,  crypto,  tls workflows or issues
- Building, fixing, or optimizing encryption security fundamentals
