---
name: email-marketing-fundamentals-implementation
description: "Use when applying email marketing fundamentals implement."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Fundamentals Implementation

"Use when applying email marketing fundamentals implement."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-fundamentals workflows or issues
- Building, fixing, or optimizing email marketing fundamentals implementation
