...
description: "Use when learning data modeling fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when learning data modeling fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  data-modeling,  schema-design workflows or issues
- Building, fixing, or optimizing data modeling fundamentals
