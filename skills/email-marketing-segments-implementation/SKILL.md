---
name: email-marketing-segments-implementation
description: "Use when applying email segments implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Segments Implementation

"Use when applying email segments implementation."

## Trigger

Activate this skill when the user mentions:
- email,  segmentation,  targeting workflows or issues
- Building, fixing, or optimizing email marketing segments implementation
