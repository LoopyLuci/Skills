---
name: email-marketing-metrics-fundamentals
description: Use when applying email metrics fundamentals.
version: 1.0.0
...
# Email Marketing Metrics Fundamentals

"Use when applying email metrics fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  metrics workflows or issues
- Building, fixing, or optimizing email marketing metrics fundamentals
