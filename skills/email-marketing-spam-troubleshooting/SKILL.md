---
name: email-marketing-spam-troubleshooting
description: Use when applying email spam troubleshooting.
version: 1.0.0
...
# Email Marketing Spam Troubleshooting

"Use when applying email spam troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  spam,  deliverability workflows or issues
- Building, fixing, or optimizing email marketing spam troubleshooting
