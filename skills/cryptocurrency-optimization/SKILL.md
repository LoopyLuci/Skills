---
name: cryptocurrency-optimization
description: Use when for cryptocurrency optimization.
version: 1.0.0
...
"Use when for cryptocurrency optimization."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing cryptocurrency optimization
