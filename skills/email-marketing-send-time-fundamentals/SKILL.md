---
name: email-marketing-send-time-fundamentals
description: Use when applying email send time fundamentals.
version: 1.0.0
...
# Email Marketing Send Time Fundamentals

"Use when applying email send time fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  timing workflows or issues
- Building, fixing, or optimizing email marketing send time fundamentals
