---
name: ai-safety-troubleshooting
description: Use when for ai safety troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [ai, safety, ai-safety, risk]
---

# Ai Safety Troubleshooting

"Use when for ai safety troubleshooting."

## Trigger

Activate this skill when the user mentions:
- ai,  safety,  ai-safety,  risk workflows or issues
- Building, fixing, or optimizing ai safety troubleshooting
