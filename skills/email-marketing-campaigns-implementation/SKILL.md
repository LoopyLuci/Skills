---
name: email-marketing-campaigns-implementation
description: "Use when applying email marketing campaigns implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email marketing campaigns implementation."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-campaigns workflows or issues
- Building, fixing, or optimizing email marketing campaigns implementation
