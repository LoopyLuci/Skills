---
name: database-replication-fundamentals
description: Use when for database replication fundamentals.
version: 1.0.0
...
"Use when for database replication fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  replication,  high-availability,  cluster workflows or issues
- Building, fixing, or optimizing database replication fundamentals
