...
description: "Use when applying aws disaster recovery fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws disaster recovery fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  disaster-recovery,  dr,  backup workflows or issues
- Building, fixing, or optimizing aws disaster recovery fundamentals
