---
name: email-marketing-transactional-fundamentals
description: "Use when applying transactional email fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Transactional Fundamentals

"Use when applying transactional email fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  transactional,  triggered workflows or issues
- Building, fixing, or optimizing email marketing transactional fundamentals
