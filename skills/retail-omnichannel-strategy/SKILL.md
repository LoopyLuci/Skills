...
Unified commerce, BOPIS, ship-from-store, and inventory visibility

## Trigger

Activate this skill when the user mentions:
- "retail",  "omnichannel" workflows or issues
- Building, fixing, or optimizing retail omnichannel strategy
