---
name: email-automation-best-practices
description: Use when applying email automation best practices.
version: 1.0.0
...
"Use when applying email automation best practices."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-automation workflows or issues
- Building, fixing, or optimizing email automation best practices
