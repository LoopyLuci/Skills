---
name: docker-build-fundamentals
description: Use when applying docker build fundamentals.
version: 1.0.0
...
"Use when applying docker build fundamentals."

## Trigger

Activate this skill when the user mentions:
- docker,  build,  buildx,  docker-buildx-multiarch workflows or issues
- Building, fixing, or optimizing docker build fundamentals
