---
name: database-mongodb-implementation
description: "Use when applying mongodb implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying mongodb implementation."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  nosql,  document workflows or issues
- Building, fixing, or optimizing database mongodb implementation
