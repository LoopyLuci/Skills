---
name: database-redis-lua-scripts-best-practices-deep-implementation
description: "Use when applying redis lua scripts implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Redis Lua Scripts Best Practices Deep Implementation

"Use when applying redis lua scripts implementation."

## Trigger

Activate this skill when the user mentions:
- data,  redis workflows or issues
- Building, fixing, or optimizing database redis lua scripts best practices deep implementation
