...
description: "Use when architecting AWS security."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cloud, aws, application-security-architecture]
    related_skills: [general]
---

# Aws Security Architecture

"Use when architecting AWS security."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  application-security-architecture workflows or issues
- Building, fixing, or optimizing aws security architecture
...
`cloud, aws, application-security-architecture`
