...
"Use when managing user consent. GDPR, CCPA, opt-out."

## Trigger

Activate this skill when the user mentions:
- consent,  gdpr,  ccpa,  privacy,  opt-in,  opt-out,  data-processing workflows or issues
- Building, fixing, or optimizing consent management skills
- Questions about consent best practices
...
`consent, gdpr, ccpa, privacy, opt-in, opt-out, data-processing`
