---
name: fashion-production-planning
description: "Use when planning fashion production."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [fashion, production-planning, manufacturing]
    related_skills: [general]
---

## Overview
Plan fashion production including quantities and timelines.

## When to Use
- "Fashion Production Planning design and implementation"
- "Best practices for Fashion Production Planning"
- "Fashion Production Planning optimization and scaling"
- "Fashion Production Planning troubleshooting and validation"
