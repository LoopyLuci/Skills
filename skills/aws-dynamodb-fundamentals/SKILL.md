...
description: "Use when applying aws dynamodb fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws dynamodb fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  dynamodb,  nosql,  database workflows or issues
- Building, fixing, or optimizing aws dynamodb fundamentals
