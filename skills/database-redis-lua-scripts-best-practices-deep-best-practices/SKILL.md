---
name: database-redis-lua-scripts-best-practices-deep-best-practices
...
# Database Redis Lua Scripts Best Practices Deep Best Practices

"Use when applying redis lua scripts best practices."

## Trigger

Activate this skill when the user mentions:
- data,  redis workflows or issues
- Building, fixing, or optimizing database redis lua scripts best practices deep best practices
