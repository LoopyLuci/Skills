---
name: email-marketing-bounce-best-practices
description: Use when applying email bounce best practices.
version: 1.0.0
...
# Email Marketing Bounce Best Practices

"Use when applying email bounce best practices."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  bounce,  delivery workflows or issues
- Building, fixing, or optimizing email marketing bounce best practices
