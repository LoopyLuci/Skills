...
"Use when designing electric motors for EVs."

## Trigger

Activate this skill when the user mentions:
- automotive,  electric-motors,  ev-design,  engineering workflows or issues
- Building, fixing, or optimizing electric motor design ev
...
`automotive, electric-motors, ev-design, engineering`
