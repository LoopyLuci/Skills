---
name: database-postgresql-timescaledb-fundamentals
description: Use when applying postgresql timescaledb fundamentals.
version: 1.0.0
...
# Database Postgresql Timescaledb Fundamentals

"Use when applying postgresql timescaledb fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  timescaledb,  time-series workflows or issues
- Building, fixing, or optimizing database postgresql timescaledb fundamentals
