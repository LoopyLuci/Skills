---
name: event-planning-analysis
description: Use when for event planning analysis.
version: 1.0.0
...
"Use when for event planning analysis."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing event planning analysis
