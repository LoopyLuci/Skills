---
name: content-marketing-analytics-troubleshooting
description: "Use when applying content marketing analytics troublesho."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Content Marketing Analytics Troubleshooting

"Use when applying content marketing analytics troublesho."

## Trigger

Activate this skill when the user mentions:
- marketing,  content-marketing-analysis workflows or issues
- Building, fixing, or optimizing content marketing analytics troubleshooting
...
`marketing, content-marketing-analysis`
