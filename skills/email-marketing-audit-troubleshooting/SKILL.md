---
name: email-marketing-audit-troubleshooting
description: "Use when applying email marketing audit troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Audit Troubleshooting

"Use when applying email marketing audit troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-audit workflows or issues
- Building, fixing, or optimizing email marketing audit troubleshooting
...
`email, marketing, email-marketing-audit`
