---
name: email-marketing-data-migration-implementation
description: Use when applying email data migration implementation.
version: 1.0.0
...
# Email Marketing Data Migration Implementation

"Use when applying email data migration implementation."

## Trigger

Activate this skill when the user mentions:
- email,  data,  migration workflows or issues
- Building, fixing, or optimizing email marketing data migration implementation
