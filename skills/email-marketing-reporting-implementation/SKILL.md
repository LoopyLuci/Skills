---
name: email-marketing-reporting-implementation
description: Use when applying email reporting implementation.
version: 1.0.0
...
# Email Marketing Reporting Implementation

"Use when applying email reporting implementation."

## Trigger

Activate this skill when the user mentions:
- email,  reporting,  kpis workflows or issues
- Building, fixing, or optimizing email marketing reporting implementation
