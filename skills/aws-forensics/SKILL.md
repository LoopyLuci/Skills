---
name: aws-forensics
description: Use when doing AWS forensics.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, digital-forensics-best-practices]
---

# Aws Forensics

"Use when doing AWS forensics."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  digital-forensics-best-practices workflows or issues
- Building, fixing, or optimizing aws forensics
...
`cloud, aws, digital-forensics-best-practices`
