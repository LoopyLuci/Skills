...
description: "Use when applying data warehouse implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying data warehouse implementation."

## Trigger

Activate this skill when the user mentions:
- data,  warehouse,  data-warehousing-fundamentals workflows or issues
- Building, fixing, or optimizing data warehouse implementation
