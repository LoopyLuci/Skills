...
"Use when securing consumer IoT devices."

## Trigger

Activate this skill when the user mentions:
- consumer-tech,  iot-security,  privacy,  authentication workflows or issues
- Building, fixing, or optimizing consumer iot security
...
`consumer-tech, iot-security, privacy, authentication`
