---
name: aws-dynamodb-implementation
description: Use when applying aws dynamodb implementation.
version: 1.0.0
...
"Use when applying aws dynamodb implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  dynamodb,  nosql,  database workflows or issues
- Building, fixing, or optimizing aws dynamodb implementation
