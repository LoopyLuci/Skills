---
name: database-redis-implementation
description: Use when applying redis implementation.
version: 1.0.0
...
"Use when applying redis implementation."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  caching,  in-memory workflows or issues
- Building, fixing, or optimizing database redis implementation
