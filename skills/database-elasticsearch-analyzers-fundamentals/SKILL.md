---
name: database-elasticsearch-analyzers-fundamentals
description: "Use when applying elasticsearch analyzers fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Elasticsearch Analyzers Fundamentals

"Use when applying elasticsearch analyzers fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  elasticsearch,  analyzers,  text-analysis workflows or issues
- Building, fixing, or optimizing database elasticsearch analyzers fundamentals
