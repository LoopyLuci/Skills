---
name: database-mongodb-indexing-best-practices
description: "Use when applying mongodb indexing best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mongodb Indexing Best Practices

"Use when applying mongodb indexing best practices."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  indexing,  performance workflows or issues
- Building, fixing, or optimizing database mongodb indexing best practices
...
`database, mongodb, indexing, performance`
