---
name: email-marketing-survival-guide-best-practices
description: "Use when applying email survival guide best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Survival Guide Best Practices

"Use when applying email survival guide best practices."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  spam-filter workflows or issues
- Building, fixing, or optimizing email marketing survival guide best practices
