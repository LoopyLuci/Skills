---
name: email-marketing-re-engagement-fundamentals
description: Use when applying re-engagement email fundamentals.
version: 1.0.0
...
# Email Marketing Re Engagement Fundamentals

"Use when applying re-engagement email fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  re-engagement,  engagement workflows or issues
- Building, fixing, or optimizing email marketing re engagement fundamentals
