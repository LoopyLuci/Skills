---
name: azure-services-troubleshooting
description: "Use when applying azure services troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cloud, azure, microsoft, az]
    related_skills: [general]
---

# Azure Services Troubleshooting

"Use when applying azure services troubleshooting."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  microsoft,  az workflows or issues
- Building, fixing, or optimizing azure services troubleshooting
