...
"Use when designing custom neural network architectures."

## Trigger

Activate this skill when the user mentions:
- neural-networks,  architecture,  design,  deep-learning,  pytorch workflows or issues
- Building, fixing, or optimizing custom neural architecture design
...
`neural-networks, architecture, design, deep-learning, pytorch`
