---
name: email-marketing-welcome-best-practices
description: Use when applying email welcome series best practices.
version: 1.0.0
...
# Email Marketing Welcome Best Practices

"Use when applying email welcome series best practices."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome workflows or issues
- Building, fixing, or optimizing email marketing welcome best practices
