---
name: database-architecture-fundamentals
description: Use when for database architecture fundamentals.
version: 1.0.0
...
"Use when for database architecture fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  architecture,  design,  scaling workflows or issues
- Building, fixing, or optimizing database architecture fundamentals
