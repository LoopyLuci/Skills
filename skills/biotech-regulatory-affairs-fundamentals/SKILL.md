---
name: biotech-regulatory-affairs-fundamentals
description: "Use when applying biotech regulatory affairs fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Biotech Regulatory Affairs Fundamentals

"Use when applying biotech regulatory affairs fundamentals."

## Trigger

Activate this skill when the user mentions:
- biotech,  regulatory,  regulatory-affairs workflows or issues
- Building, fixing, or optimizing biotech regulatory affairs fundamentals
...
`biotech, regulatory, regulatory-affairs`
