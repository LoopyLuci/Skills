...
description: Use when applying financial modeling best practices.
version: 1.0.0
...
"Use when applying financial modeling best practices."

## Trigger

Activate this skill when the user mentions:
- finance,  modeling,  financial-modeling workflows or issues
- Building, fixing, or optimizing financial modeling best practices
