---
name: aws-emr-implementation
description: "Use when applying aws emr implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws emr implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  emr,  hadoop,  spark workflows or issues
- Building, fixing, or optimizing aws emr implementation
