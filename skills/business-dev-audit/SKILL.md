---
name: business-dev-audit
description: Use when for business development audit.
version: 1.0.0
...
"Use when for business development audit."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing business dev audit
