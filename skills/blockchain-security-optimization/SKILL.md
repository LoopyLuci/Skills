---
name: blockchain-security-optimization
description: Use when optimizing blockchain security systems.
version: 1.0.0
...
"Use when optimizing blockchain security systems."

## Trigger

Activate this skill when the user mentions:
- security,  blockchain,  smart-contract-audit workflows or issues
- Building, fixing, or optimizing blockchain security optimization
