...
"Use when setting up Datadog monitoring."

## Trigger

Activate this skill when the user mentions:
- "datadog",  "monitoring",  "APM",  "dashboards",  "alerts" workflows or issues
- Building, fixing, or optimizing datadog monitoring setup
- Questions about "datadog" best practices
...
`"datadog", "monitoring", "APM", "dashboards", "alerts"`
