---
name: email-marketing-onboarding-implementation
description: Use when applying email onboarding implementation.
version: 1.0.0
...
# Email Marketing Onboarding Implementation

"Use when applying email onboarding implementation."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome workflows or issues
- Building, fixing, or optimizing email marketing onboarding implementation
