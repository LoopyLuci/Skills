---
name: audit-logging-fundamentals
description: Use when for audit logging fundamentals.
version: 1.0.0
...
"Use when for audit logging fundamentals."

## Trigger

Activate this skill when the user mentions:
- security,  audit-logging,  compliance,  logging workflows or issues
- Building, fixing, or optimizing audit logging fundamentals
