---
name: azure-traffic-manager-troubleshooting
description: "Use when applying azure traffic manager troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure traffic manager troubleshooting."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  cdn,  traffic-routing workflows or issues
- Building, fixing, or optimizing azure traffic manager troubleshooting
...
`cloud, azure, cdn, traffic-routing`
