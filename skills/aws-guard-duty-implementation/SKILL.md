---
name: aws-guard-duty-implementation
description: Use when applying aws guardduty implementation.
version: 1.0.0
...
# Aws Guard Duty Implementation

"Use when applying aws guardduty implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  guardduty,  security,  threat-detection workflows or issues
- Building, fixing, or optimizing aws guard duty implementation
