...
"Use for REST API design. Resources, schemas, OpenAPI, auth."

## Trigger

Activate this skill when the user mentions:
- programming,  api,  rest,  design,  documentation,  openapi workflows or issues
- Building, fixing, or optimizing api design and documentation
...
`programming, api, rest, design, documentation, openapi`
