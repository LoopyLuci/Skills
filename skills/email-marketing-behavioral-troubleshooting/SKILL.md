---
name: email-marketing-behavioral-troubleshooting
description: Use when applying behavioral emails troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, automation, behavioral]
---

# Email Marketing Behavioral Troubleshooting

"Use when applying behavioral emails troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  behavioral workflows or issues
- Building, fixing, or optimizing email marketing behavioral troubleshooting
