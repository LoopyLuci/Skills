---
name: aws-lambda-patterns-deep-best-practices
description: "Use when applying lambda patterns best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Lambda Patterns Deep Best Practices

"Use when applying lambda patterns best practices."

## Trigger

Activate this skill when the user mentions:
- cloud,  lambda workflows or issues
- Building, fixing, or optimizing aws lambda patterns deep best practices
