...
- bgp,  routing,  BGP-iBGP,  eBGP,  traffic-engineering,  AS,  peering,  anycast workflows or issues
- Building, fixing, or optimizing bgp routing patterns
- Questions about bgp best practices
...
`bgp, routing, BGP-iBGP, eBGP, traffic-engineering, AS, peering, anycast`
