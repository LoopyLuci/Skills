...
"Use when governing edge data."

## Trigger

Activate this skill when the user mentions:
- edge-computing,  data-governance,  privacy,  compliance workflows or issues
- Building, fixing, or optimizing edge data governance
...
`edge-computing, data-governance, privacy, compliance`
