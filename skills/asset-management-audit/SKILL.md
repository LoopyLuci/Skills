---
name: asset-management-audit
description: Use when for asset management audit.
version: 1.0.0
...
"Use when for asset management audit."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing asset management audit
