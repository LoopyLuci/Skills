---
name: email-marketing-ROI-troubleshooting
description: Use when applying email roi troubleshooting.
version: 1.0.0
...
# Email Marketing Roi Troubleshooting

"Use when applying email roi troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  roi,  measurement,  analytics workflows or issues
- Building, fixing, or optimizing email marketing roi troubleshooting
...
`email, roi, measurement, analytics`
