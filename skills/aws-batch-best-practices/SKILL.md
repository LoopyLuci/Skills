---
name: aws-batch-best-practices
description: "Use when applying aws batch best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws batch best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  batch,  compute,  jobs workflows or issues
- Building, fixing, or optimizing aws batch best practices
