---
name: database-cassandra-troubleshooting
description: "Use when applying cassandra troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Cassandra Troubleshooting

"Use when applying cassandra troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  cassandra,  nosql,  distributed workflows or issues
- Building, fixing, or optimizing database cassandra troubleshooting
