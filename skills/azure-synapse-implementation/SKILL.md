---
name: azure-synapse-implementation
description: Use when applying azure synapse implementation.
version: 1.0.0
...
"Use when applying azure synapse implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  synapse,  data-warehouse workflows or issues
- Building, fixing, or optimizing azure synapse implementation
