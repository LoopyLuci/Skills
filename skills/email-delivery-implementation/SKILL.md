---
name: email-delivery-implementation
description: Use when applying email delivery implementation.
version: 1.0.0
...
"Use when applying email delivery implementation."

## Trigger

Activate this skill when the user mentions:
- email,  smtp,  delivery workflows or issues
- Building, fixing, or optimizing email delivery implementation
