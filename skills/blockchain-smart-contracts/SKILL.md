...
description: Use when building blockchain smart contracts.
version: 1.0.0
...
"Use when building blockchain smart contracts."

## Trigger

Activate this skill when the user mentions:
- blockchain,  smart-contracts,  solidity workflows or issues
- Building, fixing, or optimizing blockchain smart contracts
