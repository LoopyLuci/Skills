---
name: email-marketing-list-segmentation-troubleshooting
description: Use when applying email list segmentation troubleshooting.
version: 1.0.0
...
# Email Marketing List Segmentation Troubleshooting

"Use when applying email list segmentation troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  segmentation,  targeting workflows or issues
- Building, fixing, or optimizing email marketing list segmentation troubleshooting
