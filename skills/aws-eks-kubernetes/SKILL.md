...
description: Use when using AWS EKS.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, aws-eks]
---

# Aws Eks Kubernetes

"Use when using AWS EKS."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-eks workflows or issues
- Building, fixing, or optimizing aws eks kubernetes
