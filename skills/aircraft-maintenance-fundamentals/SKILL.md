---
name: aircraft-maintenance-fundamentals
description: Use when applying aircraft maintenance fundamentals.
version: 1.0.0
...
"Use when applying aircraft maintenance fundamentals."

## Trigger

Activate this skill when the user mentions:
- aviation,  maintenance,  aircraft-maintenance workflows or issues
- Building, fixing, or optimizing aircraft maintenance fundamentals
