---
name: email-marketing-drip-best-practices
description: Use when applying email drip campaigns best practices.
version: 1.0.0
...
# Email Marketing Drip Best Practices

"Use when applying email drip campaigns best practices."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  drip-campaigns workflows or issues
- Building, fixing, or optimizing email marketing drip best practices
