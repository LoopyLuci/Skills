...
description: "Use when applying aws cost optimization fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws cost optimization fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  cost-optimization,  cost,  finops workflows or issues
- Building, fixing, or optimizing aws cost optimization fundamentals
