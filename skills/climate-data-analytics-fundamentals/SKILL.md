---
name: climate-data-analytics-fundamentals
description: Use when applying climate data analytics fundamentals.
version: 1.0.0
...
# Climate Data Analytics Fundamentals

"Use when applying climate data analytics fundamentals."

## Trigger

Activate this skill when the user mentions:
- climate,  data,  climate-data-analytics workflows or issues
- Building, fixing, or optimizing climate data analytics fundamentals
