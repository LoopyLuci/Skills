---
name: database-postgresql-extensions-fundamentals
description: Use when applying postgresql extensions fundamentals.
version: 1.0.0
...
# Database Postgresql Extensions Fundamentals

"Use when applying postgresql extensions fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  extensions,  contrib workflows or issues
- Building, fixing, or optimizing database postgresql extensions fundamentals
