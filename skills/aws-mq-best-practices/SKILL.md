---
name: aws-mq-best-practices
description: Use when applying aws mq best practices.
version: 1.0.0
...
"Use when applying aws mq best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  mq,  activemq,  rabbitmq workflows or issues
- Building, fixing, or optimizing aws mq best practices
