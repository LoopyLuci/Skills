...
"Use when training XGBoost models."

## Trigger

Activate this skill when the user mentions:
- "xgboost",  "gradient-boosting",  "trees",  "training",  "tuning" workflows or issues
- Building, fixing, or optimizing xgboost model training
- Questions about "xgboost" best practices
...
`"xgboost", "gradient-boosting", "trees", "training", "tuning"`
