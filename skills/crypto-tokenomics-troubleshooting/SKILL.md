---
name: crypto-tokenomics-troubleshooting
description: "Use when applying token economics design troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Crypto Tokenomics Troubleshooting

"Use when applying token economics design troubleshooting."

## Trigger

Activate this skill when the user mentions:
- crypto,  tokenomics,  tokenomics-design workflows or issues
- Building, fixing, or optimizing crypto tokenomics troubleshooting
...
`crypto, tokenomics, tokenomics-design`
