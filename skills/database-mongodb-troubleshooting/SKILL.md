---
name: database-mongodb-troubleshooting
description: "Use when applying mongodb troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mongodb Troubleshooting

"Use when applying mongodb troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  nosql,  document workflows or issues
- Building, fixing, or optimizing database mongodb troubleshooting
