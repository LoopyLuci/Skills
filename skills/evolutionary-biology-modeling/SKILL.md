---
name: evolutionary-biology-modeling
description: "Use when modeling evolutionary biology."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [biology, evolution, population-genetics]
    related_skills: [general]
---

# Evolutionary Biology Modeling

"Use when modeling evolutionary biology."

## Trigger

Activate this skill when the user mentions:
- biology,  evolution,  population-genetics workflows or issues
- Building, fixing, or optimizing evolutionary biology modeling
