---
name: data-loss-prevention-best-practices
description: Use when for data loss prevention best practices.
version: 1.0.0
...
"Use when for data loss prevention best practices."

## Trigger

Activate this skill when the user mentions:
- security,  dlp,  data-protection,  monitoring workflows or issues
- Building, fixing, or optimizing data loss prevention best practices
