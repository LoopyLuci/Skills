---
name: email-marketing-nurture-fundamentals
description: Use when applying email nurture campaigns fundamentals.
version: 1.0.0
...
"Use when applying email nurture campaigns fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  nurturing,  nurture workflows or issues
- Building, fixing, or optimizing email marketing nurture fundamentals
