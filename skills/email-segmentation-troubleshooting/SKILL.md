---
name: email-segmentation-troubleshooting
description: "Use when applying email segmentation troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Segmentation Troubleshooting

"Use when applying email segmentation troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  segmentation workflows or issues
- Building, fixing, or optimizing email segmentation troubleshooting
