...
"Use when writing MongoDB aggregations."

## Trigger

Activate this skill when the user mentions:
- "mongodb",  "aggregation",  "$lookup",  "$unwind",  "$group" workflows or issues
- Building, fixing, or optimizing mongodb aggregation pipeline
- Questions about "mongodb" best practices
...
`"mongodb", "aggregation", "$lookup", "$unwind", "$group"`
