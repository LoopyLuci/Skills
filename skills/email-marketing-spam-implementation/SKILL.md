---
name: email-marketing-spam-implementation
description: Use when applying email spam implementation.
version: 1.0.0
...
# Email Marketing Spam Implementation

"Use when applying email spam implementation."

## Trigger

Activate this skill when the user mentions:
- email,  spam,  deliverability workflows or issues
- Building, fixing, or optimizing email marketing spam implementation
