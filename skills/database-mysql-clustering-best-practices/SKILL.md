---
name: database-mysql-clustering-best-practices
description: "Use when applying mysql clustering best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mysql Clustering Best Practices

"Use when applying mysql clustering best practices."

## Trigger

Activate this skill when the user mentions:
- database,  mysql,  clustering,  ha workflows or issues
- Building, fixing, or optimizing database mysql clustering best practices
