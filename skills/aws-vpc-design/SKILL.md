---
name: aws-vpc-design
description: Use when designing AWS VPC.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, aws-vpc]
---

# Aws Vpc Design

"Use when designing AWS VPC."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-vpc workflows or issues
- Building, fixing, or optimizing aws vpc design
