...
"Use when designing circuit protection."

## Trigger

Activate this skill when the user mentions:
- electronics,  circuit-protection,  safety workflows or issues
- Building, fixing, or optimizing circuit protection design
...
`electronics, circuit-protection, safety`
