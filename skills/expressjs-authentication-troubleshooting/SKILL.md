---
name: expressjs-authentication-troubleshooting
description: "Use when applying express.js auth troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Expressjs Authentication Troubleshooting

"Use when applying express.js auth troubleshooting."

## Trigger

Activate this skill when the user mentions:
- backend,  expressjs,  auth,  jwt workflows or issues
- Building, fixing, or optimizing expressjs authentication troubleshooting
