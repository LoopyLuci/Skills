...
Positive reinforcement, behavior modification, and training plans

## Trigger

Activate this skill when the user mentions:
- "dog",  "training" workflows or issues
- Building, fixing, or optimizing dog training behavior
- Questions about "dog" best practices
