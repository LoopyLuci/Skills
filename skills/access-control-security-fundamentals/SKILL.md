---
name: access-control-security-fundamentals
description: Use when for access control fundamentals.
version: 1.0.0
...
# Access Control Security Fundamentals

"Use when for access control fundamentals."

## Trigger

Activate this skill when the user mentions:
- security,  access-control,  rbac,  abac workflows or issues
- Building, fixing, or optimizing access control security fundamentals
