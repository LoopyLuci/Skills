...
description: Use when analyzing financial data.
version: 1.0.0
...
metadata:
  hermes:
    tags: [finance, analytics, financial-analysis-analysis]
---
...
- finance,  analytics,  financial-analysis-analysis workflows or issues
- Building, fixing, or optimizing financial data analytics
...
`finance, analytics, financial-analysis-analysis`
