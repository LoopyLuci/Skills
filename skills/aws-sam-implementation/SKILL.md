---
name: aws-sam-implementation
description: "Use when applying aws sam implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws sam implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  sam,  serverless,  cloudformation workflows or issues
- Building, fixing, or optimizing aws sam implementation
...
`aws, sam, serverless, cloudformation`
