...
"Use when managing pay-per-click advertising campaigns."

## Trigger

Activate this skill when the user mentions:
- ppc,  advertising,  google-ads,  paid-search,  SEM,  bidding,  keywords workflows or issues
- Building, fixing, or optimizing ppc advertising management
- Questions about ppc best practices
...
`ppc, advertising, google-ads, paid-search, SEM, bidding, keywords`
