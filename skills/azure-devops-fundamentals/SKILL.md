...
description: Use when applying azure devops fundamentals.
version: 1.0.0
...
"Use when applying azure devops fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  devops,  pipelines workflows or issues
- Building, fixing, or optimizing azure devops fundamentals
