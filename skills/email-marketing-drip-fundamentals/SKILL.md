---
name: email-marketing-drip-fundamentals
description: "Use when applying email drip campaigns fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Drip Fundamentals

"Use when applying email drip campaigns fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  drip-campaigns workflows or issues
- Building, fixing, or optimizing email marketing drip fundamentals
