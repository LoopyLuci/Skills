---
name: database-postgresql-json-troubleshooting
description: Use when applying postgresql json troubleshooting.
version: 1.0.0
...
# Database Postgresql Json Troubleshooting

"Use when applying postgresql json troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  json,  document workflows or issues
- Building, fixing, or optimizing database postgresql json troubleshooting
...
`database, postgresql, json, document`
