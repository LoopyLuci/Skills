...
description: "Use when applying aws cloudformation best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws cloudformation best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  cloudformation,  iac,  templates workflows or issues
- Building, fixing, or optimizing aws cloudformation best practices
