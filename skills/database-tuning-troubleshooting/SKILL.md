---
name: database-tuning-troubleshooting
description: "Use when for database tuning troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database tuning troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  tuning,  performance,  optimization workflows or issues
- Building, fixing, or optimizing database tuning troubleshooting
