---
name: fashion-tech-wearables
description: "Use when building fashion tech wearables."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [fashion, fashion-tech, wearables, smart-clothing]
    related_skills: [general]
---

## Overview
Fashion Tech Wearables implementation. Comprehensive approach covering best practices, 
methodologies, technical considerations, and verification approaches.

## When to Use
- "Fashion Tech Wearables and optimization"
- "Best practices for Fashion Tech Wearables workflows"
- "Fashion Tech Wearables compliance and standards"
- "Fashion Tech Wearables troubleshooting and problem-solving"
- "Fashion Tech Wearables ROI and performance measurement"
