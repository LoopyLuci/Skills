...
description: Use when for database indexing best practices.
version: 1.0.0
...
"Use when for database indexing best practices."

## Trigger

Activate this skill when the user mentions:
- database,  indexing,  performance,  optimization workflows or issues
- Building, fixing, or optimizing database indexing best practices
