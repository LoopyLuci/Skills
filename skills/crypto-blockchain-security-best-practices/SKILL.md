---
name: crypto-blockchain-security-best-practices
description: Use when applying blockchain security best practices.
version: 1.0.0
...
metadata:
  hermes:
    tags: [crypto, security, blockchain-security]
---

# Crypto Blockchain Security Best Practices

"Use when applying blockchain security best practices."

## Trigger

Activate this skill when the user mentions:
- crypto,  security,  blockchain-security workflows or issues
- Building, fixing, or optimizing crypto blockchain security best practices
...
`crypto, security, blockchain-security`
