---
name: business-model-innovation-troubleshooting
description: "Use when applying business model innovation troubleshoot."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Business Model Innovation Troubleshooting

"Use when applying business model innovation troubleshoot."

## Trigger

Activate this skill when the user mentions:
- consulting,  innovation,  business-model workflows or issues
- Building, fixing, or optimizing business model innovation troubleshooting
...
`consulting, innovation, business-model`
