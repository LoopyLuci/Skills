---
name: email-marketing-inbox-troubleshooting
description: Use when applying email inbox placement troubleshooting.
version: 1.0.0
...
# Email Marketing Inbox Troubleshooting

"Use when applying email inbox placement troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  inbox workflows or issues
- Building, fixing, or optimizing email marketing inbox troubleshooting
