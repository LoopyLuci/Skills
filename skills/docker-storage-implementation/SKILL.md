---
name: docker-storage-implementation
description: "Use when applying docker storage implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Docker Storage Implementation

"Use when applying docker storage implementation."

## Trigger

Activate this skill when the user mentions:
- docker,  storage,  volumes,  docker-volume-backup-restore workflows or issues
- Building, fixing, or optimizing docker storage implementation
