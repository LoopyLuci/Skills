...
description: Skill for agent platform model registry
version: 1.0.0
...
**Trigger**: Use when managing Model Registry on Google Cloud's Agent Platform — Google Cloud AI and agent infrastructure.
