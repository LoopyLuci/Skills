---
name: email-marketing-list-segmentation-best-practices
description: "Use when applying email list segmentation best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email list segmentation best practices."

## Trigger

Activate this skill when the user mentions:
- email,  segmentation,  targeting workflows or issues
- Building, fixing, or optimizing email marketing list segmentation best practices
