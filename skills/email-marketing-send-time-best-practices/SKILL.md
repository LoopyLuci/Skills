---
name: email-marketing-send-time-best-practices
description: Use when applying email send time best practices.
version: 1.0.0
...
# Email Marketing Send Time Best Practices

"Use when applying email send time best practices."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  timing workflows or issues
- Building, fixing, or optimizing email marketing send time best practices
