---
name: email-marketing-abandoned-cart-recovery-implementation
description: "Use when applying abandoned cart recovery implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Abandoned Cart Recovery Implementation

"Use when applying abandoned cart recovery implementation."

## Trigger

Activate this skill when the user mentions:
- email,  ecommerce,  cart-abandonment workflows or issues
- Building, fixing, or optimizing email marketing abandoned cart recovery implementation
