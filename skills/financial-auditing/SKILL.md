...
"Use when auditing finances."

## Trigger

Activate this skill when the user mentions:
- finance,  audit,  financial-analysis-fundamentals workflows or issues
- Building, fixing, or optimizing financial auditing
...
`finance, audit, financial-analysis-fundamentals`
