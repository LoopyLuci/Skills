---
name: aws-batch-fundamentals
description: "Use when applying aws batch fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws batch fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  batch,  compute,  jobs workflows or issues
- Building, fixing, or optimizing aws batch fundamentals
