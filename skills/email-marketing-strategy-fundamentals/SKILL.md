---
name: email-marketing-strategy-fundamentals
description: "Use when applying email marketing strategy fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email marketing strategy fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-strategy workflows or issues
- Building, fixing, or optimizing email marketing strategy fundamentals
