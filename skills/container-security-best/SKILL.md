---
name: container-security-best
description: Use when applying container security.
version: 1.0.0
...
metadata:
  hermes:
    tags: [devops, containers, container-security-best-practices]
---

# Container Security Best

"Use when applying container security."

## Trigger

Activate this skill when the user mentions:
- devops,  containers,  container-security-best-practices workflows or issues
- Building, fixing, or optimizing container security best
...
`devops, containers, container-security-best-practices`
