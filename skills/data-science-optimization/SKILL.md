...
"Use when optimizing data science systems."

## Trigger

Activate this skill when the user mentions:
- data-science,  analytics,  ml,  python workflows or issues
- Building, fixing, or optimizing data science optimization
...
`data-science, analytics, ml, python`
