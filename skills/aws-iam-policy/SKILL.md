...
"Use when writing AWS IAM policies."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-iam-policy-writing workflows or issues
- Building, fixing, or optimizing aws iam policy
...
`cloud, aws, aws-iam-policy-writing`
