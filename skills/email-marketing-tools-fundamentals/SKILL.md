---
name: email-marketing-tools-fundamentals
description: "Use when applying email marketing tools fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Tools Fundamentals

"Use when applying email marketing tools fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  tools,  marketing workflows or issues
- Building, fixing, or optimizing email marketing tools fundamentals
