...
description: Use when for financial analysis fundamentals.
version: 1.0.0
...
"Use when for financial analysis fundamentals."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing financial analysis fundamentals
