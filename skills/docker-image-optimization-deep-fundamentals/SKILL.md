---
name: docker-image-optimization-deep-fundamentals
description: Use when applying docker image optimization fundamentals.
version: 1.0.0
...
# Docker Image Optimization Deep Fundamentals

"Use when applying docker image optimization fundamentals."

## Trigger

Activate this skill when the user mentions:
- devops,  docker workflows or issues
- Building, fixing, or optimizing docker image optimization deep fundamentals
