---
name: email-marketing-welcome-fundamentals
description: Use when applying email welcome series fundamentals.
version: 1.0.0
...
# Email Marketing Welcome Fundamentals

"Use when applying email welcome series fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome workflows or issues
- Building, fixing, or optimizing email marketing welcome fundamentals
