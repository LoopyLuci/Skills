---
name: ai-alignment-fundamentals
description: Use when for ai alignment fundamentals.
version: 1.0.0
...
"Use when for ai alignment fundamentals."

## Trigger

Activate this skill when the user mentions:
- ai,  alignment,  safety,  ethics workflows or issues
- Building, fixing, or optimizing ai alignment fundamentals
