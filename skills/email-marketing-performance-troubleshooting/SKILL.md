---
name: email-marketing-performance-troubleshooting
description: "Use when applying email performance troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [email, analytics, performance]
    related_skills: [general]
---

# Email Marketing Performance Troubleshooting

"Use when applying email performance troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  performance workflows or issues
- Building, fixing, or optimizing email marketing performance troubleshooting
