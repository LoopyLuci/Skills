---
name: crypto-zero-knowledge-fundamentals
description: Use when applying zero-knowledge proofs fundamentals.
version: 1.0.0
...
# Crypto Zero Knowledge Fundamentals

"Use when applying zero-knowledge proofs fundamentals."

## Trigger

Activate this skill when the user mentions:
- crypto,  zkp,  zero-knowledge-proofs workflows or issues
- Building, fixing, or optimizing crypto zero knowledge fundamentals
