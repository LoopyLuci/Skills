---
name: database-migrations-implementation
description: "Use when for database migrations implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database migrations implementation."

## Trigger

Activate this skill when the user mentions:
- database,  migrations,  schema-evolution workflows or issues
- Building, fixing, or optimizing database migrations implementation
