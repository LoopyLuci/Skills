---
name: email-marketing-survival-guide-troubleshooting
description: "Use when applying email survival guide troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [email, deliverability, spam-filter]
    related_skills: [general]
---

# Email Marketing Survival Guide Troubleshooting

"Use when applying email survival guide troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  spam-filter workflows or issues
- Building, fixing, or optimizing email marketing survival guide troubleshooting
...
`email, deliverability, spam-filter`
