---
name: aws-kafka-fundamentals
description: "Use when applying aws kafka fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Kafka Fundamentals

"Use when applying aws kafka fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  kafka,  msk,  streaming workflows or issues
- Building, fixing, or optimizing aws kafka fundamentals
