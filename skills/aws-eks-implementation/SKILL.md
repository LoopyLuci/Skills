---
name: aws-eks-implementation
description: "Use when applying aws eks implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws eks implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  eks,  kubernetes,  managed-k8s workflows or issues
- Building, fixing, or optimizing aws eks implementation
