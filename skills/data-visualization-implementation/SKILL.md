...
description: Use when applying data visualization implementation.
version: 1.0.0
...
"Use when applying data visualization implementation."

## Trigger

Activate this skill when the user mentions:
- data,  viz,  data-visualization-design workflows or issues
- Building, fixing, or optimizing data visualization implementation
