---
name: blockchain-ethereum-best-practices
description: Use when for ethereum development best practices.
version: 1.0.0
...
# Blockchain Ethereum Best Practices

"Use when for ethereum development best practices."

## Trigger

Activate this skill when the user mentions:
- blockchain,  ethereum,  solidity,  smart-contracts workflows or issues
- Building, fixing, or optimizing blockchain ethereum best practices
