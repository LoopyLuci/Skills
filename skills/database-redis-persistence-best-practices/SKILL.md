---
name: database-redis-persistence-best-practices
description: Use when applying redis persistence best practices.
version: 1.0.0
...
metadata:
  hermes:
    tags: [database, redis, persistence, durability]
---

# Database Redis Persistence Best Practices

"Use when applying redis persistence best practices."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  persistence,  durability workflows or issues
- Building, fixing, or optimizing database redis persistence best practices
...
`database, redis, persistence, durability`
