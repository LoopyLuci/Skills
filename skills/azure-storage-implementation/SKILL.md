---
name: azure-storage-implementation
description: Use when applying azure storage implementation.
version: 1.0.0
...
"Use when applying azure storage implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  blob,  file-storage workflows or issues
- Building, fixing, or optimizing azure storage implementation
