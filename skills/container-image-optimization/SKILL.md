...
"Use when optimizing container images."

## Trigger

Activate this skill when the user mentions:
- devops,  containers,  docker-image-optimization workflows or issues
- Building, fixing, or optimizing container image optimization
...
`devops, containers, docker-image-optimization`
