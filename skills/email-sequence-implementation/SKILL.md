---
name: email-sequence-implementation
description: "Use when applying email sequence implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email sequence implementation."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-sequence-automation workflows or issues
- Building, fixing, or optimizing email sequence implementation
