---
name: email-marketing-CTAs-fundamentals
description: Use when applying email ctas fundamentals.
version: 1.0.0
...
# Email Marketing Ctas Fundamentals

"Use when applying email ctas fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  copywriting,  call-to-action workflows or issues
- Building, fixing, or optimizing email marketing ctas fundamentals
