...
"Use when designing SaaS pricing models."

## Trigger

Activate this skill when the user mentions:
- "pricing",  "saas",  "tiers",  "per-seat",  "usage-based" workflows or issues
- Building, fixing, or optimizing pricing models saas
...
`"pricing", "saas", "tiers", "per-seat", "usage-based"`
