...
"Use when troubleshooting cloud security."

## Trigger

Activate this skill when the user mentions:
- security,  cloud-security,  infosec workflows or issues
- Building, fixing, or optimizing cloud security troubleshooting
...
`security, cloud-security, infosec`
