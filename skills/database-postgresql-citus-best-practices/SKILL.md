---
name: database-postgresql-citus-best-practices
description: Use when applying postgresql citus best practices.
version: 1.0.0
...
# Database Postgresql Citus Best Practices

"Use when applying postgresql citus best practices."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  citus,  sharding workflows or issues
- Building, fixing, or optimizing database postgresql citus best practices
