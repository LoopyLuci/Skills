---
name: database-postgresql-query-optimization-deep-best-practices
description: "Use when applying postgresql query optimization best pra."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Postgresql Query Optimization Deep Best Practices

"Use when applying postgresql query optimization best pra."

## Trigger

Activate this skill when the user mentions:
- data,  postgres workflows or issues
- Building, fixing, or optimizing database postgresql query optimization deep best practices
