---
name: database-postgresql-citus-troubleshooting
description: Use when applying postgresql citus troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [database, postgresql, citus, sharding]
---

# Database Postgresql Citus Troubleshooting

"Use when applying postgresql citus troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  citus,  sharding workflows or issues
- Building, fixing, or optimizing database postgresql citus troubleshooting
