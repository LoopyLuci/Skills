...
IDS/IPS, SIEM, packet analysis, NetFlow, Zeek, and anomaly detection

## Trigger

Activate this skill when the user mentions:
- "nsm",  "siem" workflows or issues
- Building, fixing, or optimizing network security monitoring
- Questions about "nsm" best practices
