---
name: ci-cd-security-implementation
description: Use when applying ci/cd security implementation.
version: 1.0.0
...
"Use when applying ci/cd security implementation."

## Trigger

Activate this skill when the user mentions:
- devops,  security,  ci-cd-security,  pipeline workflows or issues
- Building, fixing, or optimizing ci cd security implementation
