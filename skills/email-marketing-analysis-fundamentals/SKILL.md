---
name: email-marketing-analysis-fundamentals
description: "Use when applying email marketing analysis fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Analysis Fundamentals

"Use when applying email marketing analysis fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-analysis workflows or issues
- Building, fixing, or optimizing email marketing analysis fundamentals
