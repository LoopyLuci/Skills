---
name: failure-analysis-implementation
description: Use when applying failure analysis implementation.
version: 1.0.0
...
"Use when applying failure analysis implementation."

## Trigger

Activate this skill when the user mentions:
- materials,  engineering,  failure-mode-analysis workflows or issues
- Building, fixing, or optimizing failure analysis implementation
