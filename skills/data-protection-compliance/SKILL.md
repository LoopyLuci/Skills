...
"Use when ensuring data protection compliance."

## Trigger

Activate this skill when the user mentions:
- legal,  data-protection,  gdpr,  privacy workflows or issues
- Building, fixing, or optimizing data protection compliance
...
`legal, data-protection, gdpr, privacy`
