---
name: database-elasticsearch-mapping-fundamentals
description: Use when applying elasticsearch mapping fundamentals.
version: 1.0.0
...
# Database Elasticsearch Mapping Fundamentals

"Use when applying elasticsearch mapping fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  elasticsearch,  mapping,  schema workflows or issues
- Building, fixing, or optimizing database elasticsearch mapping fundamentals
