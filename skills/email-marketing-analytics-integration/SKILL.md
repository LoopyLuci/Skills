---
name: email-marketing-analytics-integration
description: "Use when connecting email analytics."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [email, marketing, analytics, integration]
    related_skills: [general]
---

# Email Marketing Analytics Integration

"Use when connecting email analytics."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  analytics,  integration workflows or issues
- Building, fixing, or optimizing email marketing analytics integration
