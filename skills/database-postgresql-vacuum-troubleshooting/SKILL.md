---
name: database-postgresql-vacuum-troubleshooting
description: "Use when applying postgresql vacuum troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Postgresql Vacuum Troubleshooting

"Use when applying postgresql vacuum troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  vacuum,  maintenance workflows or issues
- Building, fixing, or optimizing database postgresql vacuum troubleshooting
...
`database, postgresql, vacuum, maintenance`
