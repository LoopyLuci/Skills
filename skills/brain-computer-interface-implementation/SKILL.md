---
name: brain-computer-interface-implementation
description: Use when applying bci interface implementation.
version: 1.0.0
...
"Use when applying bci interface implementation."

## Trigger

Activate this skill when the user mentions:
- neurotech,  bci,  neural-interface-design workflows or issues
- Building, fixing, or optimizing brain computer interface implementation
