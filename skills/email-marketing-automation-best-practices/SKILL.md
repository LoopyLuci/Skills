---
name: email-marketing-automation-best-practices
description: "Use when applying email marketing automation best practi."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email marketing automation best practi."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-automation workflows or issues
- Building, fixing, or optimizing email marketing automation best practices
