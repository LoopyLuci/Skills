---
name: database-backup-troubleshooting
description: Use when for database backups troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [database, backup, recovery, postgresql, mysql]
---

# Database Backup Troubleshooting

"Use when for database backups troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  backup,  recovery,  postgresql,  mysql workflows or issues
- Building, fixing, or optimizing database backup troubleshooting
...
`database, backup, recovery, postgresql, mysql`
