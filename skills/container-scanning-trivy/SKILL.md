...
"Use when scanning containers with Trivy."

## Trigger

Activate this skill when the user mentions:
- security,  devops,  trivy-container workflows or issues
- Building, fixing, or optimizing container scanning trivy
...
`security, devops, trivy-container`
