---
name: email-marketing-integration-fundamentals
description: "Use when applying email integration fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Integration Fundamentals

"Use when applying email integration fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  integration,  api workflows or issues
- Building, fixing, or optimizing email marketing integration fundamentals
