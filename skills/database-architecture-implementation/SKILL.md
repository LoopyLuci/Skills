...
description: Use when for database architecture implementation.
version: 1.0.0
...
"Use when for database architecture implementation."

## Trigger

Activate this skill when the user mentions:
- database,  architecture,  design,  scaling workflows or issues
- Building, fixing, or optimizing database architecture implementation
