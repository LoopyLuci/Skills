---
name: email-marketing-list-growth-implementation
description: Use when applying email list growth implementation.
version: 1.0.0
...
# Email Marketing List Growth Implementation

"Use when applying email list growth implementation."

## Trigger

Activate this skill when the user mentions:
- email,  growth,  list-building-email-growth workflows or issues
- Building, fixing, or optimizing email marketing list growth implementation
