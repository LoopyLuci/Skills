---
name: climate-data-analytics-best-practices
description: "Use when applying climate data analytics best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Climate Data Analytics Best Practices

"Use when applying climate data analytics best practices."

## Trigger

Activate this skill when the user mentions:
- climate,  data,  climate-data-analytics workflows or issues
- Building, fixing, or optimizing climate data analytics best practices
...
`climate, data, climate-data-analytics`
