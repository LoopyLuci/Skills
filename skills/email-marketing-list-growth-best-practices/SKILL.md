---
name: email-marketing-list-growth-best-practices
description: "Use when applying email list growth best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing List Growth Best Practices

"Use when applying email list growth best practices."

## Trigger

Activate this skill when the user mentions:
- email,  growth,  list-building-email-growth workflows or issues
- Building, fixing, or optimizing email marketing list growth best practices
