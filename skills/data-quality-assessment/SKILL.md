...
"Use when assessing data quality."

## Trigger

Activate this skill when the user mentions:
- data-science,  data-quality,  profiling,  validation workflows or issues
- Building, fixing, or optimizing data quality assessment
...
`data-science, data-quality, profiling, validation`
