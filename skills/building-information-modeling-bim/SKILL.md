...
"Use when modeling buildings with BIM."

## Trigger

Activate this skill when the user mentions:
- construction,  bim,  building-model,  architecture workflows or issues
- Building, fixing, or optimizing building information modeling bim
...
`construction, bim, building-model, architecture`
