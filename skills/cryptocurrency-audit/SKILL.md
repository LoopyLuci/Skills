---
name: cryptocurrency-audit
description: Use when for cryptocurrency audit.
version: 1.0.0
...
"Use when for cryptocurrency audit."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing cryptocurrency audit
