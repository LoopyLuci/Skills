---
name: database-migrations-fundamentals
description: "Use when for database migrations fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database migrations fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  migrations,  schema-evolution workflows or issues
- Building, fixing, or optimizing database migrations fundamentals
