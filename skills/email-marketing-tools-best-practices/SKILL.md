---
name: email-marketing-tools-best-practices
description: Use when applying email marketing tools best practices.
version: 1.0.0
...
"Use when applying email marketing tools best practices."

## Trigger

Activate this skill when the user mentions:
- email,  tools,  marketing workflows or issues
- Building, fixing, or optimizing email marketing tools best practices
