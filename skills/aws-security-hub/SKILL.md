...
"Use when using AWS Security Hub."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-security-hub-best-practices workflows or issues
- Building, fixing, or optimizing aws security hub
...
`cloud, aws, aws-security-hub-best-practices`
