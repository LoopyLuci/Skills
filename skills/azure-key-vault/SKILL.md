...
"Use when managing Azure secrets."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  azure-key-vault workflows or issues
- Building, fixing, or optimizing azure key vault
