...
description: "Use when applying azure cosmos db implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure cosmos db implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  cosmos-db,  nosql workflows or issues
- Building, fixing, or optimizing azure cosmos db implementation
