---
name: data-lake-architecture-deep-fundamentals
description: "Use when applying data lake architecture fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Data Lake Architecture Deep Fundamentals

"Use when applying data lake architecture fundamentals."

## Trigger

Activate this skill when the user mentions:
- data,  data-lake workflows or issues
- Building, fixing, or optimizing data lake architecture deep fundamentals
