---
name: database-postgresql-json-implementation
description: "Use when applying postgresql json implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Postgresql Json Implementation

"Use when applying postgresql json implementation."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  json,  document workflows or issues
- Building, fixing, or optimizing database postgresql json implementation
