---
name: agri-tech-supply-chain-implementation
description: Use when applying agricultural supply chain implementation.
version: 1.0.0
...
# Agri Tech Supply Chain Implementation

"Use when applying agricultural supply chain implementation."

## Trigger

Activate this skill when the user mentions:
- agri,  supply,  agri-supply-chain workflows or issues
- Building, fixing, or optimizing agri tech supply chain implementation
