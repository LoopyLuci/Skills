---
name: aws-security-governance
description: Use when governing AWS security.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, security-governance]
---

# Aws Security Governance

"Use when governing AWS security."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  security-governance workflows or issues
- Building, fixing, or optimizing aws security governance
