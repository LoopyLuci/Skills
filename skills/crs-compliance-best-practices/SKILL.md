---
name: crs-compliance-best-practices
description: Use when applying crs best practices.
version: 1.0.0
...
# Crs Compliance Best Practices

"Use when applying crs best practices."

## Trigger

Activate this skill when the user mentions:
- finance,  tax,  crs workflows or issues
- Building, fixing, or optimizing crs compliance best practices
