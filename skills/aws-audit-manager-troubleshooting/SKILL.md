---
name: aws-audit-manager-troubleshooting
description: "Use when applying aws audit manager troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [aws, audit-manager, compliance, audit]
    related_skills: [general]
---

# Aws Audit Manager Troubleshooting

"Use when applying aws audit manager troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  audit-manager,  compliance,  audit workflows or issues
- Building, fixing, or optimizing aws audit manager troubleshooting
...
`aws, audit-manager, compliance, audit`
