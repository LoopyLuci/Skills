---
name: email-retention-fundamentals
description: "Use when applying email retention fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Retention Fundamentals

"Use when applying email retention fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  retention workflows or issues
- Building, fixing, or optimizing email retention fundamentals
