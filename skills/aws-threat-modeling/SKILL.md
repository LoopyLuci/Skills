...
"Use when threat modeling AWS."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  threat-modeling-fundamentals workflows or issues
- Building, fixing, or optimizing aws threat modeling
...
`cloud, aws, threat-modeling-fundamentals`
