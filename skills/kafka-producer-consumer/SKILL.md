...
"Use when implementing Kafka producers."

## Trigger

Activate this skill when the user mentions:
- "kafka",  "producer",  "consumer",  "avro",  "schema-registry" workflows or issues
- Building, fixing, or optimizing kafka producer consumer
...
`"kafka", "producer", "consumer", "avro", "schema-registry"`
