---
name: email-marketing-conversion-fundamentals
description: Use when applying email conversion fundamentals.
version: 1.0.0
...
# Email Marketing Conversion Fundamentals

"Use when applying email conversion fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  conversion workflows or issues
- Building, fixing, or optimizing email marketing conversion fundamentals
