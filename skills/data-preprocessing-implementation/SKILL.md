---
name: data-preprocessing-implementation
description: "Use when applying data preprocessing implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying data preprocessing implementation."

## Trigger

Activate this skill when the user mentions:
- data,  preprocessing,  data-cleaning-patterns workflows or issues
- Building, fixing, or optimizing data preprocessing implementation
