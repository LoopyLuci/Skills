---
name: data-engineering-pipelines-fundamentals
description: Use when for data engineering fundamentals.
version: 1.0.0
...
# Data Engineering Pipelines Fundamentals

"Use when for data engineering fundamentals."

## Trigger

Activate this skill when the user mentions:
- data-engineering,  etl,  data-pipeline workflows or issues
- Building, fixing, or optimizing data engineering pipelines fundamentals
