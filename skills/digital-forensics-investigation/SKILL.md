...
Disk imaging, memory forensics, timeline analysis, mobile forensics, and chain of custody

## Trigger

Activate this skill when the user mentions:
- "forensics",  "dfir" workflows or issues
- Building, fixing, or optimizing digital forensics investigation
- Questions about "forensics" best practices
