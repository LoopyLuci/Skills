---
name: database-redis-troubleshooting
description: "Use when applying redis troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Redis Troubleshooting

"Use when applying redis troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  caching,  in-memory workflows or issues
- Building, fixing, or optimizing database redis troubleshooting
...
`database, redis, caching, in-memory`
