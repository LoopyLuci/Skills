---
name: crypto-zero-knowledge-troubleshooting
description: Use when applying zero-knowledge proofs troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [crypto, zkp, zero-knowledge-proofs]
---

# Crypto Zero Knowledge Troubleshooting

"Use when applying zero-knowledge proofs troubleshooting."

## Trigger

Activate this skill when the user mentions:
- crypto,  zkp,  zero-knowledge-proofs workflows or issues
- Building, fixing, or optimizing crypto zero knowledge troubleshooting
