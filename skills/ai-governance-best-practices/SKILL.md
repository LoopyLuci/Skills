...
description: Use when for ai governance best practices.
version: 1.0.0
...
"Use when for ai governance best practices."

## Trigger

Activate this skill when the user mentions:
- ai,  governance,  policy,  regulation workflows or issues
- Building, fixing, or optimizing ai governance best practices
