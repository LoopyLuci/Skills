---
name: email-automation-troubleshooting
description: Use when applying email automation troubleshooting.
version: 1.0.0
...
"Use when applying email automation troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-automation workflows or issues
- Building, fixing, or optimizing email automation troubleshooting
