...
"Use when processing EEG signals. Preprocessing, FFT."

## Trigger

Activate this skill when the user mentions:
- neurotech,  eeg,  signal-processing,  preprocessing,  spectral-analysis workflows or issues
- Building, fixing, or optimizing eeg signal processing
...
`neurotech, eeg, signal-processing, preprocessing, spectral-analysis`
