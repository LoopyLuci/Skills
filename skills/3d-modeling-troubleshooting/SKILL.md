---
name: 3d-modeling-troubleshooting
description: "Use when applying 3d modeling troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [media, 3d, 3d-modeling-techniques]
    related_skills: [general]
---

# 3d Modeling Troubleshooting

"Use when applying 3d modeling troubleshooting."

## Trigger

Activate this skill when the user mentions:
- media,  3d,  3d-modeling-techniques workflows or issues
- Building, fixing, or optimizing 3d modeling troubleshooting
...
`media, 3d, 3d-modeling-techniques`
