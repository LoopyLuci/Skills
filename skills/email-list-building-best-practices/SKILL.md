---
name: email-list-building-best-practices
description: Use when applying email list building best practices.
version: 1.0.0
...
"Use when applying email list building best practices."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  list-building-email-growth workflows or issues
- Building, fixing, or optimizing email list building best practices
