---
name: email-marketing-unsubscribe-troubleshooting
description: "Use when applying email unsubscribe troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [email, analytics, unsubscribe]
    related_skills: [general]
---

# Email Marketing Unsubscribe Troubleshooting

"Use when applying email unsubscribe troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  unsubscribe workflows or issues
- Building, fixing, or optimizing email marketing unsubscribe troubleshooting
