---
name: aws-config-troubleshooting
description: Use when applying aws config troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [aws, config, compliance, auditing]
---

# Aws Config Troubleshooting

"Use when applying aws config troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  config,  compliance,  auditing workflows or issues
- Building, fixing, or optimizing aws config troubleshooting
