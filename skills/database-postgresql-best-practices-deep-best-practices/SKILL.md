---
name: database-postgresql-best-practices-deep-best-practices
description: "Use when applying postgresql best practices best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [data, postgres]
    related_skills: ['postgres-best-practices']
---

# Database Postgresql Best Practices Deep Best Practices

"Use when applying postgresql best practices best practices."

## Trigger

Activate this skill when the user mentions:
- data,  postgres workflows or issues
- Building, fixing, or optimizing database postgresql best practices deep best practices
