---
name: email-retention-implementation
description: Use when applying email retention implementation.
version: 1.0.0
...
# Email Retention Implementation

"Use when applying email retention implementation."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  retention workflows or issues
- Building, fixing, or optimizing email retention implementation
