---
name: automotive-sustainability-reporting
description: "Use when reporting automotive sustainability."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [automotive, sustainability, reporting, esg]
    related_skills: [sustainability-reporting]
---

## Overview
Automotive Sustainability Reporting implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Automotive Sustainability Reporting implementation and optimization"
- "Best practices for Automotive Sustainability Reporting workflows"
- "Automotive Sustainability Reporting compliance and standards"
- "Automotive Sustainability Reporting troubleshooting and problem-solving"
- "Automotive Sustainability Reporting ROI and performance measurement"
