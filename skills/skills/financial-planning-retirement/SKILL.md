...
description: "Use when planning retirement finances."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [finance, retirement-planning, 401k]
    related_skills: ['financial-planning-budgeting']
---

## Overview
Plan retirement finances including 401(k) and IRA optimization.

## When to Use
- "Financial Planning Retirement design and implementation"
- "Best practices for Financial Planning Retirement"
- "Financial Planning Retirement deployment and optimization"
- "Financial Planning Retirement troubleshooting and maintenance"
