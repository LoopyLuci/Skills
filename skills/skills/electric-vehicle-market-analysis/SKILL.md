---
name: electric-vehicle-market-analysis
description: "Use when analyzing EV markets."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [automotive, ev-market, analysis, forecasting]
    related_skills: [market-research]
---

## Overview
Electric Vehicle Market Analysis implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Electric Vehicle Market Analysis implementation and optimization"
- "Best practices for Electric Vehicle Market Analysis workflows"
- "Electric Vehicle Market Analysis compliance and standards"
- "Electric Vehicle Market Analysis troubleshooting and problem-solving"
- "Electric Vehicle Market Analysis ROI and performance measurement"
