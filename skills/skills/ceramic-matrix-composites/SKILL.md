...
description: "Use when working with CMCs."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [materials-science, cmc, ceramic-composites, high-temp]
    related_skills: [general]
---

## Overview
Ceramic Matrix Composites implementation. Comprehensive approach covering best practices, 
methodologies, technical considerations, and verification approaches.

## When to Use
- "Ceramic Matrix Composites and optimization"
- "Best practices for Ceramic Matrix Composites workflows"
- "Ceramic Matrix Composites compliance and standards"
- "Ceramic Matrix Composites troubleshooting and problem-solving"
- "Ceramic Matrix Composites ROI and performance measurement"
