...
## Overview
Design API specifications using OpenAPI, Swagger, and GraphQL schemas with proper versioning and documentation.

## When to Use
- "API specification design and implementation"
- "Best practices for API documentation"
- "API specification optimization"
- "API specification troubleshooting"
