---
name: embedded-system-testing
description: "Use when testing embedded systems."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [electronics, embedded-testing, validation]
    related_skills: [general]
---

## Overview
Test embedded systems using hardware-in-the-loop and unit testing.

## When to Use
- "Embedded System Testing design and implementation"
- "Best practices for Embedded System Testing"
- "Embedded System Testing optimization and scaling"
- "Embedded System Testing troubleshooting and validation"
