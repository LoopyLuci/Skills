...
description: "Use when studying biochemistry metabolism."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [biology, biochemistry, metabolism, enzymes]
    related_skills: [general]
---

## Overview
Study biochemical metabolism including glycolysis and enzyme kinetics.

## When to Use
- "Biochemistry Metabolism design and implementation"
- "Best practices for Biochemistry Metabolism"
- "Biochemistry Metabolism deployment and optimization"
- "Biochemistry Metabolism troubleshooting and maintenance"
