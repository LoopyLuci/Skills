---
name: cardiology-troubleshooting
description: "Use when troubleshooting cardiology issues."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cardiology, heart, cardiovascular, medicine]
    related_skills: [general]
---

## Overview
Apply troubleshooting cardiology issues for effective results. 

## When to Use
- "Cardiology Troubleshooting design and implementation"
- "Best practices for Cardiology Troubleshooting"
- "Cardiology Troubleshooting optimization and scaling"
- "Cardiology Troubleshooting troubleshooting and validation"
