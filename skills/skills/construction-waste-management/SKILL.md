...
description: "Use when managing construction waste."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [construction, waste-management, disposal, recycling]
    related_skills: [municipal-waste-management]
---

## Overview
Construction Waste Management implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Construction Waste Management implementation and optimization"
- "Best practices for Construction Waste Management workflows"
- "Construction Waste Management compliance and standards"
- "Construction Waste Management troubleshooting and problem-solving"
- "Construction Waste Management ROI and performance measurement"
