---
name: fashion-ecommerce-photography
description: "Use when shooting fashion ecommerce photos."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [fashion, ecommerce, photography, product-photos]
    related_skills: [general]
---

## Overview
Fashion Ecommerce Photography implementation. Comprehensive approach covering best practices, 
methodologies, technical considerations, and verification approaches.

## When to Use
- "Fashion Ecommerce Photography and optimization"
- "Best practices for Fashion Ecommerce Photography workflows"
- "Fashion Ecommerce Photography compliance and standards"
- "Fashion Ecommerce Photography troubleshooting and problem-solving"
- "Fashion Ecommerce Photography ROI and performance measurement"
