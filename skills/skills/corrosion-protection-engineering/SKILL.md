---
name: corrosion-protection-engineering
description: "Use when protecting against corrosion."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [materials-science, corrosion, protection, coatings]
    related_skills: [general]
---

## Overview
Corrosion Protection Engineering implementation. Comprehensive approach covering best practices, 
methodologies, technical considerations, and verification approaches.

## When to Use
- "Corrosion Protection Engineering and optimization"
- "Best practices for Corrosion Protection Engineering workflows"
- "Corrosion Protection Engineering compliance and standards"
- "Corrosion Protection Engineering troubleshooting and problem-solving"
- "Corrosion Protection Engineering ROI and performance measurement"
