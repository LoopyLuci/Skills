---
name: construction-material-specification
description: "Use when specifying construction materials."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [construction, materials, specification, procurement]
    related_skills: [advanced-materials-design]
---

## Overview
Construction Material Specification implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Construction Material Specification implementation and optimization"
- "Best practices for Construction Material Specification workflows"
- "Construction Material Specification compliance and standards"
- "Construction Material Specification troubleshooting and problem-solving"
- "Construction Material Specification ROI and performance measurement"
