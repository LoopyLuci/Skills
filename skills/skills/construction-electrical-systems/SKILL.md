...
description: "Use when designing construction electrical."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [construction, electrical-systems, power, lighting]
    related_skills: [general]
---

## Overview
Construction Electrical Systems implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Construction Electrical Systems implementation and optimization"
- "Best practices for Construction Electrical Systems workflows"
- "Construction Electrical Systems compliance and standards"
- "Construction Electrical Systems troubleshooting and problem-solving"
- "Construction Electrical Systems ROI and performance measurement"
