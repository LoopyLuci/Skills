---
name: electric-vehicle-battery-recycling
description: "Use when recycling EV batteries."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [automotive, battery-recycling, circular-economy, ev]
    related_skills: [energy-storage-recycling]
---

## Overview
Electric Vehicle Battery Recycling implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Electric Vehicle Battery Recycling implementation and optimization"
- "Best practices for Electric Vehicle Battery Recycling workflows"
- "Electric Vehicle Battery Recycling compliance and standards"
- "Electric Vehicle Battery Recycling troubleshooting and problem-solving"
- "Electric Vehicle Battery Recycling ROI and performance measurement"
