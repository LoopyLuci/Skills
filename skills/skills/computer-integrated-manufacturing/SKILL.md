...
description: "Use when implementing CIM systems."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [manufacturing, cim, integrated-manufacturing, automation]
    related_skills: [general]
---

## Overview
Computer Integrated Manufacturing implementation. Comprehensive approach covering best practices, 
methodologies, technical considerations, and verification approaches.

## When to Use
- "Computer Integrated Manufacturing and optimization"
- "Best practices for Computer Integrated Manufacturing workflows"
- "Computer Integrated Manufacturing compliance and standards"
- "Computer Integrated Manufacturing troubleshooting and problem-solving"
- "Computer Integrated Manufacturing ROI and performance measurement"
