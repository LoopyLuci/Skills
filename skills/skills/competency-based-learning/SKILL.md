...
description: "Use when implementing competency-based learning."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [education, competency-based, curriculum]
    related_skills: [general]
---

## Overview
Implement competency-based learning programs with clear outcomes.

## When to Use
- "Competency Based Learning design and implementation"
- "Best practices for Competency Based Learning"
- "Competency Based Learning optimization"
- "Competency Based Learning troubleshooting"
