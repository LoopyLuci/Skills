...
description: "Use when managing construction risks."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [construction, risk-management, insurance, contingency]
    related_skills: [general]
---

## Overview
Construction Risk Management implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Construction Risk Management implementation and optimization"
- "Best practices for Construction Risk Management workflows"
- "Construction Risk Management compliance and standards"
- "Construction Risk Management troubleshooting and problem-solving"
- "Construction Risk Management ROI and performance measurement"
