...
description: "Use when designing experiments."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [qa, doe, experimental-design, testing]
    related_skills: [general]
---

## Overview
Apply designing experiments for effective results. 

## When to Use
- "Design Of Experiments design and implementation"
- "Best practices for Design Of Experiments"
- "Design Of Experiments optimization and scaling"
- "Design Of Experiments troubleshooting and validation"
