...
description: "Use when auditing energy efficiency. Walkthrough, analysis."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [climatetech, energy-audit, efficiency, buildings]
    related_skills: [building-energy-efficiency, smart-building-controls]
---

## Overview
Energy Efficiency Auditing implementation. Covers best practices, common methodologies, 
technical considerations, and verification approaches for this field.

## When to Use
- "Energy Efficiency Auditing implementation and optimization"
- "Best practices for Energy Efficiency Auditing workflows"
- "Energy Efficiency Auditing compliance and standards"
- "Energy Efficiency Auditing troubleshooting and problem-solving"
- "Energy Efficiency Auditing ROI and performance measurement"
