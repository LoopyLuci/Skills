---
name: container-security-fundamentals-deep-fundamentals
description: Use when applying container security fundamentals fundam.
version: 1.0.0
...
# Container Security Fundamentals Deep Fundamentals

"Use when applying container security fundamentals fundam."

## Trigger

Activate this skill when the user mentions:
- devops,  security workflows or issues
- Building, fixing, or optimizing container security fundamentals deep fundamentals
