---
name: database-postgresql-vacuum-implementation
description: Use when applying postgresql vacuum implementation.
version: 1.0.0
...
# Database Postgresql Vacuum Implementation

"Use when applying postgresql vacuum implementation."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  vacuum,  maintenance workflows or issues
- Building, fixing, or optimizing database postgresql vacuum implementation
