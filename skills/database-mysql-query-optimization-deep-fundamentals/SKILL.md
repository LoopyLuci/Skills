---
name: database-mysql-query-optimization-deep-fundamentals
description: "Use when applying mysql query optimization fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mysql Query Optimization Deep Fundamentals

"Use when applying mysql query optimization fundamentals."

## Trigger

Activate this skill when the user mentions:
- data,  mysql workflows or issues
- Building, fixing, or optimizing database mysql query optimization deep fundamentals
