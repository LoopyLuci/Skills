...
"Use when building health apps for consumers."

## Trigger

Activate this skill when the user mentions:
- consumer-tech,  health-apps,  fitness,  wellness workflows or issues
- Building, fixing, or optimizing consumer health app development
...
`consumer-tech, health-apps, fitness, wellness`
