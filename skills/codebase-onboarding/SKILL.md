...
"Use for codebase exploration. Map structure, deps, tests."

## Trigger

Activate this skill when the user mentions:
- programming,  onboarding,  codebase,  documentation,  architecture workflows or issues
- Building, fixing, or optimizing codebase onboarding
...
`programming, onboarding, codebase, documentation, architecture`
