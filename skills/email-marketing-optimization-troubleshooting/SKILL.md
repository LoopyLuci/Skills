---
name: email-marketing-optimization-troubleshooting
description: Use when applying email optimization troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, optimization, ab-testing]
---

# Email Marketing Optimization Troubleshooting

"Use when applying email optimization troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  ab-testing workflows or issues
- Building, fixing, or optimizing email marketing optimization troubleshooting
