...
description: "Use when applying azure devops implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure devops implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  devops,  pipelines workflows or issues
- Building, fixing, or optimizing azure devops implementation
