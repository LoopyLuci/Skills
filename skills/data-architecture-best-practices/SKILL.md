---
name: data-architecture-best-practices
description: "Use when applying data architecture best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying data architecture best practices."

## Trigger

Activate this skill when the user mentions:
- data,  architecture,  data-lake-architecture workflows or issues
- Building, fixing, or optimizing data architecture best practices
