---
name: email-marketing-preheaders-implementation
description: Use when applying email preheaders implementation.
version: 1.0.0
...
# Email Marketing Preheaders Implementation

"Use when applying email preheaders implementation."

## Trigger

Activate this skill when the user mentions:
- email,  copywriting,  preheaders workflows or issues
- Building, fixing, or optimizing email marketing preheaders implementation
