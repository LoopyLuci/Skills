...
"Use when optimizing hyperparameters for ML models."

## Trigger

Activate this skill when the user mentions:
- hyperparameter,  optimization,  tuning,  automl,  bayesian,  grid-search workflows or issues
- Building, fixing, or optimizing hyperparameter optimization ml
- Questions about hyperparameter best practices
...
`hyperparameter, optimization, tuning, automl, bayesian, grid-search`
