---
name: email-marketing-reporting-fundamentals
description: Use when applying email reporting fundamentals.
version: 1.0.0
...
# Email Marketing Reporting Fundamentals

"Use when applying email reporting fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  reporting,  kpis workflows or issues
- Building, fixing, or optimizing email marketing reporting fundamentals
