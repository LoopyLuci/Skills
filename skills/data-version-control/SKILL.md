...
description: "Use when versioning data and models."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [data-science, dvc, version-control, mlops]
    related_skills: ['advanced-version-control-git']
---

# Data Version Control

"Use when versioning data and models."

## Trigger

Activate this skill when the user mentions:
- data-science,  dvc,  version-control,  mlops workflows or issues
- Building, fixing, or optimizing data version control
...
`data-science, dvc, version-control, mlops`
