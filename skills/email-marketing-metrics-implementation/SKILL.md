---
name: email-marketing-metrics-implementation
description: Use when applying email metrics implementation.
version: 1.0.0
...
# Email Marketing Metrics Implementation

"Use when applying email metrics implementation."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  metrics workflows or issues
- Building, fixing, or optimizing email marketing metrics implementation
