...
"Use when designing automotive lighting."

## Trigger

Activate this skill when the user mentions:
- automotive,  lighting,  led,  signal workflows or issues
- Building, fixing, or optimizing automotive lighting design
...
`automotive, lighting, led, signal`
