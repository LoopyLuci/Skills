---
name: email-marketing-analytics-best-practices
description: "Use when applying email analytics best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email analytics best practices."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  data workflows or issues
- Building, fixing, or optimizing email marketing analytics best practices
