---
name: azure-traffic-manager-fundamentals
description: "Use when applying azure traffic manager fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure traffic manager fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  cdn,  traffic-routing workflows or issues
- Building, fixing, or optimizing azure traffic manager fundamentals
