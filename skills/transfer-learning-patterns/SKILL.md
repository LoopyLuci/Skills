...
"Use when applying transfer learning and domain adaptation."

## Trigger

Activate this skill when the user mentions:
- transfer-learning,  domain-adaptation,  fine-tuning,  pre-training workflows or issues
- Building, fixing, or optimizing transfer learning patterns
- Questions about transfer-learning best practices
