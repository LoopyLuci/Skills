---
name: email-marketing-win-back-implementation
description: Use when applying win-back email implementation.
version: 1.0.0
...
# Email Marketing Win Back Implementation

"Use when applying win-back email implementation."

## Trigger

Activate this skill when the user mentions:
- email,  retention,  win-back workflows or issues
- Building, fixing, or optimizing email marketing win back implementation
