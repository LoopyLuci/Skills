---
name: email-marketing-dynamic-content-fundamentals
description: Use when applying dynamic email content fundamentals.
version: 1.0.0
...
# Email Marketing Dynamic Content Fundamentals

"Use when applying dynamic email content fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  personalization,  dynamic-content workflows or issues
- Building, fixing, or optimizing email marketing dynamic content fundamentals
