...
description: "Use when applying business model implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying business model implementation."

## Trigger

Activate this skill when the user mentions:
- business,  startup,  startup-strategy workflows or issues
- Building, fixing, or optimizing business model implementation
