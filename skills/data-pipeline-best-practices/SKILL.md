...
description: Use when applying data pipeline best practices.
version: 1.0.0
...
"Use when applying data pipeline best practices."

## Trigger

Activate this skill when the user mentions:
- data,  pipelines,  data-pipeline-streaming workflows or issues
- Building, fixing, or optimizing data pipeline best practices
