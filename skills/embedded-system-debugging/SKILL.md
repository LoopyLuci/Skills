---
name: embedded-system-debugging
description: "Use when debugging embedded systems."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [electronics, debugging, embedded, jtag]
    related_skills: [general]
---

## Overview
Debug embedded systems using JTAG, trace, and software tools.

## When to Use
- "Embedded System Debugging design and implementation"
- "Best practices for Embedded System Debugging"
- "Embedded System Debugging optimization and scaling"
- "Embedded System Debugging troubleshooting and validation"
