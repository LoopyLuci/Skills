---
name: email-marketing-performance-best-practices
description: Use when applying email performance best practices.
version: 1.0.0
...
# Email Marketing Performance Best Practices

"Use when applying email performance best practices."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  performance workflows or issues
- Building, fixing, or optimizing email marketing performance best practices
