...
"Use when implementing multi-agent ensemble voting systems."

## Trigger

Activate this skill when the user mentions:
- agents,  ensemble,  voting,  consensus,  multi-agent,  debate workflows or issues
- Building, fixing, or optimizing agent ensembles voting
...
`agents, ensemble, voting, consensus, multi-agent, debate`
