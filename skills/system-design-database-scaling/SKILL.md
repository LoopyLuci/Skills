...
"Use when designing database scaling."

## Trigger

Activate this skill when the user mentions:
- "system-design",  "database",  "sharding",  "replication" workflows or issues
- Building, fixing, or optimizing system design database scaling
