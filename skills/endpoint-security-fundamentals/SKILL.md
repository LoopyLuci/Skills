---
name: endpoint-security-fundamentals
description: Use when for endpoint security fundamentals.
version: 1.0.0
...
"Use when for endpoint security fundamentals."

## Trigger

Activate this skill when the user mentions:
- security,  endpoint,  edr,  antivirus workflows or issues
- Building, fixing, or optimizing endpoint security fundamentals
