---
name: aws-security-troubleshooting
description: Use when troubleshooting AWS security.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, aws-security-troubleshooting]
---

# Aws Security Troubleshooting

"Use when troubleshooting AWS security."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-security-troubleshooting workflows or issues
- Building, fixing, or optimizing aws security troubleshooting
...
`cloud, aws, aws-security-troubleshooting`
