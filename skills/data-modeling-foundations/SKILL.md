...
"Use when designing data models and entity relationships."

## Trigger

Activate this skill when the user mentions:
- data-modeling,  ERD,  normalization,  denormalization,  entities,  relationships workflows or issues
- Building, fixing, or optimizing data modeling foundations
- Questions about data-modeling best practices
...
`data-modeling, ERD, normalization, denormalization, entities, relationships`
