...
description: Use when protecting AWS data.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, data-protection-best-practices]
---

# Aws Data Protection

"Use when protecting AWS data."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  data-protection-best-practices workflows or issues
- Building, fixing, or optimizing aws data protection
...
`cloud, aws, data-protection-best-practices`
