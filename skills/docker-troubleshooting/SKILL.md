...
description: "Use when applying docker troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying docker troubleshooting."

## Trigger

Activate this skill when the user mentions:
- devops,  docker,  containers,  images workflows or issues
- Building, fixing, or optimizing docker troubleshooting
...
`devops, docker, containers, images`
