---
name: data-engineering-pipelines-fundamentals-best-practices
description: Use when applying data engineering fundamentals best pra.
version: 1.0.0
...
# Data Engineering Pipelines Fundamentals Best Practices

"Use when applying data engineering fundamentals best pra."

## Trigger

Activate this skill when the user mentions:
- data,  data-eng-fundamentals workflows or issues
- Building, fixing, or optimizing data engineering pipelines fundamentals best practices
