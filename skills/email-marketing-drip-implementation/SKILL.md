---
name: email-marketing-drip-implementation
description: Use when applying email drip campaigns implementation.
version: 1.0.0
...
# Email Marketing Drip Implementation

"Use when applying email drip campaigns implementation."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  drip-campaigns workflows or issues
- Building, fixing, or optimizing email marketing drip implementation
