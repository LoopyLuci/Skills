---
name: email-markering-troubleshooting
description: Use when applying email marketing troubleshooting.
version: 1.0.0
...
# Email Markering Troubleshooting

"Use when applying email marketing troubleshooting."

## Trigger

Activate this skill when the user mentions:
- marketing,  email,  email-marketing-campaigns workflows or issues
- Building, fixing, or optimizing email markering troubleshooting
