---
name: email-marketing-automation-workflows-implementation
description: "Use when applying email workflows implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Automation Workflows Implementation

"Use when applying email workflows implementation."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  workflows workflows or issues
- Building, fixing, or optimizing email marketing automation workflows implementation
