...
"Use when deploying edge applications."

## Trigger

Activate this skill when the user mentions:
- edge-computing,  deployment,  containers,  kubernetes workflows or issues
- Building, fixing, or optimizing edge application deployment
...
`edge-computing, deployment, containers, kubernetes`
