---
name: email-marketing-platforms-troubleshooting
description: Use when applying email platforms troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, platform, saas]
---

# Email Marketing Platforms Troubleshooting

"Use when applying email platforms troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  platform,  saas workflows or issues
- Building, fixing, or optimizing email marketing platforms troubleshooting
