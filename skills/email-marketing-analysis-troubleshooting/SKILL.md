---
name: email-marketing-analysis-troubleshooting
description: "Use when applying email marketing analysis troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [email, marketing, email-marketing-analysis]
    related_skills: [general]
---

# Email Marketing Analysis Troubleshooting

"Use when applying email marketing analysis troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-analysis workflows or issues
- Building, fixing, or optimizing email marketing analysis troubleshooting
...
`email, marketing, email-marketing-analysis`
