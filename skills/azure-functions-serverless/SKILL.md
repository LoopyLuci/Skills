...
"Use when building Azure Functions."

## Trigger

Activate this skill when the user mentions:
- "azure",  "functions",  "serverless",  "triggers",  "bindings" workflows or issues
- Building, fixing, or optimizing azure functions serverless
