---
name: database-architecture-best-practices
description: "Use when for database architecture best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database architecture best practices."

## Trigger

Activate this skill when the user mentions:
- database,  architecture,  design,  scaling workflows or issues
- Building, fixing, or optimizing database architecture best practices
...
`database, architecture, design, scaling`
