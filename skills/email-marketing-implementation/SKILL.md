---
name: email-marketing-implementation
description: Use when for email marketing implementation.
version: 1.0.0
...
"Use when for email marketing implementation."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing email marketing implementation
