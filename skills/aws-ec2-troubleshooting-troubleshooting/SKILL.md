---
name: aws-ec2-troubleshooting-troubleshooting
description: "Use when applying aws ec2 troubleshooting troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cloud, ec2]
    related_skills: ['aws-ec2-troubleshooting']
---

# Aws Ec2 Troubleshooting Troubleshooting

"Use when applying aws ec2 troubleshooting troubleshooting."

## Trigger

Activate this skill when the user mentions:
- cloud,  ec2 workflows or issues
- Building, fixing, or optimizing aws ec2 troubleshooting troubleshooting
