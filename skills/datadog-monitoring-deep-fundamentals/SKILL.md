---
name: datadog-monitoring-deep-fundamentals
description: Use when applying datadog monitoring fundamentals.
version: 1.0.0
...
# Datadog Monitoring Deep Fundamentals

"Use when applying datadog monitoring fundamentals."

## Trigger

Activate this skill when the user mentions:
- sys,  monitoring workflows or issues
- Building, fixing, or optimizing datadog monitoring deep fundamentals
