...
description: "Use when applying azure key vault fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure key vault fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  key-vault,  security workflows or issues
- Building, fixing, or optimizing azure key vault fundamentals
