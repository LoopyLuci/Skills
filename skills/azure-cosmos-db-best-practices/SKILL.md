...
description: Use when applying azure cosmos db best practices.
version: 1.0.0
...
"Use when applying azure cosmos db best practices."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  cosmos-db,  nosql workflows or issues
- Building, fixing, or optimizing azure cosmos db best practices
