---
name: data-augmentation-techniques-deep-fundamentals
description: Use when applying data augmentation fundamentals.
version: 1.0.0
...
# Data Augmentation Techniques Deep Fundamentals

"Use when applying data augmentation fundamentals."

## Trigger

Activate this skill when the user mentions:
- ml,  ml-data-aug workflows or issues
- Building, fixing, or optimizing data augmentation techniques deep fundamentals
