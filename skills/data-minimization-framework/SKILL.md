...
"Use when handling data. Collect only what's needed."

## Trigger

Activate this skill when the user mentions:
- privacy,  data-minimization,  gdpr-compliance,  pii,  data-governance workflows or issues
- Building, fixing, or optimizing data minimization framework
...
`privacy, data-minimization, gdpr-compliance, pii, data-governance`
