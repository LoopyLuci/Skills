...
"Use when designing container and Kubernetes networking."

## Trigger

Activate this skill when the user mentions:
- container-networking,  kubernetes,  docker,  CNI,  service-mesh,  overlay workflows or issues
- Building, fixing, or optimizing container networking patterns
- Questions about container-networking best practices
...
`container-networking, kubernetes, docker, CNI, service-mesh, overlay`
