---
name: big-data-best-practices
description: Use when applying big data best practices.
version: 1.0.0
...
- data,  bigdata,  big-data-pipeline workflows or issues
- Building, fixing, or optimizing big data best practices
...
`data, bigdata, big-data-pipeline`
