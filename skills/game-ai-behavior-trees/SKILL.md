...
Behavior trees, utility AI, GOAP, finite state machines for NPCs, and procedural generation

## Trigger

Activate this skill when the user mentions:
- "game-ai",  "npc" workflows or issues
- Building, fixing, or optimizing game ai behavior trees
- Questions about "game-ai" best practices
