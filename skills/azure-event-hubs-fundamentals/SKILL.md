---
name: azure-event-hubs-fundamentals
description: Use when applying azure event hubs fundamentals.
version: 1.0.0
...
"Use when applying azure event hubs fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  event-hubs,  streaming workflows or issues
- Building, fixing, or optimizing azure event hubs fundamentals
