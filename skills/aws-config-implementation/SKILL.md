---
name: aws-config-implementation
description: "Use when applying aws config implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws config implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  config,  compliance,  auditing workflows or issues
- Building, fixing, or optimizing aws config implementation
