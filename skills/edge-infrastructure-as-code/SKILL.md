...
"Use when provisioning edge infrastructure."

## Trigger

Activate this skill when the user mentions:
- edge-computing,  iac,  terraform,  edge-deployment workflows or issues
- Building, fixing, or optimizing edge infrastructure as code
...
`edge-computing, iac, terraform, edge-deployment`
