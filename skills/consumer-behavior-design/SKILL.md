---
name: consumer-behavior-design
description: "Use when for consumer behavior design."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for consumer behavior design."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing consumer behavior design
