...
Google Ads, Meta Ads, programmatic, bidding strategies, and ROAS optimization

## Trigger

Activate this skill when the user mentions:
- "ppc",  "paid" workflows or issues
- Building, fixing, or optimizing ppc paid advertising
