---
name: docker-registry-implementation
description: Use when applying docker registry implementation.
version: 1.0.0
...
"Use when applying docker registry implementation."

## Trigger

Activate this skill when the user mentions:
- docker,  registry,  docker-registry-operations workflows or issues
- Building, fixing, or optimizing docker registry implementation
