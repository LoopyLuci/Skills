---
name: fatca-compliance-troubleshooting
description: Use when applying fatca troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [finance, tax, fatca]
---

# Fatca Compliance Troubleshooting

"Use when applying fatca troubleshooting."

## Trigger

Activate this skill when the user mentions:
- finance,  tax,  fatca workflows or issues
- Building, fixing, or optimizing fatca compliance troubleshooting
