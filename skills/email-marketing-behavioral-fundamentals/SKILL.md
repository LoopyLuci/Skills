---
name: email-marketing-behavioral-fundamentals
description: Use when applying behavioral emails fundamentals.
version: 1.0.0
...
# Email Marketing Behavioral Fundamentals

"Use when applying behavioral emails fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  automation,  behavioral workflows or issues
- Building, fixing, or optimizing email marketing behavioral fundamentals
