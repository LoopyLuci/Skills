...
"Use when implementing TS decorators."

## Trigger

Activate this skill when the user mentions:
- "typescript",  "decorators",  "metadata",  "reflection" workflows or issues
- Building, fixing, or optimizing typescript decorators metadata
