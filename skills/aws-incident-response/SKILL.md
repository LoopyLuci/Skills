...
"Use when responding AWS incidents."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  incident-response-best-practices workflows or issues
- Building, fixing, or optimizing aws incident response
...
`cloud, aws, incident-response-best-practices`
