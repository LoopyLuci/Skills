---
name: email-marketing-migration-best-practices
description: "Use when applying email migration best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Migration Best Practices

"Use when applying email migration best practices."

## Trigger

Activate this skill when the user mentions:
- email,  migration,  platform workflows or issues
- Building, fixing, or optimizing email marketing migration best practices
