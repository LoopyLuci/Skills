---
name: crypto-crypto-wallet-dev-troubleshooting
description: "Use when applying wallet development troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Crypto Crypto Wallet Dev Troubleshooting

"Use when applying wallet development troubleshooting."

## Trigger

Activate this skill when the user mentions:
- crypto,  wallet,  blockchain-development-solidity workflows or issues
- Building, fixing, or optimizing crypto crypto wallet dev troubleshooting
...
`crypto, wallet, blockchain-development-solidity`
