---
name: aws-config-best-practices
description: "Use when applying aws config best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws config best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  config,  compliance,  auditing workflows or issues
- Building, fixing, or optimizing aws config best practices
