---
name: database-mongodb-performance-troubleshooting
description: Use when applying mongodb performance troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [database, mongodb, performance, optimization]
---

# Database Mongodb Performance Troubleshooting

"Use when applying mongodb performance troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  performance,  optimization workflows or issues
- Building, fixing, or optimizing database mongodb performance troubleshooting
...
`database, mongodb, performance, optimization`
