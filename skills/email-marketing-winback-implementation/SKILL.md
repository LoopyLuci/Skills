---
name: email-marketing-winback-implementation
description: Use when applying email win-back implementation.
version: 1.0.0
...
# Email Marketing Winback Implementation

"Use when applying email win-back implementation."

## Trigger

Activate this skill when the user mentions:
- email,  retention,  win-back workflows or issues
- Building, fixing, or optimizing email marketing winback implementation
