---
name: database-postgresql-vacuum-best-practices
description: Use when applying postgresql vacuum best practices.
version: 1.0.0
...
# Database Postgresql Vacuum Best Practices

"Use when applying postgresql vacuum best practices."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  vacuum,  maintenance workflows or issues
- Building, fixing, or optimizing database postgresql vacuum best practices
