---
name: database-redis-best-practices
description: Use when applying redis best practices.
version: 1.0.0
...
# Database Redis Best Practices

"Use when applying redis best practices."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  caching,  in-memory workflows or issues
- Building, fixing, or optimizing database redis best practices
