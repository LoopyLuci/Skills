...
description: "Use when applying aws step functions troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying aws step functions troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  step-functions,  sfn,  workflow workflows or issues
- Building, fixing, or optimizing aws step functions troubleshooting
