...
"Use when auditing AWS security."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  security-audit-standards workflows or issues
- Building, fixing, or optimizing aws security audit
...
`cloud, aws, security-audit-standards`
