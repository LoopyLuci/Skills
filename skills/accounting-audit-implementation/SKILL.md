---
name: accounting-audit-implementation
description: Use when applying accounting audit implementation.
version: 1.0.0
...
- accounting,  finance,  audit,  accounting-audit workflows or issues
- Building, fixing, or optimizing accounting audit implementation
...
`accounting, finance, audit, accounting-audit`
