---
name: data-warehouse-troubleshooting
description: Use when applying data warehouse troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [data, warehouse, data-warehousing-fundamentals]
---

# Data Warehouse Troubleshooting

"Use when applying data warehouse troubleshooting."

## Trigger

Activate this skill when the user mentions:
- data,  warehouse,  data-warehousing-fundamentals workflows or issues
- Building, fixing, or optimizing data warehouse troubleshooting
...
`data, warehouse, data-warehousing-fundamentals`
