---
name: crypto-zero-knowledge-implementation
description: Use when applying zero-knowledge proofs implementation.
version: 1.0.0
...
# Crypto Zero Knowledge Implementation

"Use when applying zero-knowledge proofs implementation."

## Trigger

Activate this skill when the user mentions:
- crypto,  zkp,  zero-knowledge-proofs workflows or issues
- Building, fixing, or optimizing crypto zero knowledge implementation
