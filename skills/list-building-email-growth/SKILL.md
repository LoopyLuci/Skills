...
"Use when growing email lists and lead generation strategies."

## Trigger

Activate this skill when the user mentions:
- email-list,  lead-generation,  opt-in,  list-building,  subscribers,  growth workflows or issues
- Building, fixing, or optimizing list building email growth
- Questions about email-list best practices
...
`email-list, lead-generation, opt-in, list-building, subscribers, growth`
