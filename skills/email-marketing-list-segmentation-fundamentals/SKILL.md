---
name: email-marketing-list-segmentation-fundamentals
description: "Use when applying email list segmentation fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing List Segmentation Fundamentals

"Use when applying email list segmentation fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  segmentation,  targeting workflows or issues
- Building, fixing, or optimizing email marketing list segmentation fundamentals
