---
name: datadog-monitoring-setup-deep-fundamentals
description: "Use when applying datadog monitoring setup fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Datadog Monitoring Setup Deep Fundamentals

"Use when applying datadog monitoring setup fundamentals."

## Trigger

Activate this skill when the user mentions:
- sys,  monitoring workflows or issues
- Building, fixing, or optimizing datadog monitoring setup deep fundamentals
