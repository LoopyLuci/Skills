---
name: container-security-hardening-deep-troubleshooting
description: Use when applying container hardening troubleshooting.
version: 1.0.0
...
# Container Security Hardening Deep Troubleshooting

"Use when applying container hardening troubleshooting."

## Trigger

Activate this skill when the user mentions:
- devops,  security workflows or issues
- Building, fixing, or optimizing container security hardening deep troubleshooting
