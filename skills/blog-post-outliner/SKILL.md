...
"Use when outlining blog posts. Headlines and structure."

## Trigger

Activate this skill when the user mentions:
- blog,  writing,  outlining,  structure,  content workflows or issues
- Building, fixing, or optimizing blog post outliner
...
`blog, writing, outlining, structure, content`
