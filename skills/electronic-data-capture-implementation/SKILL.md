...
description: "Use when applying edc implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying edc implementation."

## Trigger

Activate this skill when the user mentions:
- biotech,  medicine,  edc workflows or issues
- Building, fixing, or optimizing electronic data capture implementation
