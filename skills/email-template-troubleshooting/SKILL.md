---
name: email-template-troubleshooting
description: Use when applying email templates troubleshooting.
version: 1.0.0
...
"Use when applying email templates troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  templates workflows or issues
- Building, fixing, or optimizing email template troubleshooting
