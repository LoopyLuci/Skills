...
"Use when implementing neural architecture search for models."

## Trigger

Activate this skill when the user mentions:
- nas,  architecture-search,  automl,  neural-networks,  pytorch workflows or issues
- Building, fixing, or optimizing neural architecture search
- Questions about nas best practices
...
`nas, architecture-search, automl, neural-networks, pytorch`
