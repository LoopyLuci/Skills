...
"Closing checklists per state. Docs, disclaimers, compliance."

## Trigger

Activate this skill when the user mentions:
- real-estate,  transactions,  closing,  compliance,  documentation workflows or issues
- Building, fixing, or optimizing real estate transaction coordination
...
`real-estate, transactions, closing, compliance, documentation`
