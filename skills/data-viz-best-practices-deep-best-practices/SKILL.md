---
name: data-viz-best-practices-deep-best-practices
description: Use when applying data visualization best practices best.
version: 1.0.0
...
# Data Viz Best Practices Deep Best Practices

"Use when applying data visualization best practices best."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing data viz best practices deep best practices
