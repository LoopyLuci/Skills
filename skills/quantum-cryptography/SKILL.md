...
BB84, E91, QKD protocols, post-quantum crypto, and quantum random number generation

## Trigger

Activate this skill when the user mentions:
- "crypto",  "qkd" workflows or issues
- Building, fixing, or optimizing quantum cryptography
