---
name: email-marketing-list-segmentation-implementation
description: Use when applying email list segmentation implementation.
version: 1.0.0
...
# Email Marketing List Segmentation Implementation

"Use when applying email list segmentation implementation."

## Trigger

Activate this skill when the user mentions:
- email,  segmentation,  targeting workflows or issues
- Building, fixing, or optimizing email marketing list segmentation implementation
