---
name: email-marketing-frequency-implementation
description: "Use when applying email frequency implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Frequency Implementation

"Use when applying email frequency implementation."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  frequency workflows or issues
- Building, fixing, or optimizing email marketing frequency implementation
