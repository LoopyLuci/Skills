...
"Use when building financial models. Python, DCF, valuation."

## Trigger

Activate this skill when the user mentions:
- finance,  financial-modeling,  python,  valuation,  dcf workflows or issues
- Building, fixing, or optimizing financial modeling python
...
`finance, financial-modeling, python, valuation, dcf`
