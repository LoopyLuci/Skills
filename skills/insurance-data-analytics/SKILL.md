...
Predictive modeling, telematics, IoT, and advanced analytics in insurance

## Trigger

Activate this skill when the user mentions:
- "analytics",  "insurtech" workflows or issues
- Building, fixing, or optimizing insurance data analytics
