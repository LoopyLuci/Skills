---
name: email-marketing-campaigns-best-practices
description: Use when applying email marketing campaigns best practices.
version: 1.0.0
...
"Use when applying email marketing campaigns best practices."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-campaigns workflows or issues
- Building, fixing, or optimizing email marketing campaigns best practices
