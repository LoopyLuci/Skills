...
"Use when building actuarial models."

## Trigger

Activate this skill when the user mentions:
- finance,  actuarial,  risk-modeling workflows or issues
- Building, fixing, or optimizing actuarial science models
...
`finance, actuarial, risk-modeling`
