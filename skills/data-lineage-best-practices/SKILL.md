...
"Use when for data lineage best practices."

## Trigger

Activate this skill when the user mentions:
- data-governance,  lineage,  etl workflows or issues
- Building, fixing, or optimizing data lineage best practices
