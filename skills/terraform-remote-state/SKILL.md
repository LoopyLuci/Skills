...
description: Use when managing Terraform state.
version: 1.0.0
...
metadata:
  hermes:
    tags: [terraform, state, remote, backend, locking]
---

# Terraform Remote State

"Use when managing Terraform state."

## Trigger

Activate this skill when the user mentions:
- "terraform",  "state",  "remote",  "backend",  "locking" workflows or issues
- Building, fixing, or optimizing terraform remote state
