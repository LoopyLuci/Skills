---
name: database-monitoring-troubleshooting
description: "Use when for database monitoring troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for database monitoring troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  monitoring,  observability,  performance workflows or issues
- Building, fixing, or optimizing database monitoring troubleshooting
