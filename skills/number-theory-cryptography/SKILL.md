...
Prime numbers, modular arithmetic, and cryptographic applications

## Trigger

Activate this skill when the user mentions:
- "number-theory",  "crypto" workflows or issues
- Building, fixing, or optimizing number theory cryptography
- Questions about "number-theory" best practices
