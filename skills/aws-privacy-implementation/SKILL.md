---
name: aws-privacy-implementation
description: "Use when applying aws privacy implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Privacy Implementation

"Use when applying aws privacy implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  privacy,  data-protection,  gdpr workflows or issues
- Building, fixing, or optimizing aws privacy implementation
...
`aws, privacy, data-protection, gdpr`
