---
name: email-marketing-segments-troubleshooting
description: "Use when applying email segments troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Segments Troubleshooting

"Use when applying email segments troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  segmentation,  targeting workflows or issues
- Building, fixing, or optimizing email marketing segments troubleshooting
