...
"Use when implementing DNS servers, resolvers, and tools."

## Trigger

Activate this skill when the user mentions:
- dns,  nameserver,  resolver,  DNSSEC,  zone,  record,  authoritative,  recursive workflows or issues
- Building, fixing, or optimizing dns implementation patterns
...
`dns, nameserver, resolver, DNSSEC, zone, record, authoritative, recursive`
