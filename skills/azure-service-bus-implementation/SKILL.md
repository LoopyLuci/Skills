...
description: "Use when applying azure service bus implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure service bus implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  service-bus,  mq workflows or issues
- Building, fixing, or optimizing azure service bus implementation
