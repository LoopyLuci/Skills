---
name: docker-performance-fundamentals
description: "Use when applying docker performance fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying docker performance fundamentals."

## Trigger

Activate this skill when the user mentions:
- docker,  performance,  optimization workflows or issues
- Building, fixing, or optimizing docker performance fundamentals
