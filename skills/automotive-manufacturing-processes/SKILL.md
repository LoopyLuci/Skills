---
name: automotive-manufacturing-processes
description: "Use when managing auto manufacturing."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [automotive, manufacturing, assembly-line, production]
    related_skills: [lean-manufacturing-systems]
---

## Overview
Automotive Manufacturing Processes implementation. Covers best practices, methodologies, 
technical considerations, and verification approaches for this domain.

## When to Use
- "Automotive Manufacturing Processes implementation and optimization"
- "Best practices for Automotive Manufacturing Processes workflows"
- "Automotive Manufacturing Processes compliance and standards"
- "Automotive Manufacturing Processes troubleshooting and problem-solving"
- "Automotive Manufacturing Processes ROI and performance measurement"
