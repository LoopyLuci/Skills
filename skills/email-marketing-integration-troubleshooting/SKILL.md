---
name: email-marketing-integration-troubleshooting
description: Use when applying email integration troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, integration, api]
---

# Email Marketing Integration Troubleshooting

"Use when applying email integration troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  integration,  api workflows or issues
- Building, fixing, or optimizing email marketing integration troubleshooting
