---
name: endpoint-security-best-practices-deep-fundamentals
description: Use when applying endpoint security fundamentals.
version: 1.0.0
...
# Endpoint Security Best Practices Deep Fundamentals

"Use when applying endpoint security fundamentals."

## Trigger

Activate this skill when the user mentions:
- devops,  security workflows or issues
- Building, fixing, or optimizing endpoint security best practices deep fundamentals
