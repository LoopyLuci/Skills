---
name: email-marketing-campaign-strategy-troubleshooting
description: Use when applying email campaign strategy troubleshooting.
version: 1.0.0
...
# Email Marketing Campaign Strategy Troubleshooting

"Use when applying email campaign strategy troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  strategy,  campaigns workflows or issues
- Building, fixing, or optimizing email marketing campaign strategy troubleshooting
