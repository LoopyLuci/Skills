...
description: "Use when applying docker compose troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying docker compose troubleshooting."

## Trigger

Activate this skill when the user mentions:
- docker,  compose,  docker-compose-patterns workflows or issues
- Building, fixing, or optimizing docker compose troubleshooting
