---
name: email-marketing-survival-guide-implementation
description: "Use when applying email survival guide implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Survival Guide Implementation

"Use when applying email survival guide implementation."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  spam-filter workflows or issues
- Building, fixing, or optimizing email marketing survival guide implementation
