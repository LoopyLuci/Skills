---
name: email-marketing-inbox-fundamentals
description: Use when applying email inbox placement fundamentals.
version: 1.0.0
...
# Email Marketing Inbox Fundamentals

"Use when applying email inbox placement fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  inbox workflows or issues
- Building, fixing, or optimizing email marketing inbox fundamentals
