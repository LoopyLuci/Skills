---
name: audit-logging-troubleshooting
description: Use when for audit logging troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [security, audit-logging, compliance, logging]
---

# Audit Logging Troubleshooting

"Use when for audit logging troubleshooting."

## Trigger

Activate this skill when the user mentions:
- security,  audit-logging,  compliance,  logging workflows or issues
- Building, fixing, or optimizing audit logging troubleshooting
