...
description: Use when applying aws disaster recovery best practices.
version: 1.0.0
...
"Use when applying aws disaster recovery best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  disaster-recovery,  dr,  backup workflows or issues
- Building, fixing, or optimizing aws disaster recovery best practices
