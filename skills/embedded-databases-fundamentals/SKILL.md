---
name: embedded-databases-fundamentals
description: "Use when applying embedded databases fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Embedded Databases Fundamentals

"Use when applying embedded databases fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  embedded,  sqlite,  leveldb workflows or issues
- Building, fixing, or optimizing embedded databases fundamentals
