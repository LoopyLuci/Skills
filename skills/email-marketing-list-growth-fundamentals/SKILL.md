---
name: email-marketing-list-growth-fundamentals
description: "Use when applying email list growth fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing List Growth Fundamentals

"Use when applying email list growth fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  growth,  list-building-email-growth workflows or issues
- Building, fixing, or optimizing email marketing list growth fundamentals
