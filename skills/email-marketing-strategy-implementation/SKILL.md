---
name: email-marketing-strategy-implementation
description: "Use when applying email marketing strategy implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying email marketing strategy implementation."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-strategy workflows or issues
- Building, fixing, or optimizing email marketing strategy implementation
