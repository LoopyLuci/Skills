...
"Use when securing cloud infrastructure."

## Trigger

Activate this skill when the user mentions:
- cybersecurity,  cloud-security,  cspm,  misconfiguration workflows or issues
- Building, fixing, or optimizing cloud security posture
...
`cybersecurity, cloud-security, cspm, misconfiguration`
