---
name: email-marketing-campaign-strategy-fundamentals
description: "Use when applying email campaign strategy fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Campaign Strategy Fundamentals

"Use when applying email campaign strategy fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  strategy,  campaigns workflows or issues
- Building, fixing, or optimizing email marketing campaign strategy fundamentals
