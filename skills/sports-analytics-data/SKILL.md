...
Performance metrics, tracking data, visualization, and predictive modeling

## Trigger

Activate this skill when the user mentions:
- "analytics",  "data" workflows or issues
- Building, fixing, or optimizing sports analytics data
