---
name: database-postgresql-json-best-practices
description: Use when applying postgresql json best practices.
version: 1.0.0
...
# Database Postgresql Json Best Practices

"Use when applying postgresql json best practices."

## Trigger

Activate this skill when the user mentions:
- database,  postgresql,  json,  document workflows or issues
- Building, fixing, or optimizing database postgresql json best practices
