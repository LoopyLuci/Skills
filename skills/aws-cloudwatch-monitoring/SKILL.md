...
description: "Use when monitoring AWS."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [cloud, aws, aws-cloudwatch]
    related_skills: [general]
---

# Aws Cloudwatch Monitoring

"Use when monitoring AWS."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  aws-cloudwatch workflows or issues
- Building, fixing, or optimizing aws cloudwatch monitoring
