...
"Use when implementing retail technology."

## Trigger

Activate this skill when the user mentions:
- fashion,  retail-tech,  pos,  inventory workflows or issues
- Building, fixing, or optimizing fashion retail tech
...
`fashion, retail-tech, pos, inventory`
