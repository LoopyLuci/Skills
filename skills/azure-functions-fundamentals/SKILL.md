...
description: "Use when applying azure functions fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying azure functions fundamentals."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  functions,  lambda workflows or issues
- Building, fixing, or optimizing azure functions fundamentals
