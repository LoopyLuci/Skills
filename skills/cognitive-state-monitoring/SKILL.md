...
"Use when monitoring cognitive states. EEG, fNIRS."

## Trigger

Activate this skill when the user mentions:
- neurotech,  cognitive-monitoring,  eeg,  fnirs,  ml workflows or issues
- Building, fixing, or optimizing cognitive state monitoring
...
`neurotech, cognitive-monitoring, eeg, fnirs, ml`
