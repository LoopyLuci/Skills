---
name: data-viz-troubleshooting-deep-implementation
description: "Use when applying data viz troubleshooting implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Data Viz Troubleshooting Deep Implementation

"Use when applying data viz troubleshooting implementation."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing data viz troubleshooting deep implementation
