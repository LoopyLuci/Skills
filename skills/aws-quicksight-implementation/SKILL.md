---
name: aws-quicksight-implementation
description: Use when applying aws quicksight implementation.
version: 1.0.0
...
"Use when applying aws quicksight implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  quicksight,  bi,  dashboards workflows or issues
- Building, fixing, or optimizing aws quicksight implementation
