...
description: Use when applying aws step functions implementation.
version: 1.0.0
...
"Use when applying aws step functions implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  step-functions,  sfn,  workflow workflows or issues
- Building, fixing, or optimizing aws step functions implementation
