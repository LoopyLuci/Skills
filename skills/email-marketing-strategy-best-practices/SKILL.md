---
name: email-marketing-strategy-best-practices
description: Use when applying email marketing strategy best practices.
version: 1.0.0
...
"Use when applying email marketing strategy best practices."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-strategy workflows or issues
- Building, fixing, or optimizing email marketing strategy best practices
