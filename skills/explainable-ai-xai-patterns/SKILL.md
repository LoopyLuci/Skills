...
"Use when implementing explainable AI techniques and tools."

## Trigger

Activate this skill when the user mentions:
- explainability,  XAI,  interpretability,  SHAP,  LIME,  attention workflows or issues
- Building, fixing, or optimizing explainable ai xai patterns
- Questions about explainability best practices
...
`explainability, XAI, interpretability, SHAP, LIME, attention`
