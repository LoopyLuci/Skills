---
name: email-marketing-list-cleaning-troubleshooting
description: Use when applying email list cleaning troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, hygiene, list-cleaning]
---

# Email Marketing List Cleaning Troubleshooting

"Use when applying email list cleaning troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  hygiene,  list-cleaning workflows or issues
- Building, fixing, or optimizing email marketing list cleaning troubleshooting
