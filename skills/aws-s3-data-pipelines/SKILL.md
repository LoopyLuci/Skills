...
"Use when building data pipelines with S3."

## Trigger

Activate this skill when the user mentions:
- "aws",  "s3",  "data-lake",  "events",  "triggers" workflows or issues
- Building, fixing, or optimizing aws s3 data pipelines
...
`"aws", "s3", "data-lake", "events", "triggers"`
