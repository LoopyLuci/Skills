...
description: Use when managing container lifecycle.
version: 1.0.0
...
metadata:
  hermes:
    tags: [devops, containers, container-lifecycle-management]
---

# Container Lifecycle

"Use when managing container lifecycle."

## Trigger

Activate this skill when the user mentions:
- devops,  containers,  container-lifecycle-management workflows or issues
- Building, fixing, or optimizing container lifecycle
...
`devops, containers, container-lifecycle-management`
