---
name: aws-inspector-implementation
description: Use when applying aws inspector implementation.
version: 1.0.0
...
# Aws Inspector Implementation

"Use when applying aws inspector implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  inspector,  security,  vulnerability workflows or issues
- Building, fixing, or optimizing aws inspector implementation
