---
name: database-redis-pubsub-implementation
description: "Use when applying redis pub/sub implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Redis Pubsub Implementation

"Use when applying redis pub/sub implementation."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  pub-sub,  messaging workflows or issues
- Building, fixing, or optimizing database redis pubsub implementation
