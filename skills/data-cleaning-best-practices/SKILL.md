...
description: "Use when applying data cleaning best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying data cleaning best practices."

## Trigger

Activate this skill when the user mentions:
- data,  cleaning,  data-cleaning-techniques workflows or issues
- Building, fixing, or optimizing data cleaning best practices
