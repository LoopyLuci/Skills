---
name: database-mongodb-best-practices
description: "Use when applying mongodb best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying mongodb best practices."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  nosql,  document workflows or issues
- Building, fixing, or optimizing database mongodb best practices
