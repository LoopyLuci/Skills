---
name: database-mysql-troubleshooting
description: Use when applying mysql troubleshooting.
version: 1.0.0
...
"Use when applying mysql troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  mysql,  sql,  mariadb workflows or issues
- Building, fixing, or optimizing database mysql troubleshooting
