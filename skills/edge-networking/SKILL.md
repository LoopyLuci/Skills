...
"Use when designing edge networks."

## Trigger

Activate this skill when the user mentions:
- edge-computing,  edge-networking,  sdwan,  mesh workflows or issues
- Building, fixing, or optimizing edge networking
...
`edge-computing, edge-networking, sdwan, mesh`
