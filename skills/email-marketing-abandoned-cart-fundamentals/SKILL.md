---
name: email-marketing-abandoned-cart-fundamentals
description: "Use when applying email abandoned cart fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Abandoned Cart Fundamentals

"Use when applying email abandoned cart fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  ecommerce,  cart-abandonment workflows or issues
- Building, fixing, or optimizing email marketing abandoned cart fundamentals
