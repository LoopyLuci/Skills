---
name: azure-database-implementation
description: Use when applying azure database implementation.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, azure, sql-database, cosmos-db]
---

# Azure Database Implementation

"Use when applying azure database implementation."

## Trigger

Activate this skill when the user mentions:
- cloud,  azure,  sql-database,  cosmos-db workflows or issues
- Building, fixing, or optimizing azure database implementation
...
`cloud, azure, sql-database, cosmos-db`
