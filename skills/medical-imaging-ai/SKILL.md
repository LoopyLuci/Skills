...
DICOM, PACS, AI-assisted diagnosis, image segmentation, and radiology workflows

## Trigger

Activate this skill when the user mentions:
- "imaging",  "radiology" workflows or issues
- Building, fixing, or optimizing medical imaging ai
- Questions about "imaging" best practices
