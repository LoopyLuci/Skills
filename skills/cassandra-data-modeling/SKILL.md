...
"Use when modeling Cassandra data."

## Trigger

Activate this skill when the user mentions:
- "cassandra",  "NoSQL",  "data-modeling",  "CQL",  "partition" workflows or issues
- Building, fixing, or optimizing cassandra data modeling
- Questions about "cassandra" best practices
...
`"cassandra", "NoSQL", "data-modeling", "CQL", "partition"`
