...
"Use when making data-driven decisions."

## Trigger

Activate this skill when the user mentions:
- 'd',  'a',  't',  'a',  '-',  'd',  'r',  'i',  'v',  'e',  'n',  ',  ',  ' ',  'a',  'n',  'a',  'l',  'y',  't',  'i',  'c',  's' workflows or issues
- Building, fixing, or optimizing data driven decision making
...
`'d', 'a', 't', 'a', '-', 'd', 'r', 'i', 'v', 'e', 'n', ', ', ' ', 'a', 'n', 'a', 'l', 'y', 't', 'i', 'c', 's'`
