...
- edge-computing,  edge-ai,  on-device-ml,  inference-optimization workflows or issues
- Building, fixing, or optimizing edge ai inference
...
`edge-computing, edge-ai, on-device-ml, inference-optimization`
