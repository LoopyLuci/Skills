...
"Use when designing engine ECUs."

## Trigger

Activate this skill when the user mentions:
- automotive,  ecu,  embedded,  engine workflows or issues
- Building, fixing, or optimizing engine control unit design
...
`automotive, ecu, embedded, engine`
