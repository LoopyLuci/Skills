---
name: brain-computer-interface-fundamentals
description: "Use when applying bci interface fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying bci interface fundamentals."

## Trigger

Activate this skill when the user mentions:
- neurotech,  bci,  neural-interface-design workflows or issues
- Building, fixing, or optimizing brain computer interface fundamentals
