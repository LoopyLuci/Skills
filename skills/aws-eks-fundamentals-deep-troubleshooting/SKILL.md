---
name: aws-eks-fundamentals-deep-troubleshooting
description: "Use when applying aws eks fundamentals troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Eks Fundamentals Deep Troubleshooting

"Use when applying aws eks fundamentals troubleshooting."

## Trigger

Activate this skill when the user mentions:
- cloud,  eks workflows or issues
- Building, fixing, or optimizing aws eks fundamentals deep troubleshooting
