...
"Use when analyzing streaming data."

## Trigger

Activate this skill when the user mentions:
- data-science,  streaming,  real-time-analytics,  kafka workflows or issues
- Building, fixing, or optimizing data streaming analytics
...
`data-science, streaming, real-time-analytics, kafka`
