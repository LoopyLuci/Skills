---
name: email-marketing-win-back-best-practices
description: Use when applying win-back email best practices.
version: 1.0.0
...
# Email Marketing Win Back Best Practices

"Use when applying win-back email best practices."

## Trigger

Activate this skill when the user mentions:
- email,  retention,  win-back workflows or issues
- Building, fixing, or optimizing email marketing win back best practices
