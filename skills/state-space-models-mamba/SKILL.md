...
"Use when building state space models like Mamba and S4."

## Trigger

Activate this skill when the user mentions:
- ssm,  state-space,  mamba,  s4,  sequence-models,  pytorch workflows or issues
- Building, fixing, or optimizing state space models mamba
- Questions about ssm best practices
...
`ssm, state-space, mamba, s4, sequence-models, pytorch`
