...
"Use when testing auth bypass."

## Trigger

Activate this skill when the user mentions:
- security,  pentest,  auth-bypass workflows or issues
- Building, fixing, or optimizing broken auth test
