---
name: data-viz-fundamentals-deep-troubleshooting
description: "Use when applying data viz fundamentals troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    ...
    related_skills: ['data-viz-fundamentals']
---

# Data Viz Fundamentals Deep Troubleshooting

"Use when applying data viz fundamentals troubleshooting."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing data viz fundamentals deep troubleshooting
