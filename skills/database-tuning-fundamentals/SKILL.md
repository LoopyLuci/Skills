---
name: database-tuning-fundamentals
description: "Use when for database tuning fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Tuning Fundamentals

"Use when for database tuning fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  tuning,  performance,  optimization workflows or issues
- Building, fixing, or optimizing database tuning fundamentals
