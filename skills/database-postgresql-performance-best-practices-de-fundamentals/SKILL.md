---
name: database-postgresql-performance-best-practices-de-fundamentals
description: "Use when applying postgresql performance fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Postgresql Performance Best Practices De Fundamentals

"Use when applying postgresql performance fundamentals."

## Trigger

Activate this skill when the user mentions:
- data,  postgres workflows or issues
- Building, fixing, or optimizing database postgresql performance best practices de fundamentals
