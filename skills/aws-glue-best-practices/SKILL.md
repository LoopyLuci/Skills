---
name: aws-glue-best-practices
description: Use when applying aws glue best practices.
version: 1.0.0
...
"Use when applying aws glue best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  glue,  etl,  data-catalog workflows or issues
- Building, fixing, or optimizing aws glue best practices
