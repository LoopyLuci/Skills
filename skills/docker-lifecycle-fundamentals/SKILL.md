---
name: docker-lifecycle-fundamentals
description: "Use when applying docker lifecycle fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Docker Lifecycle Fundamentals

"Use when applying docker lifecycle fundamentals."

## Trigger

Activate this skill when the user mentions:
- docker,  lifecycle,  docker-lifecycle-management workflows or issues
- Building, fixing, or optimizing docker lifecycle fundamentals
