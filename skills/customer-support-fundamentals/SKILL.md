...
description: "Use when for customer support fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when for customer support fundamentals."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing customer support fundamentals
