---
name: email-marketing-campaigns-fundamentals
description: Use when applying email marketing campaigns fundamentals.
version: 1.0.0
...
# Email Marketing Campaigns Fundamentals

"Use when applying email marketing campaigns fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-campaigns workflows or issues
- Building, fixing, or optimizing email marketing campaigns fundamentals
