...
"Use when building consumer drones."

## Trigger

Activate this skill when the user mentions:
- consumer-tech,  drones,  quadcopter,  uav workflows or issues
- Building, fixing, or optimizing drone consumer applications
...
`consumer-tech, drones, quadcopter, uav`
