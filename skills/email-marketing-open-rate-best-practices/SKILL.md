---
name: email-marketing-open-rate-best-practices
description: "Use when applying email open rate best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Open Rate Best Practices

"Use when applying email open rate best practices."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  open-rate workflows or issues
- Building, fixing, or optimizing email marketing open rate best practices
