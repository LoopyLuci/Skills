---
name: email-protocol-best-practices
description: "Use when applying email protocol best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Protocol Best Practices

"Use when applying email protocol best practices."

## Trigger

Activate this skill when the user mentions:
- email,  smtp,  imap,  pop3 workflows or issues
- Building, fixing, or optimizing email protocol best practices
