...
"Use when building EV charging networks."

## Trigger

Activate this skill when the user mentions:
- automotive,  ev-charging,  charging-station,  infrastructure workflows or issues
- Building, fixing, or optimizing electric vehicle charging network
...
`automotive, ev-charging, charging-station, infrastructure`
