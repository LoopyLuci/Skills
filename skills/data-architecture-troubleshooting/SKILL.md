---
name: data-architecture-troubleshooting
description: Use when applying data architecture troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [data, architecture, data-lake-architecture]
---

# Data Architecture Troubleshooting

"Use when applying data architecture troubleshooting."

## Trigger

Activate this skill when the user mentions:
- data,  architecture,  data-lake-architecture workflows or issues
- Building, fixing, or optimizing data architecture troubleshooting
