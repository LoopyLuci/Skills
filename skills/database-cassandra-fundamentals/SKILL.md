---
name: database-cassandra-fundamentals
description: Use when applying cassandra fundamentals.
version: 1.0.0
...
# Database Cassandra Fundamentals

"Use when applying cassandra fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  cassandra,  nosql,  distributed workflows or issues
- Building, fixing, or optimizing database cassandra fundamentals
