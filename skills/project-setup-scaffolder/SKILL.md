...
"Use for project scaffolding. Folder structure, lint, CI."

## Trigger

Activate this skill when the user mentions:
- programming,  project-setup,  scaffolding,  boilerplate,  configuration,  tooling workflows or issues
- Building, fixing, or optimizing project setup scaffolder
...
`programming, project-setup, scaffolding, boilerplate, configuration, tooling`
