---
name: docker-image-optimization-deep-implementation
description: "Use when applying docker image optimization implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Docker Image Optimization Deep Implementation

"Use when applying docker image optimization implementation."

## Trigger

Activate this skill when the user mentions:
- devops,  docker workflows or issues
- Building, fixing, or optimizing docker image optimization deep implementation
