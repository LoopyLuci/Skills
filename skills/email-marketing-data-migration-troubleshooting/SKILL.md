---
name: email-marketing-data-migration-troubleshooting
description: "Use when applying email data migration troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Data Migration Troubleshooting

"Use when applying email data migration troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  data,  migration workflows or issues
- Building, fixing, or optimizing email marketing data migration troubleshooting
