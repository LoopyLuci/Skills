---
name: email-marketing-metrics-kpis-implementation
description: Use when applying email kpis implementation.
version: 1.0.0
...
# Email Marketing Metrics Kpis Implementation

"Use when applying email kpis implementation."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  kpis workflows or issues
- Building, fixing, or optimizing email marketing metrics kpis implementation
