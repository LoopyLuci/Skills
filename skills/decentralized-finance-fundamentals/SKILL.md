---
name: decentralized-finance-fundamentals
description: Use when for defi fundamentals.
version: 1.0.0
...
"Use when for defi fundamentals."

## Trigger

Activate this skill when the user mentions:
- business,  management,  general workflows or issues
- Building, fixing, or optimizing decentralized finance fundamentals
