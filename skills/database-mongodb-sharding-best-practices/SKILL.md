---
name: database-mongodb-sharding-best-practices
description: Use when applying mongodb sharding best practices.
version: 1.0.0
...
# Database Mongodb Sharding Best Practices

"Use when applying mongodb sharding best practices."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  sharding,  scale workflows or issues
- Building, fixing, or optimizing database mongodb sharding best practices
