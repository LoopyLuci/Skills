---
name: biotech-eng-audit-implementation
description: "Use when applying biotech audit implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Biotech Eng Audit Implementation

"Use when applying biotech audit implementation."

## Trigger

Activate this skill when the user mentions:
- biotech,  engineering,  biotech-eng-audit workflows or issues
- Building, fixing, or optimizing biotech eng audit implementation
