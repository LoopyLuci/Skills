---
name: aws-glue-implementation
description: Use when applying aws glue implementation.
version: 1.0.0
...
"Use when applying aws glue implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  glue,  etl,  data-catalog workflows or issues
- Building, fixing, or optimizing aws glue implementation
