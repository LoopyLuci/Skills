---
name: email-marketing-ROI-fundamentals
description: "Use when applying email roi fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Roi Fundamentals

"Use when applying email roi fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  roi,  measurement,  analytics workflows or issues
- Building, fixing, or optimizing email marketing roi fundamentals
