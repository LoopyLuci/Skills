...
"Use when implementing container security."

## Trigger

Activate this skill when the user mentions:
- devops,  containers,  container-security-implementation workflows or issues
- Building, fixing, or optimizing container security impl
...
`devops, containers, container-security-implementation`
