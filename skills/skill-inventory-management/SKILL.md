...
"Use when auditing, pruning, or consolidating skills."

## Trigger

Activate this skill when the user mentions:
- skills,  meta,  inventory,  audit,  lifecycle,  pruning workflows or issues
- Building, fixing, or optimizing skill inventory management
...
`skills, meta, inventory, audit, lifecycle, pruning`
