---
name: database-redis-lua-scripts-best-practices-deep-troubleshooting
description: "Use when applying redis lua scripts troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [data, redis]
    related_skills: ['redis-lua-scripts-best-practices']
---

# Database Redis Lua Scripts Best Practices Deep Troubleshooting

"Use when applying redis lua scripts troubleshooting."

## Trigger

Activate this skill when the user mentions:
- data,  redis workflows or issues
- Building, fixing, or optimizing database redis lua scripts best practices deep troubleshooting
