---
name: datadog-fundamentals-deep-best-practices
description: "Use when applying datadog fundamentals best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Datadog Fundamentals Deep Best Practices

"Use when applying datadog fundamentals best practices."

## Trigger

Activate this skill when the user mentions:
- sys,  monitoring workflows or issues
- Building, fixing, or optimizing datadog fundamentals deep best practices
