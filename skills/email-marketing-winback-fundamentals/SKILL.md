---
name: email-marketing-winback-fundamentals
description: "Use when applying email win-back fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Winback Fundamentals

"Use when applying email win-back fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  retention,  win-back workflows or issues
- Building, fixing, or optimizing email marketing winback fundamentals
