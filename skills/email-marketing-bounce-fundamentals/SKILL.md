---
name: email-marketing-bounce-fundamentals
description: Use when applying email bounce fundamentals.
version: 1.0.0
...
# Email Marketing Bounce Fundamentals

"Use when applying email bounce fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  bounce,  delivery workflows or issues
- Building, fixing, or optimizing email marketing bounce fundamentals
