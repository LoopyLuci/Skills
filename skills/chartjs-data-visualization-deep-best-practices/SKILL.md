---
name: chartjs-data-visualization-deep-best-practices
description: "Use when applying chart.js viz best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Chartjs Data Visualization Deep Best Practices

"Use when applying chart.js viz best practices."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing chartjs data visualization deep best practices
