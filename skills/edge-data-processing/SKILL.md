...
"Use when processing data at edge."

## Trigger

Activate this skill when the user mentions:
- edge-computing,  edge-data,  streaming,  real-time workflows or issues
- Building, fixing, or optimizing edge data processing
...
`edge-computing, edge-data, streaming, real-time`
