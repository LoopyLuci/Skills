---
name: container-security-hardening-deep-fundamentals
description: Use when applying container hardening fundamentals.
version: 1.0.0
...
# Container Security Hardening Deep Fundamentals

"Use when applying container hardening fundamentals."

## Trigger

Activate this skill when the user mentions:
- devops,  security workflows or issues
- Building, fixing, or optimizing container security hardening deep fundamentals
