...
"Use when building Tekton pipelines."

## Trigger

Activate this skill when the user mentions:
- "tekton",  "CI-CD",  "tasks",  "pipelines",  "triggers" workflows or issues
- Building, fixing, or optimizing tekton cicd pipelines
- Questions about "tekton" best practices
...
`"tekton", "CI-CD", "tasks", "pipelines", "triggers"`
