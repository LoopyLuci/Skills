---
name: aws-encryption
description: Use when encrypting AWS data.
version: 1.0.0
...
metadata:
  hermes:
    tags: [cloud, aws, encryption-security-best-practices]
---

# Aws Encryption

"Use when encrypting AWS data."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  encryption-security-best-practices workflows or issues
- Building, fixing, or optimizing aws encryption
...
`cloud, aws, encryption-security-best-practices`
