---
name: aws-eventbridge-fundamentals
description: Use when applying aws eventbridge fundamentals.
version: 1.0.0
...
"Use when applying aws eventbridge fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  eventbridge,  events,  event-bus workflows or issues
- Building, fixing, or optimizing aws eventbridge fundamentals
