---
name: database-redis-cluster-fundamentals
description: "Use when applying redis cluster fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Redis Cluster Fundamentals

"Use when applying redis cluster fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  clustering,  high-availability workflows or issues
- Building, fixing, or optimizing database redis cluster fundamentals
