...
Zero trust, defense in depth, segmentation, SASE, and security patterns

## Trigger

Activate this skill when the user mentions:
- "architecture",  "zero-trust" workflows or issues
- Building, fixing, or optimizing security architecture design
