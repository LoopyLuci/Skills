...
"Use when programming ESP32 devices."

## Trigger

Activate this skill when the user mentions:
- electronics,  esp32,  wifi,  ble,  iot workflows or issues
- Building, fixing, or optimizing esp32 wifi ble programming
...
`electronics, esp32, wifi, ble, iot`
