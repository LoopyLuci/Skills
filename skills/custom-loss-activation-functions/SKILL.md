...
"Use when designing custom loss functions and activations."

## Trigger

Activate this skill when the user mentions:
- neural-networks,  loss-functions,  activations,  pytorch,  deep-learning workflows or issues
- Building, fixing, or optimizing custom loss activation functions
- Questions about neural-networks best practices
...
`neural-networks, loss-functions, activations, pytorch, deep-learning`
