---
name: database-redis-pubsub-troubleshooting
description: Use when applying redis pub/sub troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [database, redis, pub-sub, messaging]
---

# Database Redis Pubsub Troubleshooting

"Use when applying redis pub/sub troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  redis,  pub-sub,  messaging workflows or issues
- Building, fixing, or optimizing database redis pubsub troubleshooting
...
`database, redis, pub-sub, messaging`
