...
"Use when building conversational AI and dialogue systems."

## Trigger

Activate this skill when the user mentions:
- dialogue,  conversational-ai,  chatbots,  dialogue-management,  NLU,  NLG workflows or issues
- Building, fixing, or optimizing dialogue systems conversational ai
- Questions about dialogue best practices
...
`dialogue, conversational-ai, chatbots, dialogue-management, NLU, NLG`
