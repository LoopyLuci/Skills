---
name: email-marketing-welcome-series-implementation
description: Use when applying welcome email series implementation.
version: 1.0.0
...
# Email Marketing Welcome Series Implementation

"Use when applying welcome email series implementation."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome-series workflows or issues
- Building, fixing, or optimizing email marketing welcome series implementation
