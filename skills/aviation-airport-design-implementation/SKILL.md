---
name: aviation-airport-design-implementation
description: "Use when applying airport design implementation."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aviation Airport Design Implementation

"Use when applying airport design implementation."

## Trigger

Activate this skill when the user mentions:
- aviation,  airport,  airport-design workflows or issues
- Building, fixing, or optimizing aviation airport design implementation
...
`aviation, airport, airport-design`
