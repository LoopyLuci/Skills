---
name: database-migrations-troubleshooting
description: Use when for database migrations troubleshooting.
version: 1.0.0
...
"Use when for database migrations troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  migrations,  schema-evolution workflows or issues
- Building, fixing, or optimizing database migrations troubleshooting
