...
description: Use when applying aws security hub implementation.
version: 1.0.0
...
"Use when applying aws security hub implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  security-hub,  security-center workflows or issues
- Building, fixing, or optimizing aws security hub implementation
