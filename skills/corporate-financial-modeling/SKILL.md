...
"Use when modeling corporate finances."

## Trigger

Activate this skill when the user mentions:
- 'f',  'i',  'n',  'a',  'n',  'c',  'i',  'a',  'l',  '-',  'm',  'o',  'd',  'e',  'l',  'i',  'n',  'g',  ',  ',  ' ',  'c',  'o',  'r',  'p',  'o',  'r',  'a',  't',  'e' workflows or issues
- Building, fixing, or optimizing corporate financial modeling
...
`'f', 'i', 'n', 'a', 'n', 'c', 'i', 'a', 'l', '-', 'm', 'o', 'd', 'e', 'l', 'i', 'n', 'g', ', ', ' ', 'c', 'o', 'r', 'p', 'o', 'r', 'a', 't', 'e'`
