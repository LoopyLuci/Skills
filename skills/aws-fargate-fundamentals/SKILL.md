---
name: aws-fargate-fundamentals
description: Use when applying aws fargate fundamentals.
version: 1.0.0
...
metadata:
  hermes:
    tags: [aws, fargate, serverless-containers]
---

# Aws Fargate Fundamentals

"Use when applying aws fargate fundamentals."

## Trigger

Activate this skill when the user mentions:
- aws,  fargate,  serverless-containers workflows or issues
- Building, fixing, or optimizing aws fargate fundamentals
