---
name: email-marketing-bounce-troubleshooting
description: Use when applying email bounce troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, analytics, bounce, delivery]
---

# Email Marketing Bounce Troubleshooting

"Use when applying email bounce troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  bounce,  delivery workflows or issues
- Building, fixing, or optimizing email marketing bounce troubleshooting
...
`email, analytics, bounce, delivery`
