---
name: email-marketing-strategy-troubleshooting
description: Use when applying email marketing strategy troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [email, marketing, email-marketing-strategy]
---

# Email Marketing Strategy Troubleshooting

"Use when applying email marketing strategy troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  email-marketing-strategy workflows or issues
- Building, fixing, or optimizing email marketing strategy troubleshooting
