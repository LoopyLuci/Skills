---
name: aws-glue-troubleshooting
description: Use when applying aws glue troubleshooting.
version: 1.0.0
...
"Use when applying aws glue troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  glue,  etl,  data-catalog workflows or issues
- Building, fixing, or optimizing aws glue troubleshooting
