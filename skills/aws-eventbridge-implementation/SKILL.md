---
name: aws-eventbridge-implementation
description: Use when applying aws eventbridge implementation.
version: 1.0.0
...
"Use when applying aws eventbridge implementation."

## Trigger

Activate this skill when the user mentions:
- aws,  eventbridge,  events,  event-bus workflows or issues
- Building, fixing, or optimizing aws eventbridge implementation
