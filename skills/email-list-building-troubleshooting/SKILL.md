---
name: email-list-building-troubleshooting
description: "Use when applying email list building troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email List Building Troubleshooting

"Use when applying email list building troubleshooting."

## Trigger

Activate this skill when the user mentions:
- email,  marketing,  list-building-email-growth workflows or issues
- Building, fixing, or optimizing email list building troubleshooting
...
`email, marketing, list-building-email-growth`
