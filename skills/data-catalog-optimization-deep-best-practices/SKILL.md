---
name: data-catalog-optimization-deep-best-practices
description: Use when applying data catalog optimization best practices.
version: 1.0.0
...
# Data Catalog Optimization Deep Best Practices

"Use when applying data catalog optimization best practices."

## Trigger

Activate this skill when the user mentions:
- data,  data-catalog workflows or issues
- Building, fixing, or optimizing data catalog optimization deep best practices
