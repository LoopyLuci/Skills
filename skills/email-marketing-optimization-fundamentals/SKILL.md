---
name: email-marketing-optimization-fundamentals
description: "Use when applying email optimization fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Optimization Fundamentals

"Use when applying email optimization fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  optimization,  ab-testing workflows or issues
- Building, fixing, or optimizing email marketing optimization fundamentals
