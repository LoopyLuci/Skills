---
name: financial-modeling-tech-implementation
description: Use when applying financial modeling tech implementation.
version: 1.0.0
...
# Financial Modeling Tech Implementation

"Use when applying financial modeling tech implementation."

## Trigger

Activate this skill when the user mentions:
- finance,  modeling,  financial-modeling-python workflows or issues
- Building, fixing, or optimizing financial modeling tech implementation
