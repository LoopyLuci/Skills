...
description: Use when applying aws backup best practices.
version: 1.0.0
...
"Use when applying aws backup best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  backup,  disaster-recovery workflows or issues
- Building, fixing, or optimizing aws backup best practices
