---
name: embedded-security-fundamentals
description: Use when for embedded security fundamentals.
version: 1.0.0
...
"Use when for embedded security fundamentals."

## Trigger

Activate this skill when the user mentions:
- security,  embedded,  firmware,  iot workflows or issues
- Building, fixing, or optimizing embedded security fundamentals
