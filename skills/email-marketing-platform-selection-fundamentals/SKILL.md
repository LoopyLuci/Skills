---
name: email-marketing-platform-selection-fundamentals
description: Use when applying email platform selection fundamentals.
version: 1.0.0
...
# Email Marketing Platform Selection Fundamentals

"Use when applying email platform selection fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  platform,  selection workflows or issues
- Building, fixing, or optimizing email marketing platform selection fundamentals
