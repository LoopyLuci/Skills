---
name: business-model-innovation-fundamentals
description: Use when applying business model innovation fundamentals.
version: 1.0.0
...
"Use when applying business model innovation fundamentals."

## Trigger

Activate this skill when the user mentions:
- consulting,  innovation,  business-model workflows or issues
- Building, fixing, or optimizing business model innovation fundamentals
