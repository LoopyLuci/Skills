---
name: email-marketing-metrics-kpis-best-practices
description: "Use when applying email kpis best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing Metrics Kpis Best Practices

"Use when applying email kpis best practices."

## Trigger

Activate this skill when the user mentions:
- email,  analytics,  kpis workflows or issues
- Building, fixing, or optimizing email marketing metrics kpis best practices
