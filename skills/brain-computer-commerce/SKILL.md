...
"Use when bridging BCI and commerce."

## Trigger

Activate this skill when the user mentions:
- cross-domain,  bci-commerce,  neurotech,  consumer-tech workflows or issues
- Building, fixing, or optimizing brain computer commerce
...
`cross-domain, bci-commerce, neurotech, consumer-tech`
