---
name: database-cassandra-data-modeling-troubleshooting
description: "Use when applying cassandra modeling troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Cassandra Data Modeling Troubleshooting

"Use when applying cassandra modeling troubleshooting."

## Trigger

Activate this skill when the user mentions:
- database,  cassandra,  data-modeling,  single-table workflows or issues
- Building, fixing, or optimizing database cassandra data modeling troubleshooting
...
`database, cassandra, data-modeling, single-table`
