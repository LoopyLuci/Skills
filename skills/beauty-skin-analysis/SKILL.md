---
name: beauty-skin-analysis
description: "Use when analyzing skin conditions."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [beauty, skin-analysis, diagnostics]
    related_skills: [general]
---

## Overview
Analyze skin conditions for personalized beauty recommendations.

## When to Use
- "Beauty Skin Analysis design and implementation"
- "Best practices for Beauty Skin Analysis"
- "Beauty Skin Analysis optimization and scaling"
- "Beauty Skin Analysis troubleshooting and validation"
