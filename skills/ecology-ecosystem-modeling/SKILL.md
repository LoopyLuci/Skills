...
"Use when modeling ecosystems."

## Trigger

Activate this skill when the user mentions:
- biology,  ecology,  ecosystem,  modeling workflows or issues
- Building, fixing, or optimizing ecology ecosystem modeling
...
`biology, ecology, ecosystem, modeling`
