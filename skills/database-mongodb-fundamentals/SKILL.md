---
name: database-mongodb-fundamentals
description: "Use when applying mongodb fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Database Mongodb Fundamentals

"Use when applying mongodb fundamentals."

## Trigger

Activate this skill when the user mentions:
- database,  mongodb,  nosql,  document workflows or issues
- Building, fixing, or optimizing database mongodb fundamentals
