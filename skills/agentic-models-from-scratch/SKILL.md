...
"Use when building custom agentic AI models from scratch."

## Trigger

Activate this skill when the user mentions:
- agents,  agentic,  foundation-model,  architecture,  training workflows or issues
- Building, fixing, or optimizing agentic models from scratch
...
`agents, agentic, foundation-model, architecture, training`
