...
description: Use when for container security best practices.
version: 1.0.0
...
"Use when for container security best practices."

## Trigger

Activate this skill when the user mentions:
- security,  containers,  docker,  kubernetes workflows or issues
- Building, fixing, or optimizing container security best practices
