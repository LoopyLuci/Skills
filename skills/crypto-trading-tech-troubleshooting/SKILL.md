---
name: crypto-trading-tech-troubleshooting
description: Use when applying crypto trading tech troubleshooting.
version: 1.0.0
...
metadata:
  hermes:
    tags: [finance, crypto, crypto-trading]
---

# Crypto Trading Tech Troubleshooting

"Use when applying crypto trading tech troubleshooting."

## Trigger

Activate this skill when the user mentions:
- finance,  crypto,  crypto-trading workflows or issues
- Building, fixing, or optimizing crypto trading tech troubleshooting
