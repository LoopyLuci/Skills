---
name: data-viz-best-practices-deep-implementation
description: "Use when applying data visualization best practices impl."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Data Viz Best Practices Deep Implementation

"Use when applying data visualization best practices impl."

## Trigger

Activate this skill when the user mentions:
- design,  data-viz workflows or issues
- Building, fixing, or optimizing data viz best practices deep implementation
