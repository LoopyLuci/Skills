---
name: data-mart-best-practices
description: Use when applying data mart best practices.
version: 1.0.0
...
"Use when applying data mart best practices."

## Trigger

Activate this skill when the user mentions:
- ds,  data,  data-mart workflows or issues
- Building, fixing, or optimizing data mart best practices
