...
"Use when automating AWS security."

## Trigger

Activate this skill when the user mentions:
- cloud,  aws,  security-automation workflows or issues
- Building, fixing, or optimizing aws security automation
