---
name: aws-audit-manager-best-practices
description: Use when applying aws audit manager best practices.
version: 1.0.0
...
"Use when applying aws audit manager best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  audit-manager,  compliance,  audit workflows or issues
- Building, fixing, or optimizing aws audit manager best practices
