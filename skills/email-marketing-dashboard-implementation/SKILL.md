---
name: email-marketing-dashboard-implementation
description: Use when applying email dashboard implementation.
version: 1.0.0
...
# Email Marketing Dashboard Implementation

"Use when applying email dashboard implementation."

## Trigger

Activate this skill when the user mentions:
- email,  dashboard,  analytics workflows or issues
- Building, fixing, or optimizing email marketing dashboard implementation
