---
name: brain-computer-interface-best-practices
description: Use when applying bci interface best practices.
version: 1.0.0
...
"Use when applying bci interface best practices."

## Trigger

Activate this skill when the user mentions:
- neurotech,  bci,  neural-interface-design workflows or issues
- Building, fixing, or optimizing brain computer interface best practices
