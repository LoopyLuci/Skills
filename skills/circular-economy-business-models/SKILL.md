---
name: circular-economy-business-models
description: "Use when designing circular economy models."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [climatetech, circular-economy, sustainability, business-models]
    related_skills: [waste-stream-optimization]
---

## Overview
Circular Economy Business Models implementation. Covers best practices, common methodologies, 
technical considerations, and verification approaches for this field.

## When to Use
- "Circular Economy Business Models implementation and optimization"
- "Best practices for Circular Economy Business Models workflows"
- "Circular Economy Business Models compliance and standards"
- "Circular Economy Business Models troubleshooting and problem-solving"
- "Circular Economy Business Models ROI and performance measurement"
