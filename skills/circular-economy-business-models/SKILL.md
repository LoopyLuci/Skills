...
"Use when designing circular economy models."

## Trigger

Activate this skill when the user mentions:
- climatetech,  circular-economy,  sustainability,  business-models workflows or issues
- Building, fixing, or optimizing circular economy business models
...
`climatetech, circular-economy, sustainability, business-models`
