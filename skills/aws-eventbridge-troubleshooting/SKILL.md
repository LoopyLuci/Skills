---
name: aws-eventbridge-troubleshooting
description: "Use when applying aws eventbridge troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [aws, eventbridge, events, event-bus]
    related_skills: [general]
---

# Aws Eventbridge Troubleshooting

"Use when applying aws eventbridge troubleshooting."

## Trigger

Activate this skill when the user mentions:
- aws,  eventbridge,  events,  event-bus workflows or issues
- Building, fixing, or optimizing aws eventbridge troubleshooting
