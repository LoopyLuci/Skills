---
name: aws-fargate-best-practices
description: Use when applying aws fargate best practices.
version: 1.0.0
...
"Use when applying aws fargate best practices."

## Trigger

Activate this skill when the user mentions:
- aws,  fargate,  serverless-containers workflows or issues
- Building, fixing, or optimizing aws fargate best practices
