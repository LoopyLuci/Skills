---
name: email-marketing-inbox-implementation
description: Use when applying email inbox placement implementation.
version: 1.0.0
...
# Email Marketing Inbox Implementation

"Use when applying email inbox placement implementation."

## Trigger

Activate this skill when the user mentions:
- email,  deliverability,  inbox workflows or issues
- Building, fixing, or optimizing email marketing inbox implementation
