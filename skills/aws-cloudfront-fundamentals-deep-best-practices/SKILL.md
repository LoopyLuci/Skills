---
name: aws-cloudfront-fundamentals-deep-best-practices
description: Use when applying cloudfront fundamentals best practices.
version: 1.0.0
...
# Aws Cloudfront Fundamentals Deep Best Practices

"Use when applying cloudfront fundamentals best practices."

## Trigger

Activate this skill when the user mentions:
- cloud,  cdn workflows or issues
- Building, fixing, or optimizing aws cloudfront fundamentals deep best practices
