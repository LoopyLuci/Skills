---
name: aws-eks-implementation-deep-troubleshooting
description: "Use when applying aws eks implementation troubleshooting."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Aws Eks Implementation Deep Troubleshooting

"Use when applying aws eks implementation troubleshooting."

## Trigger

Activate this skill when the user mentions:
- cloud,  eks workflows or issues
- Building, fixing, or optimizing aws eks implementation deep troubleshooting
