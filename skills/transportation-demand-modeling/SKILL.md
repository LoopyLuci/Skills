...
Four-step model, activity-based modeling, and travel demand management

## Trigger

Activate this skill when the user mentions:
- "demand",  "modeling" workflows or issues
- Building, fixing, or optimizing transportation demand modeling
- Questions about "demand" best practices
