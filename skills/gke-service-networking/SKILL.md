...
description: Skill for gke service networking
version: 1.0.0
...
**Trigger**: Use when working with GKE Service Networking — Google Kubernetes Engine configuration and management.
