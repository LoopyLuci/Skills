---
name: email-marketing-welcome-implementation
description: Use when applying email welcome series implementation.
version: 1.0.0
...
# Email Marketing Welcome Implementation

"Use when applying email welcome series implementation."

## Trigger

Activate this skill when the user mentions:
- email,  onboarding,  welcome workflows or issues
- Building, fixing, or optimizing email marketing welcome implementation
