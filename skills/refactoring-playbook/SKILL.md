...
"Use for refactoring. Smell detection, patterns, metrics."

## Trigger

Activate this skill when the user mentions:
- programming,  refactoring,  technical-debt,  code-quality,  clean-code workflows or issues
- Building, fixing, or optimizing refactoring playbook
...
`programming, refactoring, technical-debt, code-quality, clean-code`
