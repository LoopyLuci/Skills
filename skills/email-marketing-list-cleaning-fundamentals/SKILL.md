---
name: email-marketing-list-cleaning-fundamentals
description: "Use when applying email list cleaning fundamentals."
version: 1.0.0
author: Hermes Agent
license: MIT
...
# Email Marketing List Cleaning Fundamentals

"Use when applying email list cleaning fundamentals."

## Trigger

Activate this skill when the user mentions:
- email,  hygiene,  list-cleaning workflows or issues
- Building, fixing, or optimizing email marketing list cleaning fundamentals
