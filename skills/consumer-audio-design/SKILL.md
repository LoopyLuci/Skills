...
"Use when designing consumer audio products."

## Trigger

Activate this skill when the user mentions:
- consumer-tech,  audio,  sound-design,  dsp workflows or issues
- Building, fixing, or optimizing consumer audio design
...
`consumer-tech, audio, sound-design, dsp`
