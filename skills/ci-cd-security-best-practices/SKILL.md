...
description: "Use when applying ci/cd security best practices."
version: 1.0.0
author: Hermes Agent
license: MIT
...
"Use when applying ci/cd security best practices."

## Trigger

Activate this skill when the user mentions:
- devops,  security,  ci-cd-security,  pipeline workflows or issues
- Building, fixing, or optimizing ci cd security best practices
