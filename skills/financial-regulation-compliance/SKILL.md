...
"Use when ensuring financial regulation."

## Trigger

Activate this skill when the user mentions:
- legal,  finance-reg,  sec,  compliance workflows or issues
- Building, fixing, or optimizing financial regulation compliance
...
`legal, finance-reg, sec, compliance`
